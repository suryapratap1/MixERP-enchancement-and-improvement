 ...
 *
 */
(function(n,t){"use strict";typeof exports=="object"?module.exports=t(require("jquery","./URI")):typeof define=="function"&&define.amd?define(["jquery","./URI"],t):t(n.jQuery,n.URI)})(this,function(n,t){"use strict";function r(n){return n.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$1")}function e(n){var i=n.nodeName.toLowerCase(),r=t.domAttributes[i];return i==="input"&&n.type!=="image"?undefined:r}function c(t){return{get:function(i){return n(i).uri()[t]()},set:function(i,r){return n(i).uri()[t](r),r}}}function h(t,r){var u,o,h;return!e(t)||!r?!1:(u=r.match(s),!u||!u[5]&&u[2]!==":"&&!i[u[2]])?!1:(h=n(t).uri(),u[5]?h.is(u[5]):u[2]===":"?(o=u[1].toLowerCase()+":",!i[o])?!1:i[o](h,u[4]):(o=u[1].toLowerCase(),!f[o])?!1:i[u[2]](h[o](),u[4],o))}var f={},i={"=":function(n,t){return n===t},"^=":function(n,t){return!!(n+"").match(new RegExp("^"+r(t),"i"))},"$=":function(n,t){return!!(n+"").match(new RegExp(r(t)+"$","i"))},"*=":function(n,t,i){return i==="directory"&&(n+="/"),!!(n+"").match(new RegExp(r(t),"i"))},"equals:":function(n,t){return n.equals(t)},"is:":function(n,t){return n.is(t)}},u,o,s;return n.each("authority directory domain filename fragment hash host hostname href password path pathname port protocol query resource scheme search subdomain suffix tld username".split(" "),function(t,i){f[i]=!0;n.attrHooks["uri:"+i]=c(i)}),u={get:function(t){return n(t).uri()},set:function(t,i){return n(t).uri().href(i).toString()}},n.each(["src","href","action","uri","cite"],function(t,i){n.attrHooks[i]={set:u.set}}),n.attrHooks.uri.get=u.get,n.fn.uri=function(n){var i=this.first(),r=i.get(0),u=e(r),f;if(!u)throw new Error('Element "'+r.nodeName+'" does not have either property: href, src, action, cite');if(n!==undefined){if(f=i.data("uri"),f)return f.href(n);n instanceof t||(n=t(n||""))}else{if(n=i.data("uri"),n)return n;n=t(i.attr(u)||"")}return n._dom_element=r,n._dom_attribute=u,n.normalize(),i.data("uri",n),n},t.prototype.build=function(n){return this._dom_element?(this._string=t.build(this._parts),this._deferred_build=!1,this._dom_element.setAttribute(this._dom_attribute,this._string),this._dom_element[this._dom_attribute]=this._string):n===!0?this._deferred_build=!0:(n===undefined||this._deferred_build)&&(this._string=t.build(this._parts),this._deferred_build=!1),this},s=/^([a-zA-Z]+)\s*([\^\$*]?=|:)\s*(['"]?)(.+)\3|^\s*([a-zA-Z0-9]+)\s*$/,o=n.expr.createPseudo?n.expr.createPseudo(function(n){return function(t){return h(t,n)}}):function(n,t,i){return h(n,i[3])},n.expr[":"].uri=o,n});$(document).ready(function(){$("img:not(.logo)").addClass("ui bordered centered rounded image");processSocialSharing()});