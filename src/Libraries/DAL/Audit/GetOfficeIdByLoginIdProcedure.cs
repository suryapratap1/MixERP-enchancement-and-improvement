...
namespace MixERP.Net.Schemas.Audit.Data
{
    ...
    /// </summary>
    public class GetOfficeIdByLoginIdProcedure : DbAccess, IGetOfficeIdByLoginIdRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_office_id_by_login_id";
        /// <summary>
        ...
        public int Execute()
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the function \"GetOfficeIdByLoginIdProcedure\" was denied to the user with Login ID {LoginId}.", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            string query = "SELECT * FROM audit.get_office_id_by_login_id(@PgArg0);";
