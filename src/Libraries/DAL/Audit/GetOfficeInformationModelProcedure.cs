...
namespace MixERP.Net.Schemas.Audit.Data
{
    ...
    public class GetOfficeInformationModelProcedure : DbAccess, IGetOfficeInformationModelRepository
    {
        ...
        public IEnumerable<DbGetOfficeInformationModelResult> Execute()
        {
            ...
            string query = "SELECT * FROM audit.get_office_information_model(@PgArg0);";
            ...
            return Factory.Get<DbGetOfficeInformationModelResult>(this._Catalog, query, parameters.ToArray());
        }
