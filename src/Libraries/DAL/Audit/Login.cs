...
namespace MixERP.Net.Schemas.Audit.Data
{
    ...
    public class Login : DbAccess, ILoginRepository
    {
        ...
        /// <summary>
        /// Performs a select statement on table "audit.logins" producing a paginated result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "audit.logins" producing a paginated result of 10.
        /// </summary>
