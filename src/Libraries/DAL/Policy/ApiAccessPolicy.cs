...
namespace MixERP.Net.Schemas.Policy.Data
{
    ...
    /// </summary>
    public class ApiAccessPolicy : DbAccess, IApiAccessPolicyRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "api_access_policy";
        ...
        public long Count()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}", this._LoginId);
        ...
        /// <summary>
        /// Executes a select query on the table "policy.api_access_policy" to return all instances of the "ApiAccessPolicy" class. 
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.ApiAccessPolicy> GetAll()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the export entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM policy.api_access_policy ORDER BY api_access_policy_id;";
            return Factory.Get<MixERP.Net.Entities.Policy.ApiAccessPolicy>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "policy.api_access_policy" to return all instances of the "ApiAccessPolicy" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "ApiAccessPolicy" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        public MixERP.Net.Entities.Policy.ApiAccessPolicy Get(long apiAccessPolicyId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get entity \"ApiAccessPolicy\" filtered by \"ApiAccessPolicyId\" with value {ApiAccessPolicyId} was denied to the user with Login ID {_LoginId}", apiAccessPolicyId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.ApiAccessPolicy> Get(long[] apiAccessPolicyIds)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}. apiAccessPolicyIds: {apiAccessPolicyIds}.", this._LoginId, apiAccessPolicyIds);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            return Factory.Get<MixERP.Net.Entities.Policy.ApiAccessPolicy>(this._Catalog, sql, apiAccessPolicyIds);
        }
        ...
        public IEnumerable<PetaPoco.CustomField> GetCustomFields(string resourceId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to get custom fields for entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to get display field for entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public object AddOrEdit(dynamic apiAccessPolicy, List<EntityParser.CustomField> customFields)
        {
            ...
            apiAccessPolicy.audit_user_id = this._UserId;
            apiAccessPolicy.audit_ts = System.DateTime.UtcNow;

            object primaryKeyValue = apiAccessPolicy.api_access_policy_id;

            if (Cast.To<long>(primaryKeyValue) > 0)
            {
                primaryKeyValue = apiAccessPolicy.api_access_policy_id;
                this.Update(apiAccessPolicy, long.Parse(apiAccessPolicy.api_access_policy_id));
            }
            else
            {
        ...
        public object Add(dynamic apiAccessPolicy)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to add entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}. {ApiAccessPolicy}", this._LoginId, apiAccessPolicy);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            return Factory.Insert(this._Catalog, apiAccessPolicy, "policy.api_access_policy", "api_access_policy_id");
        }
        ...
        public List<object> BulkImport(List<ExpandoObject> apiAccessPolicies)
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to import entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}. {apiAccessPolicies}", this._LoginId, apiAccessPolicies);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            try
            {
                using (Database db = new Database(Factory.GetConnectionString(this._Catalog), Factory.ProviderName))
                {
                    ...
                    {
                        foreach (dynamic apiAccessPolicy in apiAccessPolicies)
                        {
                            line++;
                            ...
                            if (Cast.To<long>(primaryKeyValue) > 0)
                            {
                                result.Add(apiAccessPolicy.api_access_policy_id);
                                db.Update("policy.api_access_policy", "api_access_policy_id", apiAccessPolicy, apiAccessPolicy.api_access_policy_id);
                            }
                            else
                            {
                                result.Add(db.Insert("policy.api_access_policy", "api_access_policy_id", apiAccessPolicy));
                            }
                        }
        ...
        public void Update(dynamic apiAccessPolicy, long apiAccessPolicyId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to edit entity \"ApiAccessPolicy\" with Primary Key {PrimaryKey} was denied to the user with Login ID {LoginId}. {ApiAccessPolicy}", apiAccessPolicyId, this._LoginId, apiAccessPolicy);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            Factory.Update(this._Catalog, apiAccessPolicy, apiAccessPolicyId, "policy.api_access_policy", "api_access_policy_id");
        }
        ...
        public void Delete(long apiAccessPolicyId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to delete entity \"ApiAccessPolicy\" with Primary Key {PrimaryKey} was denied to the user with Login ID {LoginId}.", apiAccessPolicyId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "DELETE FROM policy.api_access_policy WHERE api_access_policy_id=@0;";
            Factory.NonQuery(this._Catalog, sql, apiAccessPolicyId);
        }

        /// <summary>
        /// Performs a select statement on table "policy.api_access_policy" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.ApiAccessPolicy> GetPaginatedResult()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the first page of the entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}.", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM policy.api_access_policy ORDER BY api_access_policy_id LIMIT 10 OFFSET 0;";
            return Factory.Get<MixERP.Net.Entities.Policy.ApiAccessPolicy>(this._Catalog, sql);
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.ApiAccessPolicy> GetPaginatedResult(long pageNumber)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}.", pageNumber, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            return Factory.Get<MixERP.Net.Entities.Policy.ApiAccessPolicy>(this._Catalog, sql, offset);
        }
        ...
        public long CountWhere(List<EntityParser.Filter> filters)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}. Filters: {Filters}.", this._LoginId, filters);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "policy.api_access_policy" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.ApiAccessPolicy> GetWhere(long pageNumber, List<EntityParser.Filter> filters)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the filtered entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}. Filters: {Filters}.", pageNumber, this._LoginId, filters);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public long CountFiltered(string filterName)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}. Filter: {Filter}.", this._LoginId, filterName);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.ApiAccessPolicy> GetFiltered(long pageNumber, string filterName)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the filtered entity \"ApiAccessPolicy\" was denied to the user with Login ID {LoginId}. Filter: {Filter}.", pageNumber, this._LoginId, filterName);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
