...
namespace MixERP.Net.Schemas.Policy.Data
{
    ...
    /// </summary>
    public class StorePolicyDetail : DbAccess, IStorePolicyDetailRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "store_policy_details";
        ...
        public long Count()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}", this._LoginId);
        ...
        /// <summary>
        /// Executes a select query on the table "policy.store_policy_details" to return all instances of the "StorePolicyDetail" class. 
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.StorePolicyDetail> GetAll()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the export entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM policy.store_policy_details ORDER BY store_policy_detail_id;";
            return Factory.Get<MixERP.Net.Entities.Policy.StorePolicyDetail>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "policy.store_policy_details" to return all instances of the "StorePolicyDetail" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "StorePolicyDetail" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        public MixERP.Net.Entities.Policy.StorePolicyDetail Get(long storePolicyDetailId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get entity \"StorePolicyDetail\" filtered by \"StorePolicyDetailId\" with value {StorePolicyDetailId} was denied to the user with Login ID {_LoginId}", storePolicyDetailId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM policy.store_policy_details WHERE store_policy_detail_id=@0;";
            return Factory.Get<MixERP.Net.Entities.Policy.StorePolicyDetail>(this._Catalog, sql, storePolicyDetailId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the first record of the table "policy.store_policy_details". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "StorePolicyDetail" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Policy.StorePolicyDetail GetFirst()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get the first record of entity \"StorePolicyDetail\" was denied to the user with Login ID {_LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM policy.store_policy_details ORDER BY store_policy_detail_id LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Policy.StorePolicyDetail>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Gets the previous record of the table "policy.store_policy_details" sorted by storePolicyDetailId.
        /// </summary>
        ...
        public MixERP.Net.Entities.Policy.StorePolicyDetail GetPrevious(long storePolicyDetailId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get the previous entity of \"StorePolicyDetail\" by \"StorePolicyDetailId\" with value {StorePolicyDetailId} was denied to the user with Login ID {_LoginId}", storePolicyDetailId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM policy.store_policy_details WHERE store_policy_detail_id < @0 ORDER BY store_policy_detail_id DESC LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Policy.StorePolicyDetail>(this._Catalog, sql, storePolicyDetailId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the next record of the table "policy.store_policy_details" sorted by storePolicyDetailId.
        /// </summary>
        /// <param name="storePolicyDetailId">The column "store_policy_detail_id" parameter used to find the next record.</param>
        /// <returns>Returns a non-live, non-mapped instance of "StorePolicyDetail" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Policy.StorePolicyDetail GetNext(long storePolicyDetailId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get the next entity of \"StorePolicyDetail\" by \"StorePolicyDetailId\" with value {StorePolicyDetailId} was denied to the user with Login ID {_LoginId}", storePolicyDetailId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM policy.store_policy_details WHERE store_policy_detail_id > @0 ORDER BY store_policy_detail_id LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Policy.StorePolicyDetail>(this._Catalog, sql, storePolicyDetailId).FirstOrDefault();
        }


        /// <summary>
        /// Gets the last record of the table "policy.store_policy_details". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "StorePolicyDetail" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Policy.StorePolicyDetail GetLast()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get the last record of entity \"StorePolicyDetail\" was denied to the user with Login ID {_LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM policy.store_policy_details ORDER BY store_policy_detail_id DESC LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Policy.StorePolicyDetail>(this._Catalog, sql).FirstOrDefault();
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.StorePolicyDetail> Get(long[] storePolicyDetailIds)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}. storePolicyDetailIds: {storePolicyDetailIds}.", this._LoginId, storePolicyDetailIds);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            return Factory.Get<MixERP.Net.Entities.Policy.StorePolicyDetail>(this._Catalog, sql, storePolicyDetailIds);
        }
        ...
        public IEnumerable<PetaPoco.CustomField> GetCustomFields(string resourceId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to get custom fields for entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to get display field for entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public object Add(dynamic storePolicyDetail)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to add entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}. {StorePolicyDetail}", this._LoginId, storePolicyDetail);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            return Factory.Insert(this._Catalog, storePolicyDetail, "policy.store_policy_details", "store_policy_detail_id");
        }
        ...
        public List<object> BulkImport(List<ExpandoObject> storePolicyDetails)
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to import entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}. {storePolicyDetails}", this._LoginId, storePolicyDetails);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            try
            {
                using (Database db = new Database(Factory.GetConnectionString(this._Catalog), Factory.ProviderName))
                {
                    ...
                    {
                        foreach (dynamic storePolicyDetail in storePolicyDetails)
                        {
                            line++;
                            ...
                            {
                                result.Add(db.Insert("policy.store_policy_details", "store_policy_detail_id", storePolicyDetail));
                            }
                        }
        ...
        public void Update(dynamic storePolicyDetail, long storePolicyDetailId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to edit entity \"StorePolicyDetail\" with Primary Key {PrimaryKey} was denied to the user with Login ID {LoginId}. {StorePolicyDetail}", storePolicyDetailId, this._LoginId, storePolicyDetail);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            Factory.Update(this._Catalog, storePolicyDetail, storePolicyDetailId, "policy.store_policy_details", "store_policy_detail_id");
        }
        ...
        public void Delete(long storePolicyDetailId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to delete entity \"StorePolicyDetail\" with Primary Key {PrimaryKey} was denied to the user with Login ID {LoginId}.", storePolicyDetailId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "DELETE FROM policy.store_policy_details WHERE store_policy_detail_id=@0;";
            Factory.NonQuery(this._Catalog, sql, storePolicyDetailId);
        }

        /// <summary>
        /// Performs a select statement on table "policy.store_policy_details" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.StorePolicyDetail> GetPaginatedResult()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the first page of the entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}.", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM policy.store_policy_details ORDER BY store_policy_detail_id LIMIT 10 OFFSET 0;";
            return Factory.Get<MixERP.Net.Entities.Policy.StorePolicyDetail>(this._Catalog, sql);
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.StorePolicyDetail> GetPaginatedResult(long pageNumber)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}.", pageNumber, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            return Factory.Get<MixERP.Net.Entities.Policy.StorePolicyDetail>(this._Catalog, sql, offset);
        }
        ...
        public long CountWhere(List<EntityParser.Filter> filters)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}. Filters: {Filters}.", this._LoginId, filters);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "policy.store_policy_details" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.StorePolicyDetail> GetWhere(long pageNumber, List<EntityParser.Filter> filters)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the filtered entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}. Filters: {Filters}.", pageNumber, this._LoginId, filters);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public long CountFiltered(string filterName)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}. Filter: {Filter}.", this._LoginId, filterName);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.StorePolicyDetail> GetFiltered(long pageNumber, string filterName)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the filtered entity \"StorePolicyDetail\" was denied to the user with Login ID {LoginId}. Filter: {Filter}.", pageNumber, this._LoginId, filterName);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
