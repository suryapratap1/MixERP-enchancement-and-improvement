...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    /// </summary>
    public class PostErFluctuationProcedure : DbAccess, IPostErFluctuationRepository
    {
        /// <summary>
        ...
        public void Execute()
        {
            ...
            string query = "SELECT * FROM transactions.post_er_fluctuation(@UserId, @LoginId, @OfficeId, @ValueDate);";
