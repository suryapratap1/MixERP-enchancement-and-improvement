...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    /// </summary>
    public class GetRetainedEarningsProcedure : DbAccess, IGetRetainedEarningsRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_retained_earnings";
        /// <summary>
        ...
        public decimal Execute()
        {
            ...
            string query = "SELECT * FROM transactions.get_retained_earnings(@DateTo, @OfficeId, @Factor);";
