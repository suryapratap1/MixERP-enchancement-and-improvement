...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    /// </summary>
    public class PostStockJournalProcedure : DbAccess, IPostStockJournalRepository
    {
        /// <summary>
        ...
        public long Execute()
        {
            ...
            string query = "SELECT * FROM transactions.post_stock_journal(@OfficeId, @UserId, @LoginId, @ValueDate, @ReferenceNumber, @StatementReference, @Details);";
