...
namespace MixERP.Net.Schemas.Transactions.Data
{
    public interface ILateFeeRepository
    {
        ...
        IEnumerable<MixERP.Net.Entities.Transactions.LateFee> GetAll();
        ...
        /// <summary>
        /// Returns a single instance of the LateFee against transactionMasterId. 
        /// </summary>
        ...
        /// <summary>
        /// Returns multiple instances of the LateFee against transactionMasterIds. 
        /// </summary>
        ...
        IEnumerable<MixERP.Net.Entities.Transactions.LateFee> Get(long[] transactionMasterIds);
        ...
        void Update(dynamic lateFee, long transactionMasterId);
        ...
        IEnumerable<MixERP.Net.Entities.Transactions.LateFee> GetPaginatedResult();
        ...
        IEnumerable<MixERP.Net.Entities.Transactions.LateFee> GetPaginatedResult(long pageNumber);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of LateFee class.</returns>
        IEnumerable<MixERP.Net.Entities.Transactions.LateFee> GetWhere(long pageNumber, List<EntityParser.Filter> filters);
        ...
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of LateFee class.</returns>
        IEnumerable<MixERP.Net.Entities.Transactions.LateFee> GetFiltered(long pageNumber, string filterName);
