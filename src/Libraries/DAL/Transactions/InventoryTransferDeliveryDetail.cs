...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    /// </summary>
    public class InventoryTransferDeliveryDetail : DbAccess, IInventoryTransferDeliveryDetailRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "inventory_transfer_delivery_details";
        ...
        public long Count()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}", this._LoginId);
        ...
        /// <summary>
        /// Executes a select query on the table "transactions.inventory_transfer_delivery_details" to return all instances of the "InventoryTransferDeliveryDetail" class. 
        /// </summary>
        ...
        /// <summary>
        /// Executes a select query on the table "transactions.inventory_transfer_delivery_details" to return all instances of the "InventoryTransferDeliveryDetail" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "InventoryTransferDeliveryDetail" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        public MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail Get(long inventoryTransferDeliveryDetailId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get entity \"InventoryTransferDeliveryDetail\" filtered by \"InventoryTransferDeliveryDetailId\" with value {InventoryTransferDeliveryDetailId} was denied to the user with Login ID {_LoginId}", inventoryTransferDeliveryDetailId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            return Factory.Get<MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail>(this._Catalog, sql, inventoryTransferDeliveryDetailId).FirstOrDefault();
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail> Get(long[] inventoryTransferDeliveryDetailIds)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}. inventoryTransferDeliveryDetailIds: {inventoryTransferDeliveryDetailIds}.", this._LoginId, inventoryTransferDeliveryDetailIds);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            return Factory.Get<MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail>(this._Catalog, sql, inventoryTransferDeliveryDetailIds);
        }
        ...
        public IEnumerable<PetaPoco.CustomField> GetCustomFields(string resourceId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to get custom fields for entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to get display field for entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public object AddOrEdit(dynamic inventoryTransferDeliveryDetail, List<EntityParser.CustomField> customFields)
        {
            ...
            object primaryKeyValue = inventoryTransferDeliveryDetail.inventory_transfer_delivery_detail_id;
        ...
        public object Add(dynamic inventoryTransferDeliveryDetail)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to add entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}. {InventoryTransferDeliveryDetail}", this._LoginId, inventoryTransferDeliveryDetail);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public List<object> BulkImport(List<ExpandoObject> inventoryTransferDeliveryDetails)
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to import entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}. {inventoryTransferDeliveryDetails}", this._LoginId, inventoryTransferDeliveryDetails);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public void Update(dynamic inventoryTransferDeliveryDetail, long inventoryTransferDeliveryDetailId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to edit entity \"InventoryTransferDeliveryDetail\" with Primary Key {PrimaryKey} was denied to the user with Login ID {LoginId}. {InventoryTransferDeliveryDetail}", inventoryTransferDeliveryDetailId, this._LoginId, inventoryTransferDeliveryDetail);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public void Delete(long inventoryTransferDeliveryDetailId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to delete entity \"InventoryTransferDeliveryDetail\" with Primary Key {PrimaryKey} was denied to the user with Login ID {LoginId}.", inventoryTransferDeliveryDetailId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            Factory.NonQuery(this._Catalog, sql, inventoryTransferDeliveryDetailId);
        }

        /// <summary>
        /// Performs a select statement on table "transactions.inventory_transfer_delivery_details" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail> GetPaginatedResult()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the first page of the entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}.", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM transactions.inventory_transfer_delivery_details ORDER BY inventory_transfer_delivery_detail_id LIMIT 10 OFFSET 0;";
            return Factory.Get<MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail>(this._Catalog, sql);
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail> GetPaginatedResult(long pageNumber)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}.", pageNumber, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            return Factory.Get<MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail>(this._Catalog, sql, offset);
        }
        ...
        public long CountWhere(List<EntityParser.Filter> filters)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}. Filters: {Filters}.", this._LoginId, filters);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "transactions.inventory_transfer_delivery_details" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail> GetWhere(long pageNumber, List<EntityParser.Filter> filters)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the filtered entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}. Filters: {Filters}.", pageNumber, this._LoginId, filters);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public long CountFiltered(string filterName)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}. Filter: {Filter}.", this._LoginId, filterName);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail> GetFiltered(long pageNumber, string filterName)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the filtered entity \"InventoryTransferDeliveryDetail\" was denied to the user with Login ID {LoginId}. Filter: {Filter}.", pageNumber, this._LoginId, filterName);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
