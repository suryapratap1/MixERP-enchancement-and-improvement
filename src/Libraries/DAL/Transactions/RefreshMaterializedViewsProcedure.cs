...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    public class RefreshMaterializedViewsProcedure : DbAccess, IRefreshMaterializedViewsRepository
    {
        ...
        /// </summary>
        public override string _ObjectName => "refresh_materialized_views";
        /// <summary>
        ...
        /// <param name="loginId">Enter argument value for "_login_id" parameter of the function "transactions.refresh_materialized_views".</param>
        ...
        public RefreshMaterializedViewsProcedure(int userId, long loginId, int officeId, DateTime valueDate)
        {
            this.UserId = userId;
        ...
        public void Execute()
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the function \"RefreshMaterializedViewsProcedure\" was denied to the user with Login ID {LoginId}.", this._LoginId);
