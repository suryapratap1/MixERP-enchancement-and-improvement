...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    /// </summary>
    public class PostOpeningInventoryProcedure : DbAccess, IPostOpeningInventoryRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "post_opening_inventory";
        /// <summary>
        ...
        /// <summary>
        /// Maps to "_office_id" argument of the function "transactions.post_opening_inventory".
        /// </summary>
        public int OfficeId { get; set; }
        /// <summary>
        /// Maps to "_user_id" argument of the function "transactions.post_opening_inventory".
        /// </summary>
        public int UserId { get; set; }
        /// <summary>
        /// Maps to "_login_id" argument of the function "transactions.post_opening_inventory".
        /// </summary>
        public long LoginId { get; set; }
        /// <summary>
        /// Maps to "_value_date" argument of the function "transactions.post_opening_inventory".
        /// </summary>
        public DateTime ValueDate { get; set; }
        /// <summary>
        /// Maps to "_reference_number" argument of the function "transactions.post_opening_inventory".
        /// </summary>
        public string ReferenceNumber { get; set; }
        /// <summary>
        /// Maps to "_statement_reference" argument of the function "transactions.post_opening_inventory".
        /// </summary>
        public string StatementReference { get; set; }
        /// <summary>
        /// Maps to "_details" argument of the function "transactions.post_opening_inventory".
        /// </summary>
        public MixERP.Net.Entities.Transactions.OpeningStockType[] Details { get; set; }

        /// <summary>
        /// Prepares, validates, and executes the function "transactions.post_opening_inventory(_office_id integer, _user_id integer, _login_id bigint, _value_date date, _reference_number character varying, _statement_reference text, _details transactions.opening_stock_type[])" on the database.
        /// </summary>
        public PostOpeningInventoryProcedure()
        {
        }
        ...
        /// <summary>
        /// Prepares and executes the function "transactions.post_opening_inventory".
        /// </summary>
        ...
        public long Execute()
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the function \"PostOpeningInventoryProcedure\" was denied to the user with Login ID {LoginId}.", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            string query = "SELECT * FROM transactions.post_opening_inventory(@OfficeId, @UserId, @LoginId, @ValueDate, @ReferenceNumber, @StatementReference, @Details);";
        ...
        private string SqlForDetails(MixERP.Net.Entities.Transactions.OpeningStockType[] details, int offset, int memberCount)
        {
            if (details == null)
            {
            ...
            for (int i = 0; i < details.Count(); i++)
            {
                ...
                string parameter = "ROW({0})::transactions.opening_stock_type";
