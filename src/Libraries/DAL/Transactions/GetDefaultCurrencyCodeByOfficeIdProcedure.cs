...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    /// </summary>
    public class GetDefaultCurrencyCodeByOfficeIdProcedure : DbAccess, IGetDefaultCurrencyCodeByOfficeIdRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_default_currency_code_by_office_id";
        /// <summary>
        ...
        public string Execute()
        {
            ...
            string query = "SELECT * FROM transactions.get_default_currency_code_by_office_id(@OfficeId);";
