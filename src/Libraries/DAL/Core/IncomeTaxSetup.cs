...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class IncomeTaxSetup : DbAccess, IIncomeTaxSetupRepository
    {
        /// <summary>
        ...
        /// <summary>
        /// Executes a select query on the table "core.income_tax_setup" to return all instances of the "IncomeTaxSetup" class. 
        /// </summary>
        ...
        /// <summary>
        /// Executes a select query on the table "core.income_tax_setup" to return all instances of the "IncomeTaxSetup" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "IncomeTaxSetup" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        public object Add(dynamic incomeTaxSetup)
        {
            ...
            return Factory.Insert(this._Catalog, incomeTaxSetup, "core.income_tax_setup", "income_tax_setup_id");
        }
        ...
        public List<object> BulkImport(List<ExpandoObject> incomeTaxSetups)
        {
            ...
            try
            {
                using (Database db = new Database(Factory.GetConnectionString(this._Catalog), Factory.ProviderName))
                {
                    ...
                    {
                        foreach (dynamic incomeTaxSetup in incomeTaxSetups)
                        {
                            line++;
                            ...
                            {
                                result.Add(db.Insert("core.income_tax_setup", "income_tax_setup_id", incomeTaxSetup));
                            }
                        }
        ...
        public void Update(dynamic incomeTaxSetup, int incomeTaxSetupId)
        {
            ...
            Factory.Update(this._Catalog, incomeTaxSetup, incomeTaxSetupId, "core.income_tax_setup", "income_tax_setup_id");
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.income_tax_setup" producing a paginated result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.income_tax_setup" producing a paginated result of 10.
        /// </summary>
