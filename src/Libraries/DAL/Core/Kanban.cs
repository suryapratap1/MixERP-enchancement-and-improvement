...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class Kanban : DbAccess, IKanbanRepository
    {
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Kanban> GetAll()
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Core.Kanban>(this._Catalog, sql);
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Kanban> Get(long[] kanbanIds)
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Core.Kanban>(this._Catalog, sql, kanbanIds);
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Kanban> GetPaginatedResult(long pageNumber)
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Core.Kanban>(this._Catalog, sql, offset);
        }
        ...
        public long CountWhere(List<EntityParser.Filter> filters)
        {
            ...
            MixERP.Net.EntityParser.Data.Service.AddFilters(ref sql, new MixERP.Net.Entities.Core.Kanban(), filters);
