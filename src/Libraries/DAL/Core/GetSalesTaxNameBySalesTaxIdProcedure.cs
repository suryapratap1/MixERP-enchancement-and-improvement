...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class GetSalesTaxNameBySalesTaxIdProcedure : DbAccess, IGetSalesTaxNameBySalesTaxIdRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_sales_tax_name_by_sales_tax_id";
        /// <summary>
        ...
        public string Execute()
        {
            ...
            string query = "SELECT * FROM core.get_sales_tax_name_by_sales_tax_id(@SalesTaxId);";
