...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class GetBaseQuantityByUnitIdProcedure : DbAccess, IGetBaseQuantityByUnitIdRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_base_quantity_by_unit_id";
        /// <summary>
        ...
        public decimal Execute()
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the function \"GetBaseQuantityByUnitIdProcedure\" was denied to the user with Login ID {LoginId}.", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            string query = "SELECT * FROM core.get_base_quantity_by_unit_id(@PgArg0, @PgArg1);";
