...
namespace MixERP.Net.Schemas.Core.Data
{
    public interface IFlagViewRepository
    {
        ...
        IEnumerable<MixERP.Net.Entities.Core.FlagView> Get();
        ...
        IEnumerable<MixERP.Net.Entities.Core.FlagView> GetPaginatedResult();
        ...
        IEnumerable<MixERP.Net.Entities.Core.FlagView> GetPaginatedResult(long pageNumber);
        ...
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "FlagView" class.</returns>
        IEnumerable<MixERP.Net.Entities.Core.FlagView> GetWhere(long pageNumber, List<EntityParser.Filter> filters);
        ...
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns collection of "FlagView" class.</returns>
        IEnumerable<MixERP.Net.Entities.Core.FlagView> GetFiltered(long pageNumber, string filterName);


        IEnumerable<MixERP.Net.Entities.Core.FlagView> Get(string resource, int userId, object[] resourceIds);
