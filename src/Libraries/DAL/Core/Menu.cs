...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class Menu : DbAccess, IMenuRepository
    {
        ...
        /// <summary>
        /// Executes a select query on the table "core.menus" to return all instances of the "Menu" class. 
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Menu> GetAll()
        {
            ...
            const string sql = "SELECT * FROM core.menus ORDER BY menu_id;";
            return Factory.Get<MixERP.Net.Entities.Core.Menu>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "core.menus" to return all instances of the "Menu" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "Menu" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Menu> Get(int[] menuIds)
        {
            ...
            const string sql = "SELECT * FROM core.menus WHERE menu_id IN (@0);";

            return Factory.Get<MixERP.Net.Entities.Core.Menu>(this._Catalog, sql, menuIds);
        }

        /// <summary>
        /// Custom fields are user defined form elements for core.menus.
        /// </summary>
        /// <returns>Returns an enumerable custom field collection for the table core.menus</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public IEnumerable<PetaPoco.CustomField> GetCustomFields(string resourceId)
        {
            ...
            {
                sql = "SELECT * FROM core.custom_field_definition_view WHERE table_name='core.menus' ORDER BY field_order;";
                return Factory.Get<PetaPoco.CustomField>(this._Catalog, sql);
            }

            sql = "SELECT * from core.get_custom_field_definition('core.menus'::text, @0::text) ORDER BY field_order;";
        ...
        /// <summary>
        /// Inserts or updates the instance of Menu class on the database table "core.menus".
        /// </summary>
        ...
        public object AddOrEdit(dynamic menu, List<EntityParser.CustomField> customFields)
        {
            ...
            {
                primaryKeyValue = menu.menu_id;
                this.Update(menu, int.Parse(menu.menu_id));
            }
            else
            {
            ...
            string sql = "DELETE FROM core.custom_fields WHERE custom_field_setup_id IN(" +
                         ...
                         "WHERE form_name=core.get_custom_field_form_name('core.menus')" +
                         ");";
            ...
            foreach (var field in customFields)
            {
                sql = "INSERT INTO core.custom_fields(custom_field_setup_id, resource_id, value) " +
                      "SELECT core.get_custom_field_setup_id_by_table_name('core.menus', @0::character varying(100)), " +
                      "@1, @2;";
        ...
        public object Add(dynamic menu)
        {
            ...
            return Factory.Insert(this._Catalog, menu, "core.menus", "menu_id");
        }

        /// <summary>
        /// Inserts or updates multiple instances of Menu class on the database table "core.menus";
        /// </summary>
                    ...
                    using (Transaction transaction = db.GetTransaction())
                    {
                        foreach (dynamic menu in menus)
                        {
                            ...
                            if (Cast.To<int>(primaryKeyValue) > 0)
                            {
                                ...
                                db.Update("core.menus", "menu_id", menu, menu.menu_id);
                            }
                            else
                            {
                                result.Add(db.Insert("core.menus", "menu_id", menu));
                            }
                        }
        ...
        public void Update(dynamic menu, int menuId)
        {
            ...
            Factory.Update(this._Catalog, menu, menuId, "core.menus", "menu_id");
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Menu> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM core.menus ORDER BY menu_id LIMIT 10 OFFSET 0;";
            return Factory.Get<MixERP.Net.Entities.Core.Menu>(this._Catalog, sql);
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Menu> GetPaginatedResult(long pageNumber)
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Core.Menu>(this._Catalog, sql, offset);
        }

        public List<EntityParser.Filter> GetFilters(string catalog, string filterName)
        {
            const string sql = "SELECT * FROM core.filters WHERE object_name='core.menus' AND lower(filter_name)=lower(@0);";
            return Factory.Get<EntityParser.Filter>(catalog, sql, filterName).ToList();
        }

        /// <summary>
        /// Performs a filtered count on table "core.menus".
        /// </summary>
        ...
        public long CountWhere(List<EntityParser.Filter> filters)
        {
            ...
            Sql sql = Sql.Builder.Append("SELECT COUNT(*) FROM core.menus WHERE 1 = 1");
