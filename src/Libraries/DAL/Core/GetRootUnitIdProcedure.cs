...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class GetRootUnitIdProcedure : DbAccess, IGetRootUnitIdRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_root_unit_id";
        /// <summary>
        ...
        public int Execute()
        {
            ...
            string query = "SELECT * FROM core.get_root_unit_id(@PgArg0);";
