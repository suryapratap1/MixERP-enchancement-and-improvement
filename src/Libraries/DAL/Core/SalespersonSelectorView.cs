...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class SalespersonSelectorView : DbAccess, ISalespersonSelectorViewRepository
    {
        /// <summary>
        ...
        /// <summary>
        /// Executes a select query on the view "core.salesperson_selector_view" to return all instances of the "SalespersonSelectorView" class. 
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalespersonSelectorView> Get()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the export entity \"SalespersonSelectorView\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM core.salesperson_selector_view ORDER BY 1;";
        ...
        /// <summary>
        /// Performs a select statement on the view "core.salesperson_selector_view" producing a paginated result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on view "core.salesperson_selector_view" producing a paginated result of 10.
        /// </summary>
