...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class PartyTypeSelectorView : DbAccess, IPartyTypeSelectorViewRepository
    {
        /// <summary>
        ...
        /// <summary>
        /// Executes a select query on the view "core.party_type_selector_view" to return all instances of the "PartyTypeSelectorView" class. 
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.PartyTypeSelectorView> Get()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the export entity \"PartyTypeSelectorView\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM core.party_type_selector_view ORDER BY 1;";
        ...
        /// <summary>
        /// Performs a select statement on the view "core.party_type_selector_view" producing a paginated result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on view "core.party_type_selector_view" producing a paginated result of 10.
        /// </summary>
