...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class Frequency : DbAccess, IFrequencyRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "frequencies";
        ...
        public long Count()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"Frequency\" was denied to the user with Login ID {LoginId}", this._LoginId);
        ...
        /// <summary>
        /// Executes a select query on the table "core.frequencies" to return all instances of the "Frequency" class. 
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Frequency> GetAll()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the export entity \"Frequency\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM core.frequencies ORDER BY frequency_id;";
            return Factory.Get<MixERP.Net.Entities.Core.Frequency>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "core.frequencies" to return all instances of the "Frequency" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "Frequency" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        public MixERP.Net.Entities.Core.Frequency Get(int frequencyId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get entity \"Frequency\" filtered by \"FrequencyId\" with value {FrequencyId} was denied to the user with Login ID {_LoginId}", frequencyId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM core.frequencies WHERE frequency_id=@0;";
            return Factory.Get<MixERP.Net.Entities.Core.Frequency>(this._Catalog, sql, frequencyId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the first record of the table "core.frequencies". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "Frequency" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Core.Frequency GetFirst()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get the first record of entity \"Frequency\" was denied to the user with Login ID {_LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM core.frequencies ORDER BY frequency_id LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.Frequency>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Gets the previous record of the table "core.frequencies" sorted by frequencyId.
        /// </summary>
        ...
        public MixERP.Net.Entities.Core.Frequency GetPrevious(int frequencyId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get the previous entity of \"Frequency\" by \"FrequencyId\" with value {FrequencyId} was denied to the user with Login ID {_LoginId}", frequencyId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM core.frequencies WHERE frequency_id < @0 ORDER BY frequency_id DESC LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.Frequency>(this._Catalog, sql, frequencyId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the next record of the table "core.frequencies" sorted by frequencyId.
        /// </summary>
        /// <param name="frequencyId">The column "frequency_id" parameter used to find the next record.</param>
        /// <returns>Returns a non-live, non-mapped instance of "Frequency" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Core.Frequency GetNext(int frequencyId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get the next entity of \"Frequency\" by \"FrequencyId\" with value {FrequencyId} was denied to the user with Login ID {_LoginId}", frequencyId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM core.frequencies WHERE frequency_id > @0 ORDER BY frequency_id LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.Frequency>(this._Catalog, sql, frequencyId).FirstOrDefault();
        }


        /// <summary>
        /// Gets the last record of the table "core.frequencies". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "Frequency" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Core.Frequency GetLast()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the get the last record of entity \"Frequency\" was denied to the user with Login ID {_LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM core.frequencies ORDER BY frequency_id DESC LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.Frequency>(this._Catalog, sql).FirstOrDefault();
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Frequency> Get(int[] frequencyIds)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to entity \"Frequency\" was denied to the user with Login ID {LoginId}. frequencyIds: {frequencyIds}.", this._LoginId, frequencyIds);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            return Factory.Get<MixERP.Net.Entities.Core.Frequency>(this._Catalog, sql, frequencyIds);
        }
        ...
        public IEnumerable<PetaPoco.CustomField> GetCustomFields(string resourceId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to get custom fields for entity \"Frequency\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to get display field for entity \"Frequency\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public object Add(dynamic frequency)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to add entity \"Frequency\" was denied to the user with Login ID {LoginId}. {Frequency}", this._LoginId, frequency);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            return Factory.Insert(this._Catalog, frequency, "core.frequencies", "frequency_id");
        }
        ...
        public List<object> BulkImport(List<ExpandoObject> frequencies)
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to import entity \"Frequency\" was denied to the user with Login ID {LoginId}. {frequencies}", this._LoginId, frequencies);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            try
            {
                using (Database db = new Database(Factory.GetConnectionString(this._Catalog), Factory.ProviderName))
                {
                    ...
                    {
                        foreach (dynamic frequency in frequencies)
                        {
                            line++;
                            ...
                            {
                                result.Add(db.Insert("core.frequencies", "frequency_id", frequency));
                            }
                        }
        ...
        public void Update(dynamic frequency, int frequencyId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to edit entity \"Frequency\" with Primary Key {PrimaryKey} was denied to the user with Login ID {LoginId}. {Frequency}", frequencyId, this._LoginId, frequency);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            Factory.Update(this._Catalog, frequency, frequencyId, "core.frequencies", "frequency_id");
        }
        ...
        public void Delete(int frequencyId)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to delete entity \"Frequency\" with Primary Key {PrimaryKey} was denied to the user with Login ID {LoginId}.", frequencyId, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "DELETE FROM core.frequencies WHERE frequency_id=@0;";
            Factory.NonQuery(this._Catalog, sql, frequencyId);
        }

        /// <summary>
        /// Performs a select statement on table "core.frequencies" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Frequency> GetPaginatedResult()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the first page of the entity \"Frequency\" was denied to the user with Login ID {LoginId}.", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM core.frequencies ORDER BY frequency_id LIMIT 10 OFFSET 0;";
            return Factory.Get<MixERP.Net.Entities.Core.Frequency>(this._Catalog, sql);
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Frequency> GetPaginatedResult(long pageNumber)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the entity \"Frequency\" was denied to the user with Login ID {LoginId}.", pageNumber, this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            ...
            return Factory.Get<MixERP.Net.Entities.Core.Frequency>(this._Catalog, sql, offset);
        }
        ...
        public long CountWhere(List<EntityParser.Filter> filters)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"Frequency\" was denied to the user with Login ID {LoginId}. Filters: {Filters}.", this._LoginId, filters);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.frequencies" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Frequency> GetWhere(long pageNumber, List<EntityParser.Filter> filters)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the filtered entity \"Frequency\" was denied to the user with Login ID {LoginId}. Filters: {Filters}.", pageNumber, this._LoginId, filters);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public long CountFiltered(string filterName)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to count entity \"Frequency\" was denied to the user with Login ID {LoginId}. Filter: {Filter}.", this._LoginId, filterName);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Frequency> GetFiltered(long pageNumber, string filterName)
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to Page #{Page} of the filtered entity \"Frequency\" was denied to the user with Login ID {LoginId}. Filter: {Filter}.", pageNumber, this._LoginId, filterName);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
