...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class CustomField : DbAccess, ICustomFieldRepository
    {
        ...
        /// <summary>
        /// Executes a select query on the table "core.custom_fields" to return all instances of the "CustomField" class. 
        /// </summary>
        ...
        /// <summary>
        /// Executes a select query on the table "core.custom_fields" to return all instances of the "CustomField" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "CustomField" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        /// <summary>
        /// Gets the first record of the table "core.custom_fields". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "CustomField" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Core.CustomField GetFirst()
        {
            ...
            const string sql = "SELECT * FROM core.custom_fields ORDER BY custom_field_id LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.CustomField>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Gets the previous record of the table "core.custom_fields" sorted by customFieldId.
        /// </summary>
        ...
        public MixERP.Net.Entities.Core.CustomField GetPrevious(long customFieldId)
        {
            ...
            const string sql = "SELECT * FROM core.custom_fields WHERE custom_field_id < @0 ORDER BY custom_field_id DESC LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.CustomField>(this._Catalog, sql, customFieldId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the next record of the table "core.custom_fields" sorted by customFieldId.
        /// </summary>
        /// <param name="customFieldId">The column "custom_field_id" parameter used to find the next record.</param>
        /// <returns>Returns a non-live, non-mapped instance of "CustomField" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Core.CustomField GetNext(long customFieldId)
        {
            ...
            const string sql = "SELECT * FROM core.custom_fields WHERE custom_field_id > @0 ORDER BY custom_field_id LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.CustomField>(this._Catalog, sql, customFieldId).FirstOrDefault();
        }


        /// <summary>
        /// Gets the last record of the table "core.custom_fields". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "CustomField" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Core.CustomField GetLast()
        {
            ...
            const string sql = "SELECT * FROM core.custom_fields ORDER BY custom_field_id DESC LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.CustomField>(this._Catalog, sql).FirstOrDefault();
        }
        ...
        public object Add(dynamic customField)
        {
            ...
            return Factory.Insert(this._Catalog, customField, "core.custom_fields", "custom_field_id");
        }
                ...
                using (Database db = new Database(Factory.GetConnectionString(this._Catalog), Factory.ProviderName))
                {
                    using (Transaction transaction = db.GetTransaction())
                    {
                        foreach (dynamic customField in customFields)
                        {
                            ...
                            {
                                result.Add(db.Insert("core.custom_fields", "custom_field_id", customField));
                            }
                        }
        ...
        public void Update(dynamic customField, long customFieldId)
        {
            ...
            Factory.Update(this._Catalog, customField, customFieldId, "core.custom_fields", "custom_field_id");
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.custom_fields" producing a paginated result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.custom_fields" producing a paginated result of 10.
        /// </summary>
