...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class GetItemGroupIdByItemGroupNameProcedure : DbAccess, IGetItemGroupIdByItemGroupNameRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_item_group_id_by_item_group_name";
        /// <summary>
        ...
        public int Execute()
        {
            ...
            string query = "SELECT * FROM core.get_item_group_id_by_item_group_name(@PgArg0);";
