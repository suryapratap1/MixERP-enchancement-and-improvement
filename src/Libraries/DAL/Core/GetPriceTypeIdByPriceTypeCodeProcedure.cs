...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class GetPriceTypeIdByPriceTypeCodeProcedure : DbAccess, IGetPriceTypeIdByPriceTypeCodeRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_price_type_id_by_price_type_code";
        /// <summary>
        ...
        public int Execute()
        {
            ...
            string query = "SELECT * FROM core.get_price_type_id_by_price_type_code(@PgArg0);";
