...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class CustomFieldSetup : DbAccess, ICustomFieldSetupRepository
    {
        ...
        /// <summary>
        /// Executes a select query on the table "core.custom_field_setup" to return all instances of the "CustomFieldSetup" class. 
        /// </summary>
        ...
        /// <summary>
        /// Executes a select query on the table "core.custom_field_setup" to return all instances of the "CustomFieldSetup" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "CustomFieldSetup" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        public MixERP.Net.Entities.Core.CustomFieldSetup Get(int customFieldSetupId)
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Core.CustomFieldSetup>(this._Catalog, sql, customFieldSetupId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the first record of the table "core.custom_field_setup". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "CustomFieldSetup" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Core.CustomFieldSetup GetFirst()
        {
            ...
            const string sql = "SELECT * FROM core.custom_field_setup ORDER BY custom_field_setup_id LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.CustomFieldSetup>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Gets the previous record of the table "core.custom_field_setup" sorted by customFieldSetupId.
        /// </summary>
        ...
        public MixERP.Net.Entities.Core.CustomFieldSetup GetPrevious(int customFieldSetupId)
        {
            ...
            const string sql = "SELECT * FROM core.custom_field_setup WHERE custom_field_setup_id < @0 ORDER BY custom_field_setup_id DESC LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.CustomFieldSetup>(this._Catalog, sql, customFieldSetupId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the next record of the table "core.custom_field_setup" sorted by customFieldSetupId.
        /// </summary>
        /// <param name="customFieldSetupId">The column "custom_field_setup_id" parameter used to find the next record.</param>
        /// <returns>Returns a non-live, non-mapped instance of "CustomFieldSetup" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Core.CustomFieldSetup GetNext(int customFieldSetupId)
        {
            ...
            const string sql = "SELECT * FROM core.custom_field_setup WHERE custom_field_setup_id > @0 ORDER BY custom_field_setup_id LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.CustomFieldSetup>(this._Catalog, sql, customFieldSetupId).FirstOrDefault();
        }


        /// <summary>
        /// Gets the last record of the table "core.custom_field_setup". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "CustomFieldSetup" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Core.CustomFieldSetup GetLast()
        {
            ...
            const string sql = "SELECT * FROM core.custom_field_setup ORDER BY custom_field_setup_id DESC LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Core.CustomFieldSetup>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Executes a select query on the table "core.custom_field_setup" with a where filter on the column "custom_field_setup_id" to return a multiple instances of the "CustomFieldSetup" class. 
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CustomFieldSetup> Get(int[] customFieldSetupIds)
        {
            ...
            const string sql = "SELECT * FROM core.custom_field_setup WHERE custom_field_setup_id IN (@0);";

            return Factory.Get<MixERP.Net.Entities.Core.CustomFieldSetup>(this._Catalog, sql, customFieldSetupIds);
        }
        ...
        public IEnumerable<PetaPoco.CustomField> GetCustomFields(string resourceId)
        {
            ...
            {
                sql = "SELECT * FROM core.custom_field_definition_view WHERE table_name='core.custom_field_setup' ORDER BY field_order;";
                return Factory.Get<PetaPoco.CustomField>(this._Catalog, sql);
            }

            sql = "SELECT * from core.get_custom_field_definition('core.custom_field_setup'::text, @0::text) ORDER BY field_order;";
        ...
        /// <summary>
        /// Inserts or updates the instance of CustomFieldSetup class on the database table "core.custom_field_setup".
        /// </summary>
        ...
        public object AddOrEdit(dynamic customFieldSetup, List<EntityParser.CustomField> customFields)
        {
            ...
            string sql = "DELETE FROM core.custom_fields WHERE custom_field_setup_id IN(" +
                         ...
                         "WHERE form_name=core.get_custom_field_form_name('core.custom_field_setup')" +
                         ");";
            ...
            foreach (var field in customFields)
            {
                sql = "INSERT INTO core.custom_fields(custom_field_setup_id, resource_id, value) " +
                      "SELECT core.get_custom_field_setup_id_by_table_name('core.custom_field_setup', @0::character varying(100)), " +
                      "@1, @2;";
        ...
        /// <summary>
        /// Inserts or updates multiple instances of CustomFieldSetup class on the database table "core.custom_field_setup";
        /// </summary>
        ...
        /// <summary>
        /// Performs a select statement on table "core.custom_field_setup" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CustomFieldSetup> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM core.custom_field_setup ORDER BY custom_field_setup_id LIMIT 10 OFFSET 0;";
            return Factory.Get<MixERP.Net.Entities.Core.CustomFieldSetup>(this._Catalog, sql);
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CustomFieldSetup> GetPaginatedResult(long pageNumber)
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Core.CustomFieldSetup>(this._Catalog, sql, offset);
        }

        public List<EntityParser.Filter> GetFilters(string catalog, string filterName)
        {
            const string sql = "SELECT * FROM core.filters WHERE object_name='core.custom_field_setup' AND lower(filter_name)=lower(@0);";
            return Factory.Get<EntityParser.Filter>(catalog, sql, filterName).ToList();
        }

        /// <summary>
        /// Performs a filtered count on table "core.custom_field_setup".
        /// </summary>
        ...
        public long CountWhere(List<EntityParser.Filter> filters)
        {
            ...
            Sql sql = Sql.Builder.Append("SELECT COUNT(*) FROM core.custom_field_setup WHERE 1 = 1");
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.custom_field_setup" producing a paginated result of 10.
        /// </summary>
