...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class GetMonthEndDateProcedure : DbAccess, IGetMonthEndDateRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_month_end_date";
        /// <summary>
        ...
        public DateTime Execute()
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the function \"GetMonthEndDateProcedure\" was denied to the user with Login ID {LoginId}.", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            string query = "SELECT * FROM core.get_month_end_date(@OfficeId);";
