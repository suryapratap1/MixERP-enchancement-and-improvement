...
namespace MixERP.Net.Schemas.Core.Data
{
    public interface ICustomFieldRepository
    {
        ...
        IEnumerable<MixERP.Net.Entities.Core.CustomField> GetAll();
        ...
        object AddOrEdit(dynamic customField, List<EntityParser.CustomField> customFields);
        ...
        IEnumerable<MixERP.Net.Entities.Core.CustomField> GetPaginatedResult();
        ...
        IEnumerable<MixERP.Net.Entities.Core.CustomField> GetPaginatedResult(long pageNumber);
