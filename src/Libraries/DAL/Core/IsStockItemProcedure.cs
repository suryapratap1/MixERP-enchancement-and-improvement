...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class IsStockItemProcedure : DbAccess, IIsStockItemRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "is_stock_item";
        /// <summary>
        ...
        public bool Execute()
        {
            ...
            string query = "SELECT * FROM core.is_stock_item(@ItemId);";
