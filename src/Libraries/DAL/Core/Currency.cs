...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class Currency : DbAccess, ICurrencyRepository
    {
        ...
        /// <summary>
        /// Executes a select query on the table "core.currencies" to return all instances of the "Currency" class. 
        /// </summary>
        ...
        /// <summary>
        /// Executes a select query on the table "core.currencies" to return all instances of the "Currency" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "Currency" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Currency> Get(string[] currencyCodes)
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Core.Currency>(this._Catalog, sql, currencyCodes);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.currencies" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Currency> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM core.currencies ORDER BY currency_code LIMIT 10 OFFSET 0;";
            return Factory.Get<MixERP.Net.Entities.Core.Currency>(this._Catalog, sql);
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Currency> GetPaginatedResult(long pageNumber)
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Core.Currency>(this._Catalog, sql, offset);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.currencies" producing a paginated result of 10.
        /// </summary>
