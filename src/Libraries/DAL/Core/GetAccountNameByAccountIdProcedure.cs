...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    /// </summary>
    public class GetAccountNameByAccountIdProcedure : DbAccess, IGetAccountNameByAccountIdRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_account_name_by_account_id";
        /// <summary>
        ...
        public string Execute()
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the function \"GetAccountNameByAccountIdProcedure\" was denied to the user with Login ID {LoginId}.", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            string query = "SELECT * FROM core.get_account_name_by_account_id(@AccountId);";
