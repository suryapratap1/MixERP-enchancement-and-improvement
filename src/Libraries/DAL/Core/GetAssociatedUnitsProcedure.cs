...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class GetAssociatedUnitsProcedure : DbAccess, IGetAssociatedUnitsRepository
    {
        ...
        /// </summary>
        public override string _ObjectName => "get_associated_units";
        /// <summary>
        ...
        public IEnumerable<DbGetAssociatedUnitsResult> Execute()
        {
            ...
            string query = "SELECT * FROM core.get_associated_units(@PgArg0);";
            ...
            return Factory.Get<DbGetAssociatedUnitsResult>(this._Catalog, query, parameters.ToArray());
        }
