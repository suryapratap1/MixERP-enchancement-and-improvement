...
namespace MixERP.Net.Schemas.Office.Data
{
    ...
    /// </summary>
    public class GetStoresProcedure : DbAccess, IGetStoresRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_stores";
        /// <summary>
        ...
        public IEnumerable<DbGetStoresResult> Execute()
        {
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the function \"GetStoresProcedure\" was denied to the user with Login ID {LoginId}.", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }
            string query = "SELECT * FROM office.get_stores(@OfficeId, @UserId);";
            ...
            return Factory.Get<DbGetStoresResult>(this._Catalog, query, parameters.ToArray());
        }
