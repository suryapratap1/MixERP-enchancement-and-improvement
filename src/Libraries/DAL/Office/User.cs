...
namespace MixERP.Net.Schemas.Office.Data
{
    ...
    public class User : DbAccess, IUserRepository
    {
        ...
        /// <summary>
        /// Executes a select query on the table "office.users" to return all instances of the "User" class. 
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.User> GetAll()
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Office.User>(this._Catalog, sql);
        }

        /// <summary>
        /// Executes a select query on the table "office.users" to return all instances of the "User" class to export. 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instances of "User" class.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        ...
        public MixERP.Net.Entities.Office.User Get(int userId)
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Office.User>(this._Catalog, sql, userId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the first record of the table "office.users". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "User" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Office.User GetFirst()
        {
            ...
            const string sql = "SELECT * FROM office.users ORDER BY user_id LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Office.User>(this._Catalog, sql).FirstOrDefault();
        }

        /// <summary>
        /// Gets the previous record of the table "office.users" sorted by userId.
        /// </summary>
        ...
        public MixERP.Net.Entities.Office.User GetPrevious(int userId)
        {
            ...
            const string sql = "SELECT * FROM office.users WHERE user_id < @0 ORDER BY user_id DESC LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Office.User>(this._Catalog, sql, userId).FirstOrDefault();
        }

        /// <summary>
        /// Gets the next record of the table "office.users" sorted by userId.
        /// </summary>
        /// <param name="userId">The column "user_id" parameter used to find the next record.</param>
        /// <returns>Returns a non-live, non-mapped instance of "User" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Office.User GetNext(int userId)
        {
            ...
            const string sql = "SELECT * FROM office.users WHERE user_id > @0 ORDER BY user_id LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Office.User>(this._Catalog, sql, userId).FirstOrDefault();
        }


        /// <summary>
        /// Gets the last record of the table "office.users". 
        /// </summary>
        /// <returns>Returns a non-live, non-mapped instance of "User" class mapped to the database row.</returns>
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public MixERP.Net.Entities.Office.User GetLast()
        {
            ...
            const string sql = "SELECT * FROM office.users ORDER BY user_id DESC LIMIT 1;";
            return Factory.Get<MixERP.Net.Entities.Office.User>(this._Catalog, sql).FirstOrDefault();
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Office.User> Get(int[] userIds)
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Office.User>(this._Catalog, sql, userIds);
        }
        ...
        public object AddOrEdit(dynamic user, List<EntityParser.CustomField> customFields)
        {
            ...
            {
                primaryKeyValue = user.user_id;
                this.Update(user, int.Parse(user.user_id));
            }
            else
            {
        ...
        public object Add(dynamic user)
        {
            ...
            return Factory.Insert(this._Catalog, user, "office.users", "user_id");
        }
                    ...
                    using (Transaction transaction = db.GetTransaction())
                    {
                        foreach (dynamic user in users)
                        {
                            ...
                            if (Cast.To<int>(primaryKeyValue) > 0)
                            {
                                ...
                                db.Update("office.users", "user_id", user, user.user_id);
                            }
                            else
                            {
                                result.Add(db.Insert("office.users", "user_id", user));
                            }
                        }
        ...
        public void Update(dynamic user, int userId)
        {
            ...
            Factory.Update(this._Catalog, user, userId, "office.users", "user_id");
        }
        ...
        /// <summary>
        /// Performs a select statement on table "office.users" producing a paginated result of 10.
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.User> GetPaginatedResult()
        {
            ...
            const string sql = "SELECT * FROM office.users ORDER BY user_id LIMIT 10 OFFSET 0;";
            return Factory.Get<MixERP.Net.Entities.Office.User>(this._Catalog, sql);
        }
        ...
        public IEnumerable<MixERP.Net.Entities.Office.User> GetPaginatedResult(long pageNumber)
        {
            ...
            return Factory.Get<MixERP.Net.Entities.Office.User>(this._Catalog, sql, offset);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "office.users" producing a paginated result of 10.
        /// </summary>
