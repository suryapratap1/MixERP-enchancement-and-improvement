...
namespace MixERP.Net.Schemas.Office.Data
{
    ...
    /// </summary>
    public class GetOfficeNameByIdProcedure : DbAccess, IGetOfficeNameByIdRepository
    {
        /// <summary>
        ...
        /// </summary>
        public override string _ObjectName => "get_office_name_by_id";
        /// <summary>
        ...
        public string Execute()
        {
            ...
            string query = "SELECT * FROM office.get_office_name_by_id(@OfficeId);";
