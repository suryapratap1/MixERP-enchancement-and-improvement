...
namespace MixERP.Net.Schemas.Localization.Data
{
    ...
    /// </summary>
    public class AddLocalizedResourceProcedure : DbAccess, IAddLocalizedResourceRepository
    {
        /// <summary>
        ...
        public void Execute()
        {
            ...
            string query = "SELECT * FROM localization.add_localized_resource(@ResourceClass, @CultureCode, @Key, @Value);";

            query = query.ReplaceWholeWord("@ResourceClass", "@0::text");
            query = query.ReplaceWholeWord("@CultureCode", "@1::text");
            query = query.ReplaceWholeWord("@Key", "@2::text");
            query = query.ReplaceWholeWord("@Value", "@3::text");
