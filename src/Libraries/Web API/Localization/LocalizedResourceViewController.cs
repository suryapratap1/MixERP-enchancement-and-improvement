...
namespace MixERP.Net.Api.Localization
{
    ...
    /// </summary>
    [RoutePrefix("api/v1.5/localization/localized-resource-view")]
    public class LocalizedResourceViewController : ApiController
    {
        ...
        /// </summary>
        /// <returns>Returns the count of the localized resource views.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("count")]
        [Route("~/api/localization/localized-resource-view/count")]
        public long Count()
        {
            try
            {
        ...
        /// <summary>
        ///     Returns collection of localized resource view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/localization/localized-resource-view/export")]
        [Route("~/api/localization/localized-resource-view/all")]
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 localized resource views on each page, sorted by the property .
        /// </summary>
        /// <returns>Returns the first page from the collection.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("")]
        [Route("~/api/localization/localized-resource-view")]
        ...
        [Route("~/api/localization/localized-resource-view/page/{pageNumber}")]
        ...
        /// <returns>Returns the count of filtered localized resource views.</returns>
        [AcceptVerbs("POST")]
        [Route("count-where")]
        [Route("~/api/localization/localized-resource-view/count-where")]
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 localized resource views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        [Route("~/api/localization/localized-resource-view/get-where/{pageNumber}")]
        public IEnumerable<MixERP.Net.Entities.Localization.LocalizedResourceView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
        ...
        [Route("~/api/localization/localized-resource-view/count-filtered/{filterName}")]
        ...
        [Route("~/api/localization/localized-resource-view/get-filtered/{pageNumber}/{filterName}")]
