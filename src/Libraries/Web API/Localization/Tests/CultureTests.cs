...
namespace MixERP.Net.Api.Localization.Tests
{
    ...
    {
        public static CultureController Fixture()
        {
            CultureController controller = new CultureController(new CultureRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Localization.Culture culture = Fixture().Get(string.Empty);
