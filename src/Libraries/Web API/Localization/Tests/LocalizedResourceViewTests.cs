...
{
    public class LocalizedResourceViewTests
    {
        public static LocalizedResourceViewController Fixture()
        {
            LocalizedResourceViewController controller = new LocalizedResourceViewController(new LocalizedResourceViewRepository(), "", new LoginView());
            return controller;
        }
