...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function IsRestrictedMode.
    /// </summary>
    [RoutePrefix("api/v1.5/policy/procedures/is-restricted-mode")]
    public class IsRestrictedModeController : ApiController
    {
        /// <summary>
