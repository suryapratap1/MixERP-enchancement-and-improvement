...
namespace MixERP.Net.Api.Policy
{
    ...
    public class LockOutController : ApiController
    {
        ...
        /// <summary>
        ///     Returns all collection of lock out.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("all")]
        [Route("~/api/policy/lock-out/all")]
        ...
        {
            dynamic lockOut = form[0].ToObject<ExpandoObject>(JsonHelper.GetJsonSerializer());
        ...
        {
            List<ExpandoObject> lockOutCollection = this.ParseCollection(collection);
