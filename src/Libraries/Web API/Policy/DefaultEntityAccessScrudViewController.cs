...
namespace MixERP.Net.Api.Policy
{
    ...
    public class DefaultEntityAccessScrudViewController : ApiController
    {
        ...
        /// <summary>
        ///     Returns collection of default entity access scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/policy/default-entity-access-scrud-view/export")]
        [Route("~/api/policy/default-entity-access-scrud-view/all")]
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 default entity access scrud views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 default entity access scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Policy.DefaultEntityAccessScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
