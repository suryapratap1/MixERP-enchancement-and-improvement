...
{
    public class VoucherVerificationPolicyScrudViewRepository : IVoucherVerificationPolicyScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Policy.VoucherVerificationPolicyScrudView(), 1);
        }
