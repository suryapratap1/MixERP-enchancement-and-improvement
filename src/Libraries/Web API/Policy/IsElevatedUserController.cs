...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function IsElevatedUser.
    /// </summary>
    [RoutePrefix("api/v1.5/policy/procedures/is-elevated-user")]
    public class IsElevatedUserController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "is elevated user" annotation meta information to perform CRUD operation.</returns>
