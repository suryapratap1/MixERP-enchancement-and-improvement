...
{
    public class AutoVerificationPolicyTests
    {
        public static AutoVerificationPolicyController Fixture()
        {
            AutoVerificationPolicyController controller = new AutoVerificationPolicyController(new AutoVerificationPolicyRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Policy.AutoVerificationPolicy autoVerificationPolicy = Fixture().Get(0);
            Assert.NotNull(autoVerificationPolicy);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Policy.AutoVerificationPolicy autoVerificationPolicy = Fixture().GetFirst();
            Assert.NotNull(autoVerificationPolicy);
        }
        ...
        {
            MixERP.Net.Entities.Policy.AutoVerificationPolicy autoVerificationPolicy = Fixture().GetPrevious(0);
            Assert.NotNull(autoVerificationPolicy);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Policy.AutoVerificationPolicy autoVerificationPolicy = Fixture().GetNext(0);
            Assert.NotNull(autoVerificationPolicy);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Policy.AutoVerificationPolicy autoVerificationPolicy = Fixture().GetLast();
            Assert.NotNull(autoVerificationPolicy);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Policy.AutoVerificationPolicy> autoVerificationPolicies = Fixture().Get(new int[] { });
            Assert.NotNull(autoVerificationPolicies);
        }
