...
{
    public class VoucherVerificationPolicyScrudViewTests
    {
        public static VoucherVerificationPolicyScrudViewController Fixture()
        {
            VoucherVerificationPolicyScrudViewController controller = new VoucherVerificationPolicyScrudViewController(new VoucherVerificationPolicyScrudViewRepository(), "", new LoginView());
            return controller;
        }
