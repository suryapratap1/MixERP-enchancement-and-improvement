...
{
    public class MenuAccessTests
    {
        public static MenuAccessController Fixture()
        {
            MenuAccessController controller = new MenuAccessController(new MenuAccessRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Policy.MenuAccess menuAccess = Fixture().Get(0);
