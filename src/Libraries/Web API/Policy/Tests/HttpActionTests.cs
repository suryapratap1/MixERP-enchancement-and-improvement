...
namespace MixERP.Net.Api.Policy.Tests
{
    ...
    {
        public static HttpActionController Fixture()
        {
            HttpActionController controller = new HttpActionController(new HttpActionRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Policy.HttpAction httpAction = Fixture().Get(string.Empty);
        ...
        {
            MixERP.Net.Entities.Policy.HttpAction httpAction = Fixture().GetPrevious(string.Empty);
            Assert.NotNull(httpAction);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Policy.HttpAction httpAction = Fixture().GetLast();
            Assert.NotNull(httpAction);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Policy.HttpAction> httpActions = Fixture().Get(new string[] { });
