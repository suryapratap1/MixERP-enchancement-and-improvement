...
{
    public class AutoVerificationPolicyScrudViewTests
    {
        public static AutoVerificationPolicyScrudViewController Fixture()
        {
            AutoVerificationPolicyScrudViewController controller = new AutoVerificationPolicyScrudViewController(new AutoVerificationPolicyScrudViewRepository(), "", new LoginView());
            return controller;
        }
