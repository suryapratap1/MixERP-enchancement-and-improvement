...
{
    public class StorePolicyTests
    {
        public static StorePolicyController Fixture()
        {
            StorePolicyController controller = new StorePolicyController(new StorePolicyRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Policy.StorePolicy storePolicy = Fixture().Get(0);
