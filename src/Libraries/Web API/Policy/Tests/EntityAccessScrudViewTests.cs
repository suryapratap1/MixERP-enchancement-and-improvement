...
{
    public class EntityAccessScrudViewTests
    {
        public static EntityAccessScrudViewController Fixture()
        {
            EntityAccessScrudViewController controller = new EntityAccessScrudViewController(new EntityAccessScrudViewRepository(), "", new LoginView());
            return controller;
        }
