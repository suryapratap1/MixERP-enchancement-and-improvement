...
namespace MixERP.Net.Api.Policy.Tests
{
    ...
    {
        public static LockOutController Fixture()
        {
            LockOutController controller = new LockOutController(new LockOutRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Policy.LockOut lockOut = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Policy.LockOut lockOut = Fixture().GetFirst();
            Assert.NotNull(lockOut);
        }
        ...
        {
            MixERP.Net.Entities.Policy.LockOut lockOut = Fixture().GetPrevious(0);
            Assert.NotNull(lockOut);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Policy.LockOut lockOut = Fixture().GetNext(0);
            Assert.NotNull(lockOut);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Policy.LockOut lockOut = Fixture().GetLast();
            Assert.NotNull(lockOut);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Policy.LockOut> lockOuts = Fixture().Get(new long[] { });
