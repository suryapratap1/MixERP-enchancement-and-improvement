...
{
    public class DefaultEntityAccessScrudViewTests
    {
        public static DefaultEntityAccessScrudViewController Fixture()
        {
            DefaultEntityAccessScrudViewController controller = new DefaultEntityAccessScrudViewController(new DefaultEntityAccessScrudViewRepository(), "", new LoginView());
            return controller;
        }
