...
namespace MixERP.Net.Api.Policy
{
    ...
    /// </summary>
    [RoutePrefix("api/v1.5/policy/procedures/has-access")]
    public class HasAccessController : ApiController
    {
        /// <summary>
        ...
        [Route("annotation")]
        [Route("~/api/policy/procedures/has-access/annotation")]
        ...
        [AcceptVerbs("POST")]
        [Route("execute")]
        [Route("~/api/policy/procedures/has-access/execute")]
