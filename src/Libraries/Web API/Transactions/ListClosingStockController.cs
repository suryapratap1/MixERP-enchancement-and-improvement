...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function ListClosingStock.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/list-closing-stock")]
    public class ListClosingStockController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "list closing stock" annotation meta information to perform CRUD operation.</returns>
        ...
        /// </summary>
        /// <returns>Returns the "list closing stock" meta information to perform CRUD operation.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("meta")]
        ...
        public IEnumerable<DbListClosingStockResult> Execute([FromBody] Annotation annotation)
        {
            try
            {
