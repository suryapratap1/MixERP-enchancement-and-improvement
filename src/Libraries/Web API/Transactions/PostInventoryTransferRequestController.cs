...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function PostInventoryTransferRequest.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/post-inventory-transfer-request")]
    public class PostInventoryTransferRequestController : ApiController
    {
        /// <summary>
        ...
        /// <summary>
        ///     The PostInventoryTransferRequest repository.
        /// </summary>
        private readonly IPostInventoryTransferRequestRepository repository;
        ...
        public PostInventoryTransferRequestController()
        {
            ...
            this.repository = new PostInventoryTransferRequestProcedure
            {
        ...
        public PostInventoryTransferRequestController(IPostInventoryTransferRequestRepository repository, string catalog, LoginView view)
        {
        ...
        /// <summary>
        ///     Creates meta information of "post inventory transfer request" annotation.
        /// </summary>
        /// <returns>Returns the "post inventory transfer request" annotation meta information to perform CRUD operation.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("annotation")]
        [Route("~/api/transactions/procedures/post-inventory-transfer-request/annotation")]
        ...
        [AcceptVerbs("POST")]
        [Route("execute")]
        [Route("~/api/transactions/procedures/post-inventory-transfer-request/execute")]
