...
namespace MixERP.Net.Api.Transactions
{
    ...
    public class ReceiptViewController : ApiController
    {
        ...
        /// <summary>
        ///     Returns collection of receipt view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/transactions/receipt-view/export")]
        [Route("~/api/transactions/receipt-view/all")]
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 receipt views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 receipt views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.ReceiptView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
