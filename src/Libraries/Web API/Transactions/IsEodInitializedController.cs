...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function IsEodInitialized.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/is-eod-initialized")]
    public class IsEodInitializedController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "is eod initialized" annotation meta information to perform CRUD operation.</returns>
