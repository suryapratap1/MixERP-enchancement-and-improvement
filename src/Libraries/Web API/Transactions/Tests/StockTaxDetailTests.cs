...
{
    public class StockTaxDetailTests
    {
        public static StockTaxDetailController Fixture()
        {
            StockTaxDetailController controller = new StockTaxDetailController(new StockTaxDetailRepository(), "", new LoginView());
            return controller;
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.StockTaxDetail> stockTaxDetails = Fixture().Get(new long[] { });
            Assert.NotNull(stockTaxDetails);
        }
