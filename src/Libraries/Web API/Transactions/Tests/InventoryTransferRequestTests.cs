...
{
    public class InventoryTransferRequestTests
    {
        public static InventoryTransferRequestController Fixture()
        {
            InventoryTransferRequestController controller = new InventoryTransferRequestController(new InventoryTransferRequestRepository(), "", new LoginView());
            return controller;
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.InventoryTransferRequest> inventoryTransferRequests = Fixture().Get(new long[] { });
            Assert.NotNull(inventoryTransferRequests);
        }
