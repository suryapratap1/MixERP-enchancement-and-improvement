...
namespace MixERP.Net.Api.Transactions.Tests
{
    ...
    {
        public static StockMasterController Fixture()
        {
            StockMasterController controller = new StockMasterController(new StockMasterRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.StockMaster stockMaster = Fixture().Get(0);
            Assert.NotNull(stockMaster);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.StockMaster> stockMasters = Fixture().Get(new long[] { });
            Assert.NotNull(stockMasters);
        }
