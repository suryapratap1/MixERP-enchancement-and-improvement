...
{
    public class SalesByCountryViewTests
    {
        public static SalesByCountryViewController Fixture()
        {
            SalesByCountryViewController controller = new SalesByCountryViewController(new SalesByCountryViewRepository(), "", new LoginView());
            return controller;
        }
