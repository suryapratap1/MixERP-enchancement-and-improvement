...
{
    public class StockMasterNonGlRelationTests
    {
        public static StockMasterNonGlRelationController Fixture()
        {
            StockMasterNonGlRelationController controller = new StockMasterNonGlRelationController(new StockMasterNonGlRelationRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.StockMasterNonGlRelation stockMasterNonGlRelation = Fixture().Get(0);
            Assert.NotNull(stockMasterNonGlRelation);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.StockMasterNonGlRelation> stockMasterNonGlRelations = Fixture().Get(new long[] { });
            Assert.NotNull(stockMasterNonGlRelations);
        }
