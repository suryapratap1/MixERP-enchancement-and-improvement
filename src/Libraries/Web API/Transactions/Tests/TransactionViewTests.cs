...
namespace MixERP.Net.Api.Transactions.Tests
{
    ...
    {
        public static TransactionViewController Fixture()
        {
            TransactionViewController controller = new TransactionViewController(new TransactionViewRepository(), "", new LoginView());
            return controller;
        }
