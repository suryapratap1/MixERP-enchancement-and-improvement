...
{
    public class DayOperationTests
    {
        public static DayOperationController Fixture()
        {
            DayOperationController controller = new DayOperationController(new DayOperationRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.DayOperation dayOperation = Fixture().Get(0);
            Assert.NotNull(dayOperation);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.DayOperation> dayOperations = Fixture().Get(new long[] { });
            Assert.NotNull(dayOperations);
        }
