...
{
    public class SalesOrderViewTests
    {
        public static SalesOrderViewController Fixture()
        {
            SalesOrderViewController controller = new SalesOrderViewController(new SalesOrderViewRepository(), "", new LoginView());
            return controller;
        }
