...
{
    public class StockTransactionViewTests
    {
        public static StockTransactionViewController Fixture()
        {
            StockTransactionViewController controller = new StockTransactionViewController(new StockTransactionViewRepository(), "", new LoginView());
            return controller;
        }
