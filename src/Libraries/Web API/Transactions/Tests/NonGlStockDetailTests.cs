...
{
    public class NonGlStockDetailTests
    {
        public static NonGlStockDetailController Fixture()
        {
            NonGlStockDetailController controller = new NonGlStockDetailController(new NonGlStockDetailRepository(), "", new LoginView());
            return controller;
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.NonGlStockDetail> nonGlStockDetails = Fixture().Get(new long[] { });
            Assert.NotNull(nonGlStockDetails);
        }
