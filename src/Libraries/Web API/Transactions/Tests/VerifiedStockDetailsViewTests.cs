...
{
    public class VerifiedStockDetailsViewTests
    {
        public static VerifiedStockDetailsViewController Fixture()
        {
            VerifiedStockDetailsViewController controller = new VerifiedStockDetailsViewController(new VerifiedStockDetailsViewRepository(), "", new LoginView());
            return controller;
        }
