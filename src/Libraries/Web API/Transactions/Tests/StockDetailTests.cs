...
namespace MixERP.Net.Api.Transactions.Tests
{
    public class StockDetailTests
    {
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.StockDetail stockDetail = Fixture().Get(0);
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.StockDetail> stockDetails = Fixture().Get(new long[] { });
            Assert.NotNull(stockDetails);
        }
