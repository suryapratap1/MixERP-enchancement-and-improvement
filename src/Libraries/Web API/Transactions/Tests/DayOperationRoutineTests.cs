...
{
    public class DayOperationRoutineTests
    {
        public static DayOperationRoutineController Fixture()
        {
            DayOperationRoutineController controller = new DayOperationRoutineController(new DayOperationRoutineRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.DayOperationRoutine dayOperationRoutine = Fixture().Get(0);
            Assert.NotNull(dayOperationRoutine);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.DayOperationRoutine> dayOperationRoutines = Fixture().Get(new long[] { });
            Assert.NotNull(dayOperationRoutines);
        }
