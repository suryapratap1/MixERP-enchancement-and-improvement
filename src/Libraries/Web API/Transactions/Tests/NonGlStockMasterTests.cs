...
{
    public class NonGlStockMasterTests
    {
        public static NonGlStockMasterController Fixture()
        {
            NonGlStockMasterController controller = new NonGlStockMasterController(new NonGlStockMasterRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.NonGlStockMaster nonGlStockMaster = Fixture().Get(0);
            Assert.NotNull(nonGlStockMaster);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.NonGlStockMaster> nonGlStockMasters = Fixture().Get(new long[] { });
            Assert.NotNull(nonGlStockMasters);
        }
