...
{
    public class PartySalesChartViewTests
    {
        public static PartySalesChartViewController Fixture()
        {
            PartySalesChartViewController controller = new PartySalesChartViewController(new PartySalesChartViewRepository(), "", new LoginView());
            return controller;
        }
