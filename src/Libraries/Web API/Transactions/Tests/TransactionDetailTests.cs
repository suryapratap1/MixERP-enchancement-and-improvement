...
namespace MixERP.Net.Api.Transactions.Tests
{
    ...
    {
        public static TransactionDetailController Fixture()
        {
            TransactionDetailController controller = new TransactionDetailController(new TransactionDetailRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.TransactionDetail transactionDetail = Fixture().Get(0);
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.TransactionDetail> transactionDetails = Fixture().Get(new long[] { });
