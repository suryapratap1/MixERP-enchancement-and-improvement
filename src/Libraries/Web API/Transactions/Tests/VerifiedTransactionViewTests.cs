...
{
    public class VerifiedTransactionViewTests
    {
        public static VerifiedTransactionViewController Fixture()
        {
            VerifiedTransactionViewController controller = new VerifiedTransactionViewController(new VerifiedTransactionViewRepository(), "", new LoginView());
            return controller;
        }
