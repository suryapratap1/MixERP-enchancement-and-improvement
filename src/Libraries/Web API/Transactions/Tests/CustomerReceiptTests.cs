...
{
    public class CustomerReceiptTests
    {
        public static CustomerReceiptController Fixture()
        {
            CustomerReceiptController controller = new CustomerReceiptController(new CustomerReceiptRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.CustomerReceipt customerReceipt = Fixture().Get(0);
            Assert.NotNull(customerReceipt);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.CustomerReceipt> customerReceipts = Fixture().Get(new long[] { });
            Assert.NotNull(customerReceipts);
        }
