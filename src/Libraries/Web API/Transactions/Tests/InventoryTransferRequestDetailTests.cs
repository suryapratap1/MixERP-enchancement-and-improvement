...
{
    public class InventoryTransferRequestDetailTests
    {
        public static InventoryTransferRequestDetailController Fixture()
        {
            InventoryTransferRequestDetailController controller = new InventoryTransferRequestDetailController(new InventoryTransferRequestDetailRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.InventoryTransferRequestDetail inventoryTransferRequestDetail = Fixture().Get(0);
            Assert.NotNull(inventoryTransferRequestDetail);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.InventoryTransferRequestDetail> inventoryTransferRequestDetails = Fixture().Get(new long[] { });
            Assert.NotNull(inventoryTransferRequestDetails);
        }
