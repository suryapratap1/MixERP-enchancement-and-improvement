...
{
    public class SalesDeliveryViewTests
    {
        public static SalesDeliveryViewController Fixture()
        {
            SalesDeliveryViewController controller = new SalesDeliveryViewController(new SalesDeliveryViewRepository(), "", new LoginView());
            return controller;
        }
