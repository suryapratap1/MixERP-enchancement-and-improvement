...
{
    public class TransactionMasterTests
    {
        public static TransactionMasterController Fixture()
        {
            TransactionMasterController controller = new TransactionMasterController(new TransactionMasterRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.TransactionMaster transactionMaster = Fixture().Get(0);
            Assert.NotNull(transactionMaster);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.TransactionMaster> transactionMasters = Fixture().Get(new long[] { });
            Assert.NotNull(transactionMasters);
        }
