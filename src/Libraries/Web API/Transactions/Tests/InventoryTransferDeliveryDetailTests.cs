...
{
    public class InventoryTransferDeliveryDetailTests
    {
        public static InventoryTransferDeliveryDetailController Fixture()
        {
            InventoryTransferDeliveryDetailController controller = new InventoryTransferDeliveryDetailController(new InventoryTransferDeliveryDetailRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail inventoryTransferDeliveryDetail = Fixture().Get(0);
            Assert.NotNull(inventoryTransferDeliveryDetail);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.InventoryTransferDeliveryDetail> inventoryTransferDeliveryDetails = Fixture().Get(new long[] { });
            Assert.NotNull(inventoryTransferDeliveryDetails);
        }
