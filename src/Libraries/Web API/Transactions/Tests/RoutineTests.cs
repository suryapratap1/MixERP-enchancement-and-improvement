...
namespace MixERP.Net.Api.Transactions.Tests
{
    ...
    {
        public static TransactionsRoutineController Fixture()
        {
            TransactionsRoutineController controller = new TransactionsRoutineController(new RoutineRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.Routine routine = Fixture().Get(0);
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.Routine> routines = Fixture().Get(new int[] { });
