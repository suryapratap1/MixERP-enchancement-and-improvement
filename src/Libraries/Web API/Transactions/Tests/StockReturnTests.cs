...
{
    public class StockReturnTests
    {
        public static StockReturnController Fixture()
        {
            StockReturnController controller = new StockReturnController(new StockReturnRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.StockReturn stockReturn = Fixture().Get(0);
            Assert.NotNull(stockReturn);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.StockReturn> stockReturns = Fixture().Get(new long[] { });
            Assert.NotNull(stockReturns);
        }
