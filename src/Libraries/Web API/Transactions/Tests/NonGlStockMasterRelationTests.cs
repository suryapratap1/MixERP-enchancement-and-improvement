...
{
    public class NonGlStockMasterRelationTests
    {
        public static NonGlStockMasterRelationController Fixture()
        {
            NonGlStockMasterRelationController controller = new NonGlStockMasterRelationController(new NonGlStockMasterRelationRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.NonGlStockMasterRelation nonGlStockMasterRelation = Fixture().Get(0);
            Assert.NotNull(nonGlStockMasterRelation);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.NonGlStockMasterRelation> nonGlStockMasterRelations = Fixture().Get(new long[] { });
            Assert.NotNull(nonGlStockMasterRelations);
        }
