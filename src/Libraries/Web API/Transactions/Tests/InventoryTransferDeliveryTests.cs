...
{
    public class InventoryTransferDeliveryTests
    {
        public static InventoryTransferDeliveryController Fixture()
        {
            InventoryTransferDeliveryController controller = new InventoryTransferDeliveryController(new InventoryTransferDeliveryRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Transactions.InventoryTransferDelivery inventoryTransferDelivery = Fixture().Get(0);
            Assert.NotNull(inventoryTransferDelivery);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Transactions.InventoryTransferDelivery> inventoryTransferDeliveries = Fixture().Get(new long[] { });
            Assert.NotNull(inventoryTransferDeliveries);
        }
