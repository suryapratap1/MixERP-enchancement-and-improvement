...
namespace MixERP.Net.Api.Transactions
{
    ...
    public class GetTotalDueController : ApiController
    {
        ...
        /// <summary>
        ///     The GetTotalDue repository.
        /// </summary>
        private readonly IGetTotalDueRepository repository;
        ...
        public GetTotalDueController()
        {
            ...
            this.repository = new GetTotalDueProcedure
            {
        ...
        public GetTotalDueController(IGetTotalDueRepository repository, string catalog, LoginView view)
        {
