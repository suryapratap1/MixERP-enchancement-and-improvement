...
namespace MixERP.Net.Api.Transactions
{
    ...
    {
        /// <summary>
        ///     The TransactionView repository.
        /// </summary>
        private readonly ITransactionViewRepository TransactionViewRepository;
        ...
        public TransactionViewController()
        {
            ...
            this.TransactionViewRepository = new MixERP.Net.Schemas.Transactions.Data.TransactionView
            {
        ...
        public TransactionViewController(ITransactionViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.TransactionViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.TransactionViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of transaction view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/transactions/transaction-view/export")]
        [Route("~/api/transactions/transaction-view/all")]
        public IEnumerable<MixERP.Net.Entities.Transactions.TransactionView> Get()
        {
            try
            {
                return this.TransactionViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 transaction views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.TransactionView> GetPaginatedResult()
        {
            try
            {
                return this.TransactionViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.TransactionView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.TransactionViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.TransactionViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.TransactionViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 transaction views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.TransactionView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.TransactionViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.TransactionViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.TransactionView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.TransactionViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
