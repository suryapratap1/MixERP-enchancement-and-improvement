...
namespace MixERP.Net.Api.Transactions
{
    ...
    public class VerifiedTransactionViewController : ApiController
    {
        ...
        /// <summary>
        ///     Returns collection of verified transaction view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/transactions/verified-transaction-view/export")]
        [Route("~/api/transactions/verified-transaction-view/all")]
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 verified transaction views on each page, sorted by the property .
        /// </summary>
        ...
        /// <returns>Returns the count of filtered verified transaction views.</returns>
        [AcceptVerbs("POST")]
        [Route("count-where")]
        [Route("~/api/transactions/verified-transaction-view/count-where")]
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 verified transaction views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.VerifiedTransactionView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
        ...
        [Route("~/api/transactions/verified-transaction-view/count-filtered/{filterName}")]
        ...
        [Route("~/api/transactions/verified-transaction-view/get-filtered/{pageNumber}/{filterName}")]
