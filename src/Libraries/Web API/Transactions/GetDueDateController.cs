...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetDueDate.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/get-due-date")]
    public class GetDueDateController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "get due date" annotation meta information to perform CRUD operation.</returns>
