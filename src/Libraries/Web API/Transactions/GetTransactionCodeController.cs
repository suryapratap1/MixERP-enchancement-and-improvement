...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetTransactionCode.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/get-transaction-code")]
    public class GetTransactionCodeController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "get transaction code" annotation meta information to perform CRUD operation.</returns>
