...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetStockAccountStatement.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/get-stock-account-statement")]
    public class GetStockAccountStatementController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "get stock account statement" annotation meta information to perform CRUD operation.</returns>
        ...
        /// </summary>
        /// <returns>Returns the "get stock account statement" meta information to perform CRUD operation.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("meta")]
        ...
        public IEnumerable<DbGetStockAccountStatementResult> Execute([FromBody] Annotation annotation)
        {
            try
            {
