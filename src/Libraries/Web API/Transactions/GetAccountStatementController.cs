...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetAccountStatement.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/get-account-statement")]
    public class GetAccountStatementController : ApiController
    {
        /// <summary>
        ...
        /// <summary>
        ///     The GetAccountStatement repository.
        /// </summary>
        private readonly IGetAccountStatementRepository repository;
        ...
        public GetAccountStatementController()
        {
            ...
            this.repository = new GetAccountStatementProcedure
            {
        ...
        public GetAccountStatementController(IGetAccountStatementRepository repository, string catalog, LoginView view)
        {
        ...
        /// <summary>
        ///     Creates meta information of "get account statement" annotation.
        /// </summary>
        /// <returns>Returns the "get account statement" annotation meta information to perform CRUD operation.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("annotation")]
        [Route("~/api/transactions/procedures/get-account-statement/annotation")]
        public EntityView GetAnnotation()
        {
            ...
            return new EntityView
            {
                Columns = new List<EntityColumn>()
                                {
                                        new EntityColumn { ColumnName = "_value_date_from",  PropertyName = "ValueDateFrom",  DataType = "DateTime",  DbDataType = "date",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
                                        new EntityColumn { ColumnName = "_value_date_to",  PropertyName = "ValueDateTo",  DataType = "DateTime",  DbDataType = "date",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
        ...
        /// <summary>
        ///     Creates meta information of "get account statement" entity.
        /// </summary>
        /// <returns>Returns the "get account statement" meta information to perform CRUD operation.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("meta")]
        [Route("~/api/transactions/procedures/get-account-statement/meta")]
                ...
                Columns = new List<EntityColumn>()
                                {
                                        ...
                                        new EntityColumn { ColumnName = "flag_bg",  PropertyName = "FlagBg",  DataType = "string",  DbDataType = "text",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
                                        new EntityColumn { ColumnName = "flag_fg",  PropertyName = "FlagFg",  DataType = "string",  DbDataType = "text",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 }
                                }
            };
        }
        ...
        [AcceptVerbs("POST")]
        [Route("execute")]
        [Route("~/api/transactions/procedures/get-account-statement/execute")]
        public IEnumerable<DbGetAccountStatementResult> Execute([FromBody] Annotation annotation)
        {
            try
            {
