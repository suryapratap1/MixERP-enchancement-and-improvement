...
namespace MixERP.Net.Api.Transactions
{
    ...
    {
        /// <summary>
        ///     The SalesByCountryView repository.
        /// </summary>
        private readonly ISalesByCountryViewRepository SalesByCountryViewRepository;
        ...
        public SalesByCountryViewController()
        {
            ...
            this.SalesByCountryViewRepository = new MixERP.Net.Schemas.Transactions.Data.SalesByCountryView
            {
        ...
        public SalesByCountryViewController(ISalesByCountryViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.SalesByCountryViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.SalesByCountryViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of sales by country view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/transactions/sales-by-country-view/export")]
        [Route("~/api/transactions/sales-by-country-view/all")]
        public IEnumerable<MixERP.Net.Entities.Transactions.SalesByCountryView> Get()
        {
            try
            {
                return this.SalesByCountryViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 sales by country views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.SalesByCountryView> GetPaginatedResult()
        {
            try
            {
                return this.SalesByCountryViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.SalesByCountryView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.SalesByCountryViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.SalesByCountryViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.SalesByCountryViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 sales by country views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.SalesByCountryView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.SalesByCountryViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.SalesByCountryViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.SalesByCountryView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.SalesByCountryViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
