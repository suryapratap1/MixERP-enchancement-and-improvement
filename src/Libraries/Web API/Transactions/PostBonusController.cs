...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function PostBonus.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/post-bonus")]
    public class PostBonusController : ApiController
    {
        /// <summary>
        ...
        /// <summary>
        ///     The PostBonus repository.
        /// </summary>
        private readonly IPostBonusRepository repository;
        ...
        public PostBonusController()
        {
            ...
            this.repository = new PostBonusProcedure
            {
        ...
        public PostBonusController(IPostBonusRepository repository, string catalog, LoginView view)
        {
        ...
        /// <summary>
        ///     Creates meta information of "post bonus" annotation.
        /// </summary>
        /// <returns>Returns the "post bonus" annotation meta information to perform CRUD operation.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("annotation")]
        [Route("~/api/transactions/procedures/post-bonus/annotation")]
        ...
        /// <summary>
        ///     Creates meta information of "post bonus" entity.
        /// </summary>
        /// <returns>Returns the "post bonus" meta information to perform CRUD operation.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("meta")]
        [Route("~/api/transactions/procedures/post-bonus/meta")]
        ...
        [AcceptVerbs("POST")]
        [Route("execute")]
        [Route("~/api/transactions/procedures/post-bonus/execute")]
