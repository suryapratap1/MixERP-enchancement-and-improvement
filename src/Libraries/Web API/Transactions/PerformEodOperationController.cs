...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function PerformEodOperation.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/perform-eod-operation")]
    public class PerformEodOperationController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "perform eod operation" annotation meta information to perform CRUD operation.</returns>
