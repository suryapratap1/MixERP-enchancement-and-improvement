...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetPurchase.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/get-purchase")]
    public class GetPurchaseController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "get purchase" annotation meta information to perform CRUD operation.</returns>
