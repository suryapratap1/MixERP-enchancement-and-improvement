...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetMavcogs.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/get-mavcogs")]
    public class GetMavcogsController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "get mavcogs" annotation meta information to perform CRUD operation.</returns>
                ...
                Columns = new List<EntityColumn>()
                                {
                                        ...
                                        new EntityColumn { ColumnName = "_base_quantity",  PropertyName = "BaseQuantity",  DataType = "decimal",  DbDataType = "numeric",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
