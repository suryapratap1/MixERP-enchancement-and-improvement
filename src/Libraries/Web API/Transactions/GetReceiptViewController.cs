...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetReceiptView.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/get-receipt-view")]
    public class GetReceiptViewController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "get receipt view" annotation meta information to perform CRUD operation.</returns>
                ...
                Columns = new List<EntityColumn>()
                                {
                                        ...
                                        new EntityColumn { ColumnName = "_party",  PropertyName = "Party",  DataType = "string",  DbDataType = "text",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
                                        new EntityColumn { ColumnName = "_user",  PropertyName = "User",  DataType = "string",  DbDataType = "character varying",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
        ...
        /// </summary>
        /// <returns>Returns the "get receipt view" meta information to perform CRUD operation.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("meta")]
                ...
                Columns = new List<EntityColumn>()
                                {
                                        ...
                                        new EntityColumn { ColumnName = "user",  PropertyName = "User",  DataType = "string",  DbDataType = "text",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 },
        ...
        public IEnumerable<DbGetReceiptViewResult> Execute([FromBody] Annotation annotation)
        {
            try
            {
