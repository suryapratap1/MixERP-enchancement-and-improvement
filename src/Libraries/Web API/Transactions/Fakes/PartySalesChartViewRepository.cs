...
{
    public class PartySalesChartViewRepository : IPartySalesChartViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Transactions.PartySalesChartView(), 1);
        }
