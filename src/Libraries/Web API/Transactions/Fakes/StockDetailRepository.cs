...
namespace MixERP.Net.Api.Transactions.Fakes
{
    public class StockDetailRepository : IStockDetailRepository
    {
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Transactions.StockDetail(), 1);
        }
        ...
        {
            return new MixERP.Net.Entities.Transactions.StockDetail();
        }
        ...
        public void Update(dynamic stockDetail, long stockDetailId)
        {
            ...
            throw new ArgumentException("stockDetailId is null.");
        }
