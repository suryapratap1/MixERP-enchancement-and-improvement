...
{
    public class VerifiedStockDetailsViewRepository : IVerifiedStockDetailsViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Transactions.VerifiedStockDetailsView(), 1);
        }
