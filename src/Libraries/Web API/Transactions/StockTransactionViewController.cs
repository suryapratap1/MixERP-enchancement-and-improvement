...
namespace MixERP.Net.Api.Transactions
{
    ...
    public class StockTransactionViewController : ApiController
    {
        ...
        /// <summary>
        ///     Returns collection of stock transaction view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/transactions/stock-transaction-view/export")]
        [Route("~/api/transactions/stock-transaction-view/all")]
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 stock transaction views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Counts the number of stock transaction views using the supplied filter(s).
        /// </summary>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns the count of filtered stock transaction views.</returns>
        [AcceptVerbs("POST")]
        [Route("count-where")]
        [Route("~/api/transactions/stock-transaction-view/count-where")]
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 stock transaction views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.StockTransactionView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
        ...
        /// <summary>
        ///     Counts the number of stock transaction views using the supplied filter name.
        /// </summary>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns the count of filtered stock transaction views.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("count-filtered/{filterName}")]
        [Route("~/api/transactions/stock-transaction-view/count-filtered/{filterName}")]
        ...
        [Route("~/api/transactions/stock-transaction-view/get-filtered/{pageNumber}/{filterName}")]
