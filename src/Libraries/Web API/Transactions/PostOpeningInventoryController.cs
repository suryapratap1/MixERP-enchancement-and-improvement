...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function PostOpeningInventory.
    /// </summary>
    [RoutePrefix("api/v1.5/transactions/procedures/post-opening-inventory")]
    public class PostOpeningInventoryController : ApiController
    {
        /// <summary>
        ...
        /// <summary>
        ///     The PostOpeningInventory repository.
        /// </summary>
        private readonly IPostOpeningInventoryRepository repository;
        ...
        public PostOpeningInventoryController()
        {
            ...
            this.repository = new PostOpeningInventoryProcedure
            {
        ...
        public PostOpeningInventoryController(IPostOpeningInventoryRepository repository, string catalog, LoginView view)
        {
        ...
        /// <summary>
        ///     Creates meta information of "post opening inventory" annotation.
        /// </summary>
        /// <returns>Returns the "post opening inventory" annotation meta information to perform CRUD operation.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("annotation")]
        [Route("~/api/transactions/procedures/post-opening-inventory/annotation")]
                ...
                Columns = new List<EntityColumn>()
                                {
                                        ...
                                        new EntityColumn { ColumnName = "_details",  PropertyName = "Details",  DataType = "MixERP.Net.Entities.Transactions.OpeningStockType",  DbDataType = "transactions.opening_stock_type[]",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 }
                                }
            };
        }
        ...
        [AcceptVerbs("POST")]
        [Route("execute")]
        [Route("~/api/transactions/procedures/post-opening-inventory/execute")]
