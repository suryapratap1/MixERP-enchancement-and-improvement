...
namespace MixERP.Net.Api.Config
{
    ...
    public class OpenExchangeRateScrudViewController : ApiController
    {
        ...
        /// <summary>
        ///     Returns collection of open exchange rate scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/config/open-exchange-rate-scrud-view/export")]
        [Route("~/api/config/open-exchange-rate-scrud-view/all")]
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 open exchange rate scrud views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Counts the number of open exchange rate scrud views using the supplied filter(s).
        /// </summary>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns the count of filtered open exchange rate scrud views.</returns>
        [AcceptVerbs("POST")]
        [Route("count-where")]
        [Route("~/api/config/open-exchange-rate-scrud-view/count-where")]
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 open exchange rate scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Config.OpenExchangeRateScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
        ...
        /// <summary>
        ///     Counts the number of open exchange rate scrud views using the supplied filter name.
        /// </summary>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns the count of filtered open exchange rate scrud views.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("count-filtered/{filterName}")]
        [Route("~/api/config/open-exchange-rate-scrud-view/count-filtered/{filterName}")]
        ...
        [Route("~/api/config/open-exchange-rate-scrud-view/get-filtered/{pageNumber}/{filterName}")]
