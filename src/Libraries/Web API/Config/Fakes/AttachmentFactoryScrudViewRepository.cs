...
{
    public class AttachmentFactoryScrudViewRepository : IAttachmentFactoryScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Config.AttachmentFactoryScrudView(), 1);
        }
