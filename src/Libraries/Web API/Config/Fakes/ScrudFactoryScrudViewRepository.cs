...
{
    public class ScrudFactoryScrudViewRepository : IScrudFactoryScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Config.ScrudFactoryScrudView(), 1);
        }
