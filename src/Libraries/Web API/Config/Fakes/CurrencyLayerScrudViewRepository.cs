...
{
    public class CurrencyLayerScrudViewRepository : ICurrencyLayerScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Config.CurrencyLayerScrudView(), 1);
        }
