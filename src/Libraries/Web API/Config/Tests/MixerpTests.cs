...
{
    public class MixerpTests
    {
        public static MixerpController Fixture()
        {
            MixerpController controller = new MixerpController(new MixerpRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Config.Mixerp mixerp = Fixture().Get(string.Empty);
