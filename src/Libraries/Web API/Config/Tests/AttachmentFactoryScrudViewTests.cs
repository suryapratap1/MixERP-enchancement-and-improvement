...
{
    public class AttachmentFactoryScrudViewTests
    {
        public static AttachmentFactoryScrudViewController Fixture()
        {
            AttachmentFactoryScrudViewController controller = new AttachmentFactoryScrudViewController(new AttachmentFactoryScrudViewRepository(), "", new LoginView());
            return controller;
        }
