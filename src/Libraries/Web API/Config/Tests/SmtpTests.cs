...
namespace MixERP.Net.Api.Config.Tests
{
    ...
    {
        public static SmtpController Fixture()
        {
            SmtpController controller = new SmtpController(new SmtpRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Config.Smtp smtp = Fixture().Get(0);
            Assert.NotNull(smtp);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Config.Smtp smtp = Fixture().GetFirst();
            Assert.NotNull(smtp);
        }
        ...
        {
            MixERP.Net.Entities.Config.Smtp smtp = Fixture().GetPrevious(0);
            Assert.NotNull(smtp);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Config.Smtp smtp = Fixture().GetNext(0);
            Assert.NotNull(smtp);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Config.Smtp smtp = Fixture().GetLast();
            Assert.NotNull(smtp);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Config.Smtp> smtps = Fixture().Get(new int[] { });
            Assert.NotNull(smtps);
        }
