...
{
    public class CurrencyLayerTests
    {
        public static CurrencyLayerController Fixture()
        {
            CurrencyLayerController controller = new CurrencyLayerController(new CurrencyLayerRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Config.CurrencyLayer currencyLayer = Fixture().Get(string.Empty);
