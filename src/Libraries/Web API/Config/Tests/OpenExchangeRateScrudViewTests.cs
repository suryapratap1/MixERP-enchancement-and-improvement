...
{
    public class OpenExchangeRateScrudViewTests
    {
        public static OpenExchangeRateScrudViewController Fixture()
        {
            OpenExchangeRateScrudViewController controller = new OpenExchangeRateScrudViewController(new OpenExchangeRateScrudViewRepository(), "", new LoginView());
            return controller;
        }
