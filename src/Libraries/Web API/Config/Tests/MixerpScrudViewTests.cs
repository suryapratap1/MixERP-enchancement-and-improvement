...
{
    public class MixerpScrudViewTests
    {
        public static MixerpScrudViewController Fixture()
        {
            MixerpScrudViewController controller = new MixerpScrudViewController(new MixerpScrudViewRepository(), "", new LoginView());
            return controller;
        }
