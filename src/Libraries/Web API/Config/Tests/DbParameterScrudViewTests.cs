...
{
    public class DbParameterScrudViewTests
    {
        public static DbParameterScrudViewController Fixture()
        {
            DbParameterScrudViewController controller = new DbParameterScrudViewController(new DbParameterScrudViewRepository(), "", new LoginView());
            return controller;
        }
