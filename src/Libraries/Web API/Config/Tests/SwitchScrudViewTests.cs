...
{
    public class SwitchScrudViewTests
    {
        public static SwitchScrudViewController Fixture()
        {
            SwitchScrudViewController controller = new SwitchScrudViewController(new SwitchScrudViewRepository(), "", new LoginView());
            return controller;
        }
