...
{
    public class ScrudFactoryScrudViewTests
    {
        public static ScrudFactoryScrudViewController Fixture()
        {
            ScrudFactoryScrudViewController controller = new ScrudFactoryScrudViewController(new ScrudFactoryScrudViewRepository(), "", new LoginView());
            return controller;
        }
