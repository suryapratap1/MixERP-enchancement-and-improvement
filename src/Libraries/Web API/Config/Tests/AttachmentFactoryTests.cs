...
namespace MixERP.Net.Api.Config.Tests
{
    ...
    {
        public static AttachmentFactoryController Fixture()
        {
            AttachmentFactoryController controller = new AttachmentFactoryController(new AttachmentFactoryRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Config.AttachmentFactory attachmentFactory = Fixture().Get(string.Empty);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(attachmentFactories);
        }
