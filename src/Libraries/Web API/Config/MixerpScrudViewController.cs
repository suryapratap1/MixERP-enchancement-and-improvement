...
namespace MixERP.Net.Api.Config
{
    ...
    {
        /// <summary>
        ///     The MixerpScrudView repository.
        /// </summary>
        private readonly IMixerpScrudViewRepository MixerpScrudViewRepository;
        ...
        public MixerpScrudViewController()
        {
            ...
            this.MixerpScrudViewRepository = new MixERP.Net.Schemas.Config.Data.MixerpScrudView
            {
        ...
        public MixerpScrudViewController(IMixerpScrudViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.MixerpScrudViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.MixerpScrudViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of mixerp scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/config/mixerp-scrud-view/export")]
        [Route("~/api/config/mixerp-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.Config.MixerpScrudView> Get()
        {
            try
            {
                return this.MixerpScrudViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 mixerp scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Config.MixerpScrudView> GetPaginatedResult()
        {
            try
            {
                return this.MixerpScrudViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Config.MixerpScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.MixerpScrudViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.MixerpScrudViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 mixerp scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Config.MixerpScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.MixerpScrudViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.MixerpScrudViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Config.MixerpScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.MixerpScrudViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
