...
namespace MixERP.Net.Api.Config
{
    ...
    public class AttachmentFactoryController : ApiController
    {
        ...
        /// <summary>
        ///     Returns all collection of attachment factory.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("all")]
        [Route("~/api/config/attachment-factory/all")]
        ...
        {
            dynamic attachmentFactory = form[0].ToObject<ExpandoObject>(JsonHelper.GetJsonSerializer());
        ...
        {
            List<ExpandoObject> attachmentFactoryCollection = this.ParseCollection(collection);
