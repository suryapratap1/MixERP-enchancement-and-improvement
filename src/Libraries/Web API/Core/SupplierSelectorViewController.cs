...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The SupplierSelectorView repository.
        /// </summary>
        private readonly ISupplierSelectorViewRepository SupplierSelectorViewRepository;
        ...
        public SupplierSelectorViewController()
        {
            ...
            this.SupplierSelectorViewRepository = new MixERP.Net.Schemas.Core.Data.SupplierSelectorView
            {
        ...
        public SupplierSelectorViewController(ISupplierSelectorViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.SupplierSelectorViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.SupplierSelectorViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of supplier selector view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/supplier-selector-view/export")]
        [Route("~/api/core/supplier-selector-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.SupplierSelectorView> Get()
        {
            try
            {
                return this.SupplierSelectorViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 supplier selector views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SupplierSelectorView> GetPaginatedResult()
        {
            try
            {
                return this.SupplierSelectorViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SupplierSelectorView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.SupplierSelectorViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.SupplierSelectorViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.SupplierSelectorViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 supplier selector views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SupplierSelectorView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.SupplierSelectorViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.SupplierSelectorViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SupplierSelectorView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.SupplierSelectorViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
