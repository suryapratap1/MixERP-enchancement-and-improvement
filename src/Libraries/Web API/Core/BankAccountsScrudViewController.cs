...
namespace MixERP.Net.Api.Core
{
    ...
    public class BankAccountsScrudViewController : ApiController
    {
        ...
        /// <summary>
        ///     Returns collection of bank accounts scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/bank-accounts-scrud-view/export")]
        [Route("~/api/core/bank-accounts-scrud-view/all")]
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 bank accounts scrud views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 bank accounts scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.BankAccountsScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
