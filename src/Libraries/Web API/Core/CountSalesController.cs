...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function CountSales.
    /// </summary>
    [RoutePrefix("api/v1.5/core/procedures/count-sales")]
    public class CountSalesController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "count sales" annotation meta information to perform CRUD operation.</returns>
