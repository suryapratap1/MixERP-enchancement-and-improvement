...
namespace MixERP.Net.Api.Core
{
    ...
    public class GetStateIdByStateNameController : ApiController
    {
        ...
        /// <summary>
        ///     The GetStateIdByStateName repository.
        /// </summary>
        private readonly IGetStateIdByStateNameRepository repository;
        ...
        public GetStateIdByStateNameController()
        {
            ...
            this.repository = new GetStateIdByStateNameProcedure
            {
        ...
        public GetStateIdByStateNameController(IGetStateIdByStateNameRepository repository, string catalog, LoginView view)
        {
