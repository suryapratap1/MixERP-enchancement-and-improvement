...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetShippingAddressIdByShippingAddressCode.
    /// </summary>
    [RoutePrefix("api/v1.5/core/procedures/get-shipping-address-id-by-shipping-address-code")]
    public class GetShippingAddressIdByShippingAddressCodeController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "get shipping address id by shipping address code" annotation meta information to perform CRUD operation.</returns>
