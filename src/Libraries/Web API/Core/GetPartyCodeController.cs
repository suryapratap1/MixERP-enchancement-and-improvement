...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetPartyCode.
    /// </summary>
    [RoutePrefix("api/v1.5/core/procedures/get-party-code")]
    public class GetPartyCodeController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "get party code" annotation meta information to perform CRUD operation.</returns>
        ...
        [AcceptVerbs("POST")]
        [Route("execute")]
        [Route("~/api/core/procedures/get-party-code/execute")]
