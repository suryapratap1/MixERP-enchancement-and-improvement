...
{
    /// <summary>
    ///     Provides a direct HTTP access to perform various tasks such as adding, editing, and removing Custom Field Views.
    /// </summary>
    [RoutePrefix("api/v1.5/core/custom-field-view")]
    public class CustomFieldViewController : ApiController
    {
        ...
        /// <summary>
        ///     Counts the number of custom field views.
        /// </summary>
        /// <returns>Returns the count of the custom field views.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("count")]
        [Route("~/api/core/custom-field-view/count")]
        public long Count()
        {
            try
            {
        ...
        /// <summary>
        ///     Returns collection of custom field view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/custom-field-view/export")]
        [Route("~/api/core/custom-field-view/all")]
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 custom field views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Counts the number of custom field views using the supplied filter(s).
        /// </summary>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns the count of filtered custom field views.</returns>
        [AcceptVerbs("POST")]
        [Route("count-where")]
        [Route("~/api/core/custom-field-view/count-where")]
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 custom field views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        [Route("~/api/core/custom-field-view/get-where/{pageNumber}")]
        public IEnumerable<MixERP.Net.Entities.Core.CustomFieldView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
        ...
        /// <summary>
        ///     Counts the number of custom field views using the supplied filter name.
        /// </summary>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns the count of filtered custom field views.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("count-filtered/{filterName}")]
        [Route("~/api/core/custom-field-view/count-filtered/{filterName}")]
        ...
        [Route("~/api/core/custom-field-view/get-filtered/{pageNumber}/{filterName}")]
