...
namespace MixERP.Net.Api.Core
{
    ...
    public class TaxBaseAmountTypeSelectorViewController : ApiController
    {
        ...
        /// <summary>
        ///     Returns collection of tax base amount type selector view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/tax-base-amount-type-selector-view/export")]
        [Route("~/api/core/tax-base-amount-type-selector-view/all")]
