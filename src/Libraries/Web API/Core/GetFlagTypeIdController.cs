...
namespace MixERP.Net.Api.Core
{
    ...
    /// </summary>
    [RoutePrefix("api/v1.5/core/procedures/get-flag-type-id")]
    public class GetFlagTypeIdController : ApiController
    {
        /// <summary>
        ...
        [Route("annotation")]
        [Route("~/api/core/procedures/get-flag-type-id/annotation")]
        ...
        [AcceptVerbs("POST")]
        [Route("execute")]
        [Route("~/api/core/procedures/get-flag-type-id/execute")]
