...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The CountryScrudView repository.
        /// </summary>
        private readonly ICountryScrudViewRepository CountryScrudViewRepository;
        ...
        public CountryScrudViewController()
        {
            ...
            this.CountryScrudViewRepository = new MixERP.Net.Schemas.Core.Data.CountryScrudView
            {
        ...
        public CountryScrudViewController(ICountryScrudViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.CountryScrudViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.CountryScrudViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of country scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/country-scrud-view/export")]
        [Route("~/api/core/country-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.CountryScrudView> Get()
        {
            try
            {
                return this.CountryScrudViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 country scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CountryScrudView> GetPaginatedResult()
        {
            try
            {
                return this.CountryScrudViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CountryScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.CountryScrudViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.CountryScrudViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.CountryScrudViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 country scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CountryScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.CountryScrudViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.CountryScrudViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CountryScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.CountryScrudViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
