...
namespace MixERP.Net.Api.Core
{
    ...
    public class SalesTeamSelectorViewController : ApiController
    {
        ...
        /// <summary>
        ///     Returns collection of sales team selector view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/sales-team-selector-view/export")]
        [Route("~/api/core/sales-team-selector-view/all")]
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 sales team selector views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 sales team selector views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTeamSelectorView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
