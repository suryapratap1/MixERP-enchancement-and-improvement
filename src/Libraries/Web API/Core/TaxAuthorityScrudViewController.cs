...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The TaxAuthorityScrudView repository.
        /// </summary>
        private readonly ITaxAuthorityScrudViewRepository TaxAuthorityScrudViewRepository;
        ...
        public TaxAuthorityScrudViewController()
        {
            ...
            this.TaxAuthorityScrudViewRepository = new MixERP.Net.Schemas.Core.Data.TaxAuthorityScrudView
            {
        ...
        public TaxAuthorityScrudViewController(ITaxAuthorityScrudViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.TaxAuthorityScrudViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.TaxAuthorityScrudViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of tax authority scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/tax-authority-scrud-view/export")]
        [Route("~/api/core/tax-authority-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.TaxAuthorityScrudView> Get()
        {
            try
            {
                return this.TaxAuthorityScrudViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 tax authority scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.TaxAuthorityScrudView> GetPaginatedResult()
        {
            try
            {
                return this.TaxAuthorityScrudViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.TaxAuthorityScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.TaxAuthorityScrudViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.TaxAuthorityScrudViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.TaxAuthorityScrudViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 tax authority scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.TaxAuthorityScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.TaxAuthorityScrudViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.TaxAuthorityScrudViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.TaxAuthorityScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.TaxAuthorityScrudViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
