...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The CurrencyScrudView repository.
        /// </summary>
        private readonly ICurrencyScrudViewRepository CurrencyScrudViewRepository;
        ...
        public CurrencyScrudViewController()
        {
            ...
            this.CurrencyScrudViewRepository = new MixERP.Net.Schemas.Core.Data.CurrencyScrudView
            {
        ...
        public CurrencyScrudViewController(ICurrencyScrudViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.CurrencyScrudViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.CurrencyScrudViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of currency scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/currency-scrud-view/export")]
        [Route("~/api/core/currency-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.CurrencyScrudView> Get()
        {
            try
            {
                return this.CurrencyScrudViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 currency scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CurrencyScrudView> GetPaginatedResult()
        {
            try
            {
                return this.CurrencyScrudViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CurrencyScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.CurrencyScrudViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.CurrencyScrudViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.CurrencyScrudViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 currency scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CurrencyScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.CurrencyScrudViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.CurrencyScrudViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CurrencyScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.CurrencyScrudViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
