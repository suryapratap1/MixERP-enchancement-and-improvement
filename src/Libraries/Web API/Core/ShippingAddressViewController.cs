...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The ShippingAddressView repository.
        /// </summary>
        private readonly IShippingAddressViewRepository ShippingAddressViewRepository;
        ...
        public ShippingAddressViewController()
        {
            ...
            this.ShippingAddressViewRepository = new MixERP.Net.Schemas.Core.Data.ShippingAddressView
            {
        ...
        public ShippingAddressViewController(IShippingAddressViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.ShippingAddressViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.ShippingAddressViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of shipping address view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/shipping-address-view/export")]
        [Route("~/api/core/shipping-address-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.ShippingAddressView> Get()
        {
            try
            {
                return this.ShippingAddressViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 shipping address views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ShippingAddressView> GetPaginatedResult()
        {
            try
            {
                return this.ShippingAddressViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ShippingAddressView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.ShippingAddressViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.ShippingAddressViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.ShippingAddressViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 shipping address views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ShippingAddressView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.ShippingAddressViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.ShippingAddressViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ShippingAddressView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.ShippingAddressViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
