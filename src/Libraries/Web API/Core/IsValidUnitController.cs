...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function IsValidUnit.
    /// </summary>
    [RoutePrefix("api/v1.5/core/procedures/is-valid-unit")]
    public class IsValidUnitController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "is valid unit" annotation meta information to perform CRUD operation.</returns>
