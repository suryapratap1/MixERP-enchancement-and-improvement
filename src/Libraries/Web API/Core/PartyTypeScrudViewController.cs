...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The PartyTypeScrudView repository.
        /// </summary>
        private readonly IPartyTypeScrudViewRepository PartyTypeScrudViewRepository;
        ...
        public PartyTypeScrudViewController()
        {
            ...
            this.PartyTypeScrudViewRepository = new MixERP.Net.Schemas.Core.Data.PartyTypeScrudView
            {
        ...
        public PartyTypeScrudViewController(IPartyTypeScrudViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.PartyTypeScrudViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.PartyTypeScrudViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of party type scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/party-type-scrud-view/export")]
        [Route("~/api/core/party-type-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.PartyTypeScrudView> Get()
        {
            try
            {
                return this.PartyTypeScrudViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 party type scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.PartyTypeScrudView> GetPaginatedResult()
        {
            try
            {
                return this.PartyTypeScrudViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.PartyTypeScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.PartyTypeScrudViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.PartyTypeScrudViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.PartyTypeScrudViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 party type scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.PartyTypeScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.PartyTypeScrudViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.PartyTypeScrudViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.PartyTypeScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.PartyTypeScrudViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
