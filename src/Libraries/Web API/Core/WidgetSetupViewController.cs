...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The WidgetSetupView repository.
        /// </summary>
        private readonly IWidgetSetupViewRepository WidgetSetupViewRepository;
        ...
        public WidgetSetupViewController()
        {
            ...
            this.WidgetSetupViewRepository = new MixERP.Net.Schemas.Core.Data.WidgetSetupView
            {
        ...
        public WidgetSetupViewController(IWidgetSetupViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.WidgetSetupViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.WidgetSetupViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of widget setup view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/widget-setup-view/export")]
        [Route("~/api/core/widget-setup-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.WidgetSetupView> Get()
        {
            try
            {
                return this.WidgetSetupViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 widget setup views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.WidgetSetupView> GetPaginatedResult()
        {
            try
            {
                return this.WidgetSetupViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.WidgetSetupView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.WidgetSetupViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.WidgetSetupViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.WidgetSetupViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 widget setup views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.WidgetSetupView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.WidgetSetupViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.WidgetSetupViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.WidgetSetupView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.WidgetSetupViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
