...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The ItemGroupSelectorView repository.
        /// </summary>
        private readonly IItemGroupSelectorViewRepository ItemGroupSelectorViewRepository;
        ...
        public ItemGroupSelectorViewController()
        {
            ...
            this.ItemGroupSelectorViewRepository = new MixERP.Net.Schemas.Core.Data.ItemGroupSelectorView
            {
        ...
        public ItemGroupSelectorViewController(IItemGroupSelectorViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.ItemGroupSelectorViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.ItemGroupSelectorViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of item group selector view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/item-group-selector-view/export")]
        [Route("~/api/core/item-group-selector-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.ItemGroupSelectorView> Get()
        {
            try
            {
                return this.ItemGroupSelectorViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 item group selector views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ItemGroupSelectorView> GetPaginatedResult()
        {
            try
            {
                return this.ItemGroupSelectorViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ItemGroupSelectorView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.ItemGroupSelectorViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.ItemGroupSelectorViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.ItemGroupSelectorViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 item group selector views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ItemGroupSelectorView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.ItemGroupSelectorViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.ItemGroupSelectorViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ItemGroupSelectorView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.ItemGroupSelectorViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
