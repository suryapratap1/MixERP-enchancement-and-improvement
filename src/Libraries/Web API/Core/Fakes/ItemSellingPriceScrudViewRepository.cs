...
{
    public class ItemSellingPriceScrudViewRepository : IItemSellingPriceScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.ItemSellingPriceScrudView(), 1);
        }
