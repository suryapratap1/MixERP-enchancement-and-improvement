...
{
    public class SalesTaxExemptDetailScrudViewRepository : ISalesTaxExemptDetailScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.SalesTaxExemptDetailScrudView(), 1);
        }
