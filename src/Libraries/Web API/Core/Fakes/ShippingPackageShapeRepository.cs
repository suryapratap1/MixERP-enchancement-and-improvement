...
{
    public class ShippingPackageShapeRepository : IShippingPackageShapeRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            if (shippingPackageShapeId > 0)
            {
                return;
            }

            throw new ArgumentException("shippingPackageShapeId is null.");
        }
