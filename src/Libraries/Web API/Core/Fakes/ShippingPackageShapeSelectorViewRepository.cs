...
{
    public class ShippingPackageShapeSelectorViewRepository : IShippingPackageShapeSelectorViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.ShippingPackageShapeSelectorView(), 1);
        }
