...
{
    public class PriceTypeSelectorViewRepository : IPriceTypeSelectorViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.PriceTypeSelectorView(), 1);
        }
