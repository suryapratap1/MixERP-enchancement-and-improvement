...
namespace MixERP.Net.Api.Core.Fakes
{
    public class PartyTypeRepository : IPartyTypeRepository
    {
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.PartyType(), 1);
        }
        ...
        {
            return new MixERP.Net.Entities.Core.PartyType();
        }
        ...
        public void Update(dynamic partyType, int partyTypeId)
        {
            ...
            throw new ArgumentException("partyTypeId is null.");
        }
