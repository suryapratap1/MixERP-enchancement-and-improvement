...
namespace MixERP.Net.Api.Core.Fakes
{
    public class PriceTypeRepository : IPriceTypeRepository
    {
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.PriceType(), 1);
        }
        ...
        {
            return new MixERP.Net.Entities.Core.PriceType();
        }
        ...
        public void Update(dynamic priceType, int priceTypeId)
        {
            ...
            throw new ArgumentException("priceTypeId is null.");
        }
