...
{
    public class CashFlowHeadingScrudViewRepository : ICashFlowHeadingScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.CashFlowHeadingScrudView(), 1);
        }
