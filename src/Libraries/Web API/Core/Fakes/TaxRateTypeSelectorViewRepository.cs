...
{
    public class TaxRateTypeSelectorViewRepository : ITaxRateTypeSelectorViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.TaxRateTypeSelectorView(), 1);
        }
