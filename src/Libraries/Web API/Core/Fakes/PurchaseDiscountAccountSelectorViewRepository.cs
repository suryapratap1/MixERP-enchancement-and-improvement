...
{
    public class PurchaseDiscountAccountSelectorViewRepository : IPurchaseDiscountAccountSelectorViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.PurchaseDiscountAccountSelectorView(), 1);
        }
