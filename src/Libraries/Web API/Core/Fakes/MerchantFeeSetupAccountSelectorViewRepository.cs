...
{
    public class MerchantFeeSetupAccountSelectorViewRepository : IMerchantFeeSetupAccountSelectorViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.MerchantFeeSetupAccountSelectorView(), 1);
        }
