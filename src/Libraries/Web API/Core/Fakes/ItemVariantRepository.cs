...
namespace MixERP.Net.Api.Core.Fakes
{
    public class ItemVariantRepository : IItemVariantRepository
    {
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.ItemVariant(), 1);
        }
        ...
        {
            return new MixERP.Net.Entities.Core.ItemVariant();
        }
        ...
        public void Update(dynamic itemVariant, int itemVariantId)
        {
            ...
            throw new ArgumentException("itemVariantId is null.");
        }
