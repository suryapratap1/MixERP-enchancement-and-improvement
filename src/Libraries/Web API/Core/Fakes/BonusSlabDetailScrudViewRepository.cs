...
{
    public class BonusSlabDetailScrudViewRepository : IBonusSlabDetailScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.BonusSlabDetailScrudView(), 1);
        }
