...
{
    public class FrequencySetupScrudViewRepository : IFrequencySetupScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.FrequencySetupScrudView(), 1);
        }
