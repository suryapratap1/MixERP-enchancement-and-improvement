...
{
    public class SalespersonScrudViewRepository : ISalespersonScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.SalespersonScrudView(), 1);
        }
