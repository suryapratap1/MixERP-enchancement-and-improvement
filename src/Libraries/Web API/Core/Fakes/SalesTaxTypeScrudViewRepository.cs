...
{
    public class SalesTaxTypeScrudViewRepository : ISalesTaxTypeScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.SalesTaxTypeScrudView(), 1);
        }
