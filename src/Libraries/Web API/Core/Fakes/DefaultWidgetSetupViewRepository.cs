...
{
    public class DefaultWidgetSetupViewRepository : IDefaultWidgetSetupViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.DefaultWidgetSetupView(), 1);
        }
