...
{
    public class BankAccountScrudViewRepository : IBankAccountScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Core.BankAccountScrudView(), 1);
        }
