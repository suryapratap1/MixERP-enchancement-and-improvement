...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The PriceTypeSelectorView repository.
        /// </summary>
        private readonly IPriceTypeSelectorViewRepository PriceTypeSelectorViewRepository;
        ...
        public PriceTypeSelectorViewController()
        {
            ...
            this.PriceTypeSelectorViewRepository = new MixERP.Net.Schemas.Core.Data.PriceTypeSelectorView
            {
        ...
        public PriceTypeSelectorViewController(IPriceTypeSelectorViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.PriceTypeSelectorViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.PriceTypeSelectorViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of price type selector view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/price-type-selector-view/export")]
        [Route("~/api/core/price-type-selector-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.PriceTypeSelectorView> Get()
        {
            try
            {
                return this.PriceTypeSelectorViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 price type selector views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.PriceTypeSelectorView> GetPaginatedResult()
        {
            try
            {
                return this.PriceTypeSelectorViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.PriceTypeSelectorView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.PriceTypeSelectorViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.PriceTypeSelectorViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.PriceTypeSelectorViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 price type selector views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.PriceTypeSelectorView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.PriceTypeSelectorViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.PriceTypeSelectorViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.PriceTypeSelectorView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.PriceTypeSelectorViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
