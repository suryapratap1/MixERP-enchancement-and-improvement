...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The ItemGroupScrudView repository.
        /// </summary>
        private readonly IItemGroupScrudViewRepository ItemGroupScrudViewRepository;
        ...
        public ItemGroupScrudViewController()
        {
            ...
            this.ItemGroupScrudViewRepository = new MixERP.Net.Schemas.Core.Data.ItemGroupScrudView
            {
        ...
        public ItemGroupScrudViewController(IItemGroupScrudViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.ItemGroupScrudViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.ItemGroupScrudViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of item group scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/item-group-scrud-view/export")]
        [Route("~/api/core/item-group-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.ItemGroupScrudView> Get()
        {
            try
            {
                return this.ItemGroupScrudViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 item group scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ItemGroupScrudView> GetPaginatedResult()
        {
            try
            {
                return this.ItemGroupScrudViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ItemGroupScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.ItemGroupScrudViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.ItemGroupScrudViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.ItemGroupScrudViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 item group scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ItemGroupScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.ItemGroupScrudViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.ItemGroupScrudViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ItemGroupScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.ItemGroupScrudViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
