...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function IsStockItem.
    /// </summary>
    [RoutePrefix("api/v1.5/core/procedures/is-stock-item")]
    public class IsStockItemController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "is stock item" annotation meta information to perform CRUD operation.</returns>
