...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetTaxAuthorityIdByTaxAuthorityCode.
    /// </summary>
    [RoutePrefix("api/v1.5/core/procedures/get-tax-authority-id-by-tax-authority-code")]
    public class GetTaxAuthorityIdByTaxAuthorityCodeController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "get tax authority id by tax authority code" annotation meta information to perform CRUD operation.</returns>
        ...
        public EntityView GetAnnotation()
        {
            ...
            return new EntityView
            {
                Columns = new List<EntityColumn>()
                                {
                                        new EntityColumn { ColumnName = "_tax_authority_code",  PropertyName = "TaxAuthorityCode",  DataType = "string",  DbDataType = "character varying",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "",  MaxLength = 0 }
                                }
            };
        }
