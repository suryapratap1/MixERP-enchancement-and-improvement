...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The BonusSlabAccountSelectorView repository.
        /// </summary>
        private readonly IBonusSlabAccountSelectorViewRepository BonusSlabAccountSelectorViewRepository;
        ...
        public BonusSlabAccountSelectorViewController()
        {
            ...
            this.BonusSlabAccountSelectorViewRepository = new MixERP.Net.Schemas.Core.Data.BonusSlabAccountSelectorView
            {
        ...
        public BonusSlabAccountSelectorViewController(IBonusSlabAccountSelectorViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.BonusSlabAccountSelectorViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.BonusSlabAccountSelectorViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of bonus slab account selector view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/bonus-slab-account-selector-view/export")]
        [Route("~/api/core/bonus-slab-account-selector-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.BonusSlabAccountSelectorView> Get()
        {
            try
            {
                return this.BonusSlabAccountSelectorViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.BonusSlabAccountSelectorView> GetPaginatedResult()
        {
            try
            {
                return this.BonusSlabAccountSelectorViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.BonusSlabAccountSelectorView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.BonusSlabAccountSelectorViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.BonusSlabAccountSelectorViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.BonusSlabAccountSelectorViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.BonusSlabAccountSelectorView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            ...
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.BonusSlabAccountSelectorViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.BonusSlabAccountSelectorViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.BonusSlabAccountSelectorView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.BonusSlabAccountSelectorViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
