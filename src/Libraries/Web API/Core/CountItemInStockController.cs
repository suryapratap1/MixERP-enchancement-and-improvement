...
namespace MixERP.Net.Api.Core
{
    ...
    /// </summary>
    [RoutePrefix("api/v1.5/core/procedures/count-item-in-stock")]
    public class CountItemInStockController : ApiController
    {
        ...
        [Route("annotation")]
        [Route("~/api/core/procedures/count-item-in-stock/annotation")]
        ...
        [AcceptVerbs("POST")]
        [Route("execute")]
        [Route("~/api/core/procedures/count-item-in-stock/execute")]
