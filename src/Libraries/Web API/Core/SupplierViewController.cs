...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The SupplierView repository.
        /// </summary>
        private readonly ISupplierViewRepository SupplierViewRepository;
        ...
        public SupplierViewController()
        {
            ...
            this.SupplierViewRepository = new MixERP.Net.Schemas.Core.Data.SupplierView
            {
        ...
        public SupplierViewController(ISupplierViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.SupplierViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.SupplierViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of supplier view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/supplier-view/export")]
        [Route("~/api/core/supplier-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.SupplierView> Get()
        {
            try
            {
                return this.SupplierViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 supplier views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SupplierView> GetPaginatedResult()
        {
            try
            {
                return this.SupplierViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SupplierView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.SupplierViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.SupplierViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.SupplierViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 supplier views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SupplierView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.SupplierViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.SupplierViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SupplierView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.SupplierViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
