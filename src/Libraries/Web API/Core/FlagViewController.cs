...
namespace MixERP.Net.Api.Core
{
    ...
    public class FlagViewController : ApiController
    {
        ...
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/flag-view/export")]
        [Route("~/api/core/flag-view/all")]
        ...
        [AcceptVerbs("POST")]
        [Route("count-where")]
        [Route("~/api/core/flag-view/count-where")]
        ...
        public IEnumerable<MixERP.Net.Entities.Core.FlagView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
        ...
        [Route("~/api/core/flag-view/count-filtered/{filterName}")]
        ...
        [Route("~/api/core/flag-view/get-filtered/{pageNumber}/{filterName}")]
