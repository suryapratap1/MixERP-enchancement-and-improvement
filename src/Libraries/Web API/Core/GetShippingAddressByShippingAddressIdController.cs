...
namespace MixERP.Net.Api.Core
{
    ...
    public class GetShippingAddressByShippingAddressIdController : ApiController
    {
        ...
        /// <summary>
        ///     The GetShippingAddressByShippingAddressId repository.
        /// </summary>
        private readonly IGetShippingAddressByShippingAddressIdRepository repository;
        ...
        public GetShippingAddressByShippingAddressIdController()
        {
            ...
            this.repository = new GetShippingAddressByShippingAddressIdProcedure
            {
        ...
        public GetShippingAddressByShippingAddressIdController(IGetShippingAddressByShippingAddressIdRepository repository, string catalog, LoginView view)
        {
