...
{
    public class SalesTeamScrudViewTests
    {
        public static SalesTeamScrudViewController Fixture()
        {
            SalesTeamScrudViewController controller = new SalesTeamScrudViewController(new SalesTeamScrudViewRepository(), "", new LoginView());
            return controller;
        }
