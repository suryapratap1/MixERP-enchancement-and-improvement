...
{
    public class SupplierViewTests
    {
        public static SupplierViewController Fixture()
        {
            SupplierViewController controller = new SupplierViewController(new SupplierViewRepository(), "", new LoginView());
            return controller;
        }
