...
{
    public class ExchangeRateDetailTests
    {
        public static ExchangeRateDetailController Fixture()
        {
            ExchangeRateDetailController controller = new ExchangeRateDetailController(new ExchangeRateDetailRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.ExchangeRateDetail exchangeRateDetail = Fixture().Get(0);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(exchangeRateDetails);
        }
