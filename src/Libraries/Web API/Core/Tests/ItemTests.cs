...
namespace MixERP.Net.Api.Core.Tests
{
    public class ItemTests
    {
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.Item item = Fixture().Get(0);
            Assert.NotNull(item);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.Item item = Fixture().GetFirst();
            Assert.NotNull(item);
        }
        ...
        {
            MixERP.Net.Entities.Core.Item item = Fixture().GetPrevious(0);
            Assert.NotNull(item);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.Item item = Fixture().GetNext(0);
            Assert.NotNull(item);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.Item item = Fixture().GetLast();
            Assert.NotNull(item);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.Item> items = Fixture().Get(new int[] { });
