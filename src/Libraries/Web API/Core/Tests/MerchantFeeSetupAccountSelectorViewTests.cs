...
{
    public class MerchantFeeSetupAccountSelectorViewTests
    {
        public static MerchantFeeSetupAccountSelectorViewController Fixture()
        {
            MerchantFeeSetupAccountSelectorViewController controller = new MerchantFeeSetupAccountSelectorViewController(new MerchantFeeSetupAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
