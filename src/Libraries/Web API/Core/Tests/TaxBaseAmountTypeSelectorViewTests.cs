...
{
    public class TaxBaseAmountTypeSelectorViewTests
    {
        public static TaxBaseAmountTypeSelectorViewController Fixture()
        {
            TaxBaseAmountTypeSelectorViewController controller = new TaxBaseAmountTypeSelectorViewController(new TaxBaseAmountTypeSelectorViewRepository(), "", new LoginView());
            return controller;
        }
