...
namespace MixERP.Net.Api.Core.Tests
{
    ...
    {
        public static CoreLateFeeController Fixture()
        {
            CoreLateFeeController controller = new CoreLateFeeController(new LateFeeRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.LateFee lateFee = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.LateFee lateFee = Fixture().GetFirst();
            Assert.NotNull(lateFee);
        }
        ...
        {
            MixERP.Net.Entities.Core.LateFee lateFee = Fixture().GetPrevious(0);
            Assert.NotNull(lateFee);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.LateFee lateFee = Fixture().GetNext(0);
            Assert.NotNull(lateFee);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.LateFee lateFee = Fixture().GetLast();
            Assert.NotNull(lateFee);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.LateFee> lateFees = Fixture().Get(new int[] { });
            Assert.NotNull(lateFees);
        }
