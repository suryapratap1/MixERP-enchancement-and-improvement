...
{
    public class IndustryScrudViewTests
    {
        public static IndustryScrudViewController Fixture()
        {
            IndustryScrudViewController controller = new IndustryScrudViewController(new IndustryScrudViewRepository(), "", new LoginView());
            return controller;
        }
