...
namespace MixERP.Net.Api.Core.Tests
{
    public class PartyTests
    {
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.Party party = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.Party party = Fixture().GetFirst();
            Assert.NotNull(party);
        }
        ...
        {
            MixERP.Net.Entities.Core.Party party = Fixture().GetPrevious(0);
            Assert.NotNull(party);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.Party party = Fixture().GetNext(0);
            Assert.NotNull(party);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.Party party = Fixture().GetLast();
            Assert.NotNull(party);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.Party> parties = Fixture().Get(new long[] { });
