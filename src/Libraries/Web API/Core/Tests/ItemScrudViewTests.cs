...
{
    public class ItemScrudViewTests
    {
        public static ItemScrudViewController Fixture()
        {
            ItemScrudViewController controller = new ItemScrudViewController(new ItemScrudViewRepository(), "", new LoginView());
            return controller;
        }
