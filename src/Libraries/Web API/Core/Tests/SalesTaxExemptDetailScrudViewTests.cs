...
{
    public class SalesTaxExemptDetailScrudViewTests
    {
        public static SalesTaxExemptDetailScrudViewController Fixture()
        {
            SalesTaxExemptDetailScrudViewController controller = new SalesTaxExemptDetailScrudViewController(new SalesTaxExemptDetailScrudViewRepository(), "", new LoginView());
            return controller;
        }
