...
{
    public class SalesDiscountAccountSelectorViewTests
    {
        public static SalesDiscountAccountSelectorViewController Fixture()
        {
            SalesDiscountAccountSelectorViewController controller = new SalesDiscountAccountSelectorViewController(new SalesDiscountAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
