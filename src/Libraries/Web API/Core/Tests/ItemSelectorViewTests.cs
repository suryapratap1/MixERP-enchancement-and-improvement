...
{
    public class ItemSelectorViewTests
    {
        public static ItemSelectorViewController Fixture()
        {
            ItemSelectorViewController controller = new ItemSelectorViewController(new ItemSelectorViewRepository(), "", new LoginView());
            return controller;
        }
