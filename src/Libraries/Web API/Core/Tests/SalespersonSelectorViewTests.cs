...
{
    public class SalespersonSelectorViewTests
    {
        public static SalespersonSelectorViewController Fixture()
        {
            SalespersonSelectorViewController controller = new SalespersonSelectorViewController(new SalespersonSelectorViewRepository(), "", new LoginView());
            return controller;
        }
