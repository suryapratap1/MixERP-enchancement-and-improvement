...
{
    public class ItemSellingPriceTests
    {
        public static ItemSellingPriceController Fixture()
        {
            ItemSellingPriceController controller = new ItemSellingPriceController(new ItemSellingPriceRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.ItemSellingPrice itemSellingPrice = Fixture().Get(0);
            Assert.NotNull(itemSellingPrice);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.ItemSellingPrice itemSellingPrice = Fixture().GetFirst();
            Assert.NotNull(itemSellingPrice);
        }
        ...
        {
            MixERP.Net.Entities.Core.ItemSellingPrice itemSellingPrice = Fixture().GetPrevious(0);
            Assert.NotNull(itemSellingPrice);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.ItemSellingPrice itemSellingPrice = Fixture().GetNext(0);
            Assert.NotNull(itemSellingPrice);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.ItemSellingPrice itemSellingPrice = Fixture().GetLast();
            Assert.NotNull(itemSellingPrice);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.ItemSellingPrice> itemSellingPrices = Fixture().Get(new long[] { });
            Assert.NotNull(itemSellingPrices);
        }
