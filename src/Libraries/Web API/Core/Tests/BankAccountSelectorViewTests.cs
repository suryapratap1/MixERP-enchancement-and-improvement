...
{
    public class BankAccountSelectorViewTests
    {
        public static BankAccountSelectorViewController Fixture()
        {
            BankAccountSelectorViewController controller = new BankAccountSelectorViewController(new BankAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
