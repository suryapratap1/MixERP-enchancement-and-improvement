...
{
    public class EntityScrudViewTests
    {
        public static EntityScrudViewController Fixture()
        {
            EntityScrudViewController controller = new EntityScrudViewController(new EntityScrudViewRepository(), "", new LoginView());
            return controller;
        }
