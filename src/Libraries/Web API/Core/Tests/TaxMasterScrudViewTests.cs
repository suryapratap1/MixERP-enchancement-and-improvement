...
{
    public class TaxMasterScrudViewTests
    {
        public static TaxMasterScrudViewController Fixture()
        {
            TaxMasterScrudViewController controller = new TaxMasterScrudViewController(new TaxMasterScrudViewRepository(), "", new LoginView());
            return controller;
        }
