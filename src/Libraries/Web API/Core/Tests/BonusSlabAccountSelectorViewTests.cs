...
{
    public class BonusSlabAccountSelectorViewTests
    {
        public static BonusSlabAccountSelectorViewController Fixture()
        {
            BonusSlabAccountSelectorViewController controller = new BonusSlabAccountSelectorViewController(new BonusSlabAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
