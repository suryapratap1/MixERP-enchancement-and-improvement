...
{
    public class RecurringInvoiceSetupScrudViewTests
    {
        public static RecurringInvoiceSetupScrudViewController Fixture()
        {
            RecurringInvoiceSetupScrudViewController controller = new RecurringInvoiceSetupScrudViewController(new RecurringInvoiceSetupScrudViewRepository(), "", new LoginView());
            return controller;
        }
