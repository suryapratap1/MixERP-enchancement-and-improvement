...
{
    public class PartySelectorViewTests
    {
        public static PartySelectorViewController Fixture()
        {
            PartySelectorViewController controller = new PartySelectorViewController(new PartySelectorViewRepository(), "", new LoginView());
            return controller;
        }
