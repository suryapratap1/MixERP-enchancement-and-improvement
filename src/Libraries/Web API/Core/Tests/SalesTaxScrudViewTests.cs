...
{
    public class SalesTaxScrudViewTests
    {
        public static SalesTaxScrudViewController Fixture()
        {
            SalesTaxScrudViewController controller = new SalesTaxScrudViewController(new SalesTaxScrudViewRepository(), "", new LoginView());
            return controller;
        }
