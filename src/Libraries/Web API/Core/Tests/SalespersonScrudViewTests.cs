...
{
    public class SalespersonScrudViewTests
    {
        public static SalespersonScrudViewController Fixture()
        {
            SalespersonScrudViewController controller = new SalespersonScrudViewController(new SalespersonScrudViewRepository(), "", new LoginView());
            return controller;
        }
