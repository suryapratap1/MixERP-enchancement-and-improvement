...
{
    public class AccountScrudViewTests
    {
        public static AccountScrudViewController Fixture()
        {
            AccountScrudViewController controller = new AccountScrudViewController(new AccountScrudViewRepository(), "", new LoginView());
            return controller;
        }
