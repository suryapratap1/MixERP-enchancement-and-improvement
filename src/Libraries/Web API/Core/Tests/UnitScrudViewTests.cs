...
{
    public class UnitScrudViewTests
    {
        public static UnitScrudViewController Fixture()
        {
            UnitScrudViewController controller = new UnitScrudViewController(new UnitScrudViewRepository(), "", new LoginView());
            return controller;
        }
