...
{
    public class ShippingPackageShapeTests
    {
        public static ShippingPackageShapeController Fixture()
        {
            ShippingPackageShapeController controller = new ShippingPackageShapeController(new ShippingPackageShapeRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.ShippingPackageShape shippingPackageShape = Fixture().Get(0);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(shippingPackageShapes);
        }
