...
namespace MixERP.Net.Api.Core.Tests
{
    public class WeekDayTests
    {
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.WeekDay weekDay = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.WeekDay weekDay = Fixture().GetFirst();
            Assert.NotNull(weekDay);
        }
        ...
        {
            MixERP.Net.Entities.Core.WeekDay weekDay = Fixture().GetPrevious(0);
            Assert.NotNull(weekDay);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.WeekDay weekDay = Fixture().GetNext(0);
            Assert.NotNull(weekDay);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.WeekDay weekDay = Fixture().GetLast();
            Assert.NotNull(weekDay);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.WeekDay> weekDays = Fixture().Get(new int[] { });
