...
{
    public class ShippingMailTypeTests
    {
        public static ShippingMailTypeController Fixture()
        {
            ShippingMailTypeController controller = new ShippingMailTypeController(new ShippingMailTypeRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.ShippingMailType shippingMailType = Fixture().Get(0);
            Assert.NotNull(shippingMailType);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.ShippingMailType shippingMailType = Fixture().GetFirst();
            Assert.NotNull(shippingMailType);
        }
        ...
        {
            MixERP.Net.Entities.Core.ShippingMailType shippingMailType = Fixture().GetPrevious(0);
            Assert.NotNull(shippingMailType);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.ShippingMailType shippingMailType = Fixture().GetNext(0);
            Assert.NotNull(shippingMailType);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.ShippingMailType shippingMailType = Fixture().GetLast();
            Assert.NotNull(shippingMailType);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.ShippingMailType> shippingMailTypes = Fixture().Get(new int[] { });
            Assert.NotNull(shippingMailTypes);
        }
