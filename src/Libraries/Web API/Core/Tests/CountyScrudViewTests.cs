...
{
    public class CountyScrudViewTests
    {
        public static CountyScrudViewController Fixture()
        {
            CountyScrudViewController controller = new CountyScrudViewController(new CountyScrudViewRepository(), "", new LoginView());
            return controller;
        }
