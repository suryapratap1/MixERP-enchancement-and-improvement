...
{
    public class BonusSlabDetailScrudViewTests
    {
        public static BonusSlabDetailScrudViewController Fixture()
        {
            BonusSlabDetailScrudViewController controller = new BonusSlabDetailScrudViewController(new BonusSlabDetailScrudViewRepository(), "", new LoginView());
            return controller;
        }
