...
{
    public class ItemCostPriceTests
    {
        public static ItemCostPriceController Fixture()
        {
            ItemCostPriceController controller = new ItemCostPriceController(new ItemCostPriceRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.ItemCostPrice itemCostPrice = Fixture().Get(0);
