...
{
    public class FlagTypeScrudViewTests
    {
        public static FlagTypeScrudViewController Fixture()
        {
            FlagTypeScrudViewController controller = new FlagTypeScrudViewController(new FlagTypeScrudViewRepository(), "", new LoginView());
            return controller;
        }
