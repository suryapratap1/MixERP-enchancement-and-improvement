...
{
    public class RevenueAccountSelectorViewTests
    {
        public static RevenueAccountSelectorViewController Fixture()
        {
            RevenueAccountSelectorViewController controller = new RevenueAccountSelectorViewController(new RevenueAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
