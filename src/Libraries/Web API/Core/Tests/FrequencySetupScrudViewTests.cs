...
{
    public class FrequencySetupScrudViewTests
    {
        public static FrequencySetupScrudViewController Fixture()
        {
            FrequencySetupScrudViewController controller = new FrequencySetupScrudViewController(new FrequencySetupScrudViewRepository(), "", new LoginView());
            return controller;
        }
