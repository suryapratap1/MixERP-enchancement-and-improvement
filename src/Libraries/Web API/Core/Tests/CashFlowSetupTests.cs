...
{
    public class CashFlowSetupTests
    {
        public static CashFlowSetupController Fixture()
        {
            CashFlowSetupController controller = new CashFlowSetupController(new CashFlowSetupRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.CashFlowSetup cashFlowSetup = Fixture().Get(0);
