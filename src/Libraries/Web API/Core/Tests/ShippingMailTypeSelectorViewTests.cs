...
{
    public class ShippingMailTypeSelectorViewTests
    {
        public static ShippingMailTypeSelectorViewController Fixture()
        {
            ShippingMailTypeSelectorViewController controller = new ShippingMailTypeSelectorViewController(new ShippingMailTypeSelectorViewRepository(), "", new LoginView());
            return controller;
        }
