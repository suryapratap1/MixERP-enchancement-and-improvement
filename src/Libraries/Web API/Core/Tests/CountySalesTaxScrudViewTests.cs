...
{
    public class CountySalesTaxScrudViewTests
    {
        public static CountySalesTaxScrudViewController Fixture()
        {
            CountySalesTaxScrudViewController controller = new CountySalesTaxScrudViewController(new CountySalesTaxScrudViewRepository(), "", new LoginView());
            return controller;
        }
