...
{
    public class TaxExemptTypeTests
    {
        public static TaxExemptTypeController Fixture()
        {
            TaxExemptTypeController controller = new TaxExemptTypeController(new TaxExemptTypeRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.TaxExemptType taxExemptType = Fixture().Get(0);
            Assert.NotNull(taxExemptType);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.TaxExemptType taxExemptType = Fixture().GetFirst();
            Assert.NotNull(taxExemptType);
        }
        ...
        {
            MixERP.Net.Entities.Core.TaxExemptType taxExemptType = Fixture().GetPrevious(0);
            Assert.NotNull(taxExemptType);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.TaxExemptType taxExemptType = Fixture().GetNext(0);
            Assert.NotNull(taxExemptType);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.TaxExemptType taxExemptType = Fixture().GetLast();
            Assert.NotNull(taxExemptType);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.TaxExemptType> taxExemptTypes = Fixture().Get(new int[] { });
            Assert.NotNull(taxExemptTypes);
        }
