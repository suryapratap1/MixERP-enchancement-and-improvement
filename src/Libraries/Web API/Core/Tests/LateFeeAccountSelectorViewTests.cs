...
{
    public class LateFeeAccountSelectorViewTests
    {
        public static LateFeeAccountSelectorViewController Fixture()
        {
            LateFeeAccountSelectorViewController controller = new LateFeeAccountSelectorViewController(new LateFeeAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
