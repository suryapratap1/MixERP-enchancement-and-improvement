...
{
    public class ShippingPackageShapeSelectorViewTests
    {
        public static ShippingPackageShapeSelectorViewController Fixture()
        {
            ShippingPackageShapeSelectorViewController controller = new ShippingPackageShapeSelectorViewController(new ShippingPackageShapeSelectorViewRepository(), "", new LoginView());
            return controller;
        }
