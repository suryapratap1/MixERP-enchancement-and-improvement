...
{
    public class BankAccountScrudViewTests
    {
        public static BankAccountScrudViewController Fixture()
        {
            BankAccountScrudViewController controller = new BankAccountScrudViewController(new BankAccountScrudViewRepository(), "", new LoginView());
            return controller;
        }
