...
{
    public class CashFlowHeadingScrudViewTests
    {
        public static CashFlowHeadingScrudViewController Fixture()
        {
            CashFlowHeadingScrudViewController controller = new CashFlowHeadingScrudViewController(new CashFlowHeadingScrudViewRepository(), "", new LoginView());
            return controller;
        }
