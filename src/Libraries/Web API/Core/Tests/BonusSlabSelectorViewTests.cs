...
{
    public class BonusSlabSelectorViewTests
    {
        public static BonusSlabSelectorViewController Fixture()
        {
            BonusSlabSelectorViewController controller = new BonusSlabSelectorViewController(new BonusSlabSelectorViewRepository(), "", new LoginView());
            return controller;
        }
