...
{
    public class TaxAuthorityScrudViewTests
    {
        public static TaxAuthorityScrudViewController Fixture()
        {
            TaxAuthorityScrudViewController controller = new TaxAuthorityScrudViewController(new TaxAuthorityScrudViewRepository(), "", new LoginView());
            return controller;
        }
