...
{
    public class SalespersonBonusSetupScrudViewTests
    {
        public static SalespersonBonusSetupScrudViewController Fixture()
        {
            SalespersonBonusSetupScrudViewController controller = new SalespersonBonusSetupScrudViewController(new SalespersonBonusSetupScrudViewRepository(), "", new LoginView());
            return controller;
        }
