...
namespace MixERP.Net.Api.Core.Tests
{
    ...
    {
        public static MaritalStatusController Fixture()
        {
            MaritalStatusController controller = new MaritalStatusController(new MaritalStatusRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.MaritalStatus maritalStatus = Fixture().Get(0);
