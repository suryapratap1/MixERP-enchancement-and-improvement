...
{
    public class FrequencySetupTests
    {
        public static FrequencySetupController Fixture()
        {
            FrequencySetupController controller = new FrequencySetupController(new FrequencySetupRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.FrequencySetup frequencySetup = Fixture().Get(0);
            Assert.NotNull(frequencySetup);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.FrequencySetup frequencySetup = Fixture().GetFirst();
            Assert.NotNull(frequencySetup);
        }
        ...
        {
            MixERP.Net.Entities.Core.FrequencySetup frequencySetup = Fixture().GetPrevious(0);
            Assert.NotNull(frequencySetup);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.FrequencySetup frequencySetup = Fixture().GetNext(0);
            Assert.NotNull(frequencySetup);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.FrequencySetup frequencySetup = Fixture().GetLast();
            Assert.NotNull(frequencySetup);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.FrequencySetup> frequencySetups = Fixture().Get(new int[] { });
            Assert.NotNull(frequencySetups);
        }
