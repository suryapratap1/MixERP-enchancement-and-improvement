...
{
    public class CompoundItemScrudViewTests
    {
        public static CompoundItemScrudViewController Fixture()
        {
            CompoundItemScrudViewController controller = new CompoundItemScrudViewController(new CompoundItemScrudViewRepository(), "", new LoginView());
            return controller;
        }
