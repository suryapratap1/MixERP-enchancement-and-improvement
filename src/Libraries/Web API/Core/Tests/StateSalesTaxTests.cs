...
{
    public class StateSalesTaxTests
    {
        public static StateSalesTaxController Fixture()
        {
            StateSalesTaxController controller = new StateSalesTaxController(new StateSalesTaxRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.StateSalesTax stateSalesTax = Fixture().Get(0);
            Assert.NotNull(stateSalesTax);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.StateSalesTax stateSalesTax = Fixture().GetFirst();
            Assert.NotNull(stateSalesTax);
        }
        ...
        {
            MixERP.Net.Entities.Core.StateSalesTax stateSalesTax = Fixture().GetPrevious(0);
            Assert.NotNull(stateSalesTax);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.StateSalesTax stateSalesTax = Fixture().GetNext(0);
            Assert.NotNull(stateSalesTax);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.StateSalesTax stateSalesTax = Fixture().GetLast();
            Assert.NotNull(stateSalesTax);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.StateSalesTax> stateSalesTaxes = Fixture().Get(new int[] { });
            Assert.NotNull(stateSalesTaxes);
        }
