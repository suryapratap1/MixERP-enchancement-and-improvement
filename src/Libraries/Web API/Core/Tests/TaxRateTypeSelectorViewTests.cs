...
{
    public class TaxRateTypeSelectorViewTests
    {
        public static TaxRateTypeSelectorViewController Fixture()
        {
            TaxRateTypeSelectorViewController controller = new TaxRateTypeSelectorViewController(new TaxRateTypeSelectorViewRepository(), "", new LoginView());
            return controller;
        }
