...
{
    public class WidgetGroupTests
    {
        public static WidgetGroupController Fixture()
        {
            WidgetGroupController controller = new WidgetGroupController(new WidgetGroupRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.WidgetGroup widgetGroup = Fixture().Get(string.Empty);
        ...
        {
            MixERP.Net.Entities.Core.WidgetGroup widgetGroup = Fixture().GetPrevious(string.Empty);
            Assert.NotNull(widgetGroup);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.WidgetGroup widgetGroup = Fixture().GetLast();
            Assert.NotNull(widgetGroup);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.WidgetGroup> widgetGroups = Fixture().Get(new string[] { });
            Assert.NotNull(widgetGroups);
        }
