...
{
    public class PartyScrudViewTests
    {
        public static PartyScrudViewController Fixture()
        {
            PartyScrudViewController controller = new PartyScrudViewController(new PartyScrudViewRepository(), "", new LoginView());
            return controller;
        }
