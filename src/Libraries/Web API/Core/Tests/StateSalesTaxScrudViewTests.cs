...
{
    public class StateSalesTaxScrudViewTests
    {
        public static StateSalesTaxScrudViewController Fixture()
        {
            StateSalesTaxScrudViewController controller = new StateSalesTaxScrudViewController(new StateSalesTaxScrudViewRepository(), "", new LoginView());
            return controller;
        }
