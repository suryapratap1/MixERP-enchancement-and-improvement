...
{
    public class ItemCostPriceScrudViewTests
    {
        public static ItemCostPriceScrudViewController Fixture()
        {
            ItemCostPriceScrudViewController controller = new ItemCostPriceScrudViewController(new ItemCostPriceScrudViewRepository(), "", new LoginView());
            return controller;
        }
