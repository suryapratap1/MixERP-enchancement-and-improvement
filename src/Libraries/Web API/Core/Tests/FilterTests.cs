...
namespace MixERP.Net.Api.Core.Tests
{
    public class FilterTests
    {
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.Filter filter = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.Filter filter = Fixture().GetFirst();
            Assert.NotNull(filter);
        }
        ...
        {
            MixERP.Net.Entities.Core.Filter filter = Fixture().GetPrevious(0);
            Assert.NotNull(filter);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.Filter filter = Fixture().GetNext(0);
            Assert.NotNull(filter);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.Filter filter = Fixture().GetLast();
            Assert.NotNull(filter);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.Filter> filters = Fixture().Get(new long[] { });
