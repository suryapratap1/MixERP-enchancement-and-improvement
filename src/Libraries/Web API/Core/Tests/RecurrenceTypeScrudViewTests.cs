...
{
    public class RecurrenceTypeScrudViewTests
    {
        public static RecurrenceTypeScrudViewController Fixture()
        {
            RecurrenceTypeScrudViewController controller = new RecurrenceTypeScrudViewController(new RecurrenceTypeScrudViewRepository(), "", new LoginView());
            return controller;
        }
