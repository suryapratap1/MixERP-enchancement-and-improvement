...
{
    public class BankAccountsScrudViewTests
    {
        public static BankAccountsScrudViewController Fixture()
        {
            BankAccountsScrudViewController controller = new BankAccountsScrudViewController(new BankAccountsScrudViewRepository(), "", new LoginView());
            return controller;
        }
