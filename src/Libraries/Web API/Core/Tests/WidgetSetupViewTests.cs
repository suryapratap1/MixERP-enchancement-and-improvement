...
{
    public class WidgetSetupViewTests
    {
        public static WidgetSetupViewController Fixture()
        {
            WidgetSetupViewController controller = new WidgetSetupViewController(new WidgetSetupViewRepository(), "", new LoginView());
            return controller;
        }
