...
{
    public class SupplierSelectorViewTests
    {
        public static SupplierSelectorViewController Fixture()
        {
            SupplierSelectorViewController controller = new SupplierSelectorViewController(new SupplierSelectorViewRepository(), "", new LoginView());
            return controller;
        }
