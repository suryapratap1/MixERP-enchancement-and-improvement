...
{
    public class BonusSlabDetailTests
    {
        public static BonusSlabDetailController Fixture()
        {
            BonusSlabDetailController controller = new BonusSlabDetailController(new BonusSlabDetailRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.BonusSlabDetail bonusSlabDetail = Fixture().Get(0);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(bonusSlabDetails);
        }
