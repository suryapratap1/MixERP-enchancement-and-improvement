...
namespace MixERP.Net.Api.Core.Tests
{
    ...
    {
        public static VerificationStatusController Fixture()
        {
            VerificationStatusController controller = new VerificationStatusController(new VerificationStatusRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.VerificationStatus verificationStatus = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.VerificationStatus verificationStatus = Fixture().GetFirst();
            Assert.NotNull(verificationStatus);
        }
        ...
        {
            MixERP.Net.Entities.Core.VerificationStatus verificationStatus = Fixture().GetPrevious(0);
            Assert.NotNull(verificationStatus);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.VerificationStatus verificationStatus = Fixture().GetNext(0);
            Assert.NotNull(verificationStatus);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.VerificationStatus verificationStatus = Fixture().GetLast();
            Assert.NotNull(verificationStatus);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.VerificationStatus> verificationStatuses = Fixture().Get(new short[] { });
            Assert.NotNull(verificationStatuses);
        }
