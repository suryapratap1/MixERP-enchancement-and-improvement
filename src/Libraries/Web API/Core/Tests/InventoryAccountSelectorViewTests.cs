...
{
    public class InventoryAccountSelectorViewTests
    {
        public static InventoryAccountSelectorViewController Fixture()
        {
            InventoryAccountSelectorViewController controller = new InventoryAccountSelectorViewController(new InventoryAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
