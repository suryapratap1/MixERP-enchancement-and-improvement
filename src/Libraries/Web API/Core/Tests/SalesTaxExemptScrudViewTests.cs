...
{
    public class SalesTaxExemptScrudViewTests
    {
        public static SalesTaxExemptScrudViewController Fixture()
        {
            SalesTaxExemptScrudViewController controller = new SalesTaxExemptScrudViewController(new SalesTaxExemptScrudViewRepository(), "", new LoginView());
            return controller;
        }
