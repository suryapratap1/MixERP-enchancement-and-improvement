...
{
    public class RecurringInvoiceScrudViewTests
    {
        public static RecurringInvoiceScrudViewController Fixture()
        {
            RecurringInvoiceScrudViewController controller = new RecurringInvoiceScrudViewController(new RecurringInvoiceScrudViewRepository(), "", new LoginView());
            return controller;
        }
