...
{
    public class PurchaseDiscountAccountSelectorViewTests
    {
        public static PurchaseDiscountAccountSelectorViewController Fixture()
        {
            PurchaseDiscountAccountSelectorViewController controller = new PurchaseDiscountAccountSelectorViewController(new PurchaseDiscountAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
