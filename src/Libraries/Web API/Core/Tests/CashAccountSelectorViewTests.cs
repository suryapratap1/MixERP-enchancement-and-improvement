...
{
    public class CashAccountSelectorViewTests
    {
        public static CashAccountSelectorViewController Fixture()
        {
            CashAccountSelectorViewController controller = new CashAccountSelectorViewController(new CashAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
