...
{
    public class RecurringInvoiceAccountSelectorViewTests
    {
        public static RecurringInvoiceAccountSelectorViewController Fixture()
        {
            RecurringInvoiceAccountSelectorViewController controller = new RecurringInvoiceAccountSelectorViewController(new RecurringInvoiceAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
