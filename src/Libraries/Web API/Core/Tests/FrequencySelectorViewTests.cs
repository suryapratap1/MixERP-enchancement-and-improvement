...
{
    public class FrequencySelectorViewTests
    {
        public static FrequencySelectorViewController Fixture()
        {
            FrequencySelectorViewController controller = new FrequencySelectorViewController(new FrequencySelectorViewRepository(), "", new LoginView());
            return controller;
        }
