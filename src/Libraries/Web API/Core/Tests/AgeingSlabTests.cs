...
{
    public class AgeingSlabTests
    {
        public static AgeingSlabController Fixture()
        {
            AgeingSlabController controller = new AgeingSlabController(new AgeingSlabRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.AgeingSlab ageingSlab = Fixture().Get(0);
