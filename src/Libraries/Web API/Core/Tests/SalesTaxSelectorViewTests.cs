...
{
    public class SalesTaxSelectorViewTests
    {
        public static SalesTaxSelectorViewController Fixture()
        {
            SalesTaxSelectorViewController controller = new SalesTaxSelectorViewController(new SalesTaxSelectorViewRepository(), "", new LoginView());
            return controller;
        }
