...
namespace MixERP.Net.Api.Core.Tests
{
    ...
    {
        public static ItemVariantController Fixture()
        {
            ItemVariantController controller = new ItemVariantController(new ItemVariantRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.ItemVariant itemVariant = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.ItemVariant itemVariant = Fixture().GetFirst();
            Assert.NotNull(itemVariant);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.ItemVariant itemVariant = Fixture().GetLast();
            Assert.NotNull(itemVariant);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.ItemVariant> itemVariants = Fixture().Get(new int[] { });
            Assert.NotNull(itemVariants);
        }
