...
{
    public class FiscalYearScrudViewTests
    {
        public static FiscalYearScrudViewController Fixture()
        {
            FiscalYearScrudViewController controller = new FiscalYearScrudViewController(new FiscalYearScrudViewRepository(), "", new LoginView());
            return controller;
        }
