...
{
    public class ShippingAddressScrudViewTests
    {
        public static ShippingAddressScrudViewController Fixture()
        {
            ShippingAddressScrudViewController controller = new ShippingAddressScrudViewController(new ShippingAddressScrudViewRepository(), "", new LoginView());
            return controller;
        }
