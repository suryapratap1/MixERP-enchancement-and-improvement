...
namespace MixERP.Net.Api.Core.Tests
{
    public class AttachmentTests
    {
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.Attachment attachment = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.Attachment attachment = Fixture().GetFirst();
            Assert.NotNull(attachment);
        }
        ...
        {
            MixERP.Net.Entities.Core.Attachment attachment = Fixture().GetPrevious(0);
            Assert.NotNull(attachment);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.Attachment attachment = Fixture().GetNext(0);
            Assert.NotNull(attachment);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.Attachment attachment = Fixture().GetLast();
            Assert.NotNull(attachment);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.Attachment> attachments = Fixture().Get(new long[] { });
