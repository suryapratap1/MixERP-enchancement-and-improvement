...
{
    public class ItemVariantScrudViewTests
    {
        public static ItemVariantScrudViewController Fixture()
        {
            ItemVariantScrudViewController controller = new ItemVariantScrudViewController(new ItemVariantScrudViewRepository(), "", new LoginView());
            return controller;
        }
