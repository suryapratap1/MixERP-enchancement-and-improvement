...
{
    public class SalespersonBonusSetupTests
    {
        public static SalespersonBonusSetupController Fixture()
        {
            SalespersonBonusSetupController controller = new SalespersonBonusSetupController(new SalespersonBonusSetupRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.SalespersonBonusSetup salespersonBonusSetup = Fixture().Get(0);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(salespersonBonusSetups);
        }
