...
{
    public class TaxExemptTypeScrudViewTests
    {
        public static TaxExemptTypeScrudViewController Fixture()
        {
            TaxExemptTypeScrudViewController controller = new TaxExemptTypeScrudViewController(new TaxExemptTypeScrudViewRepository(), "", new LoginView());
            return controller;
        }
