...
{
    public class SalesReturnAccountSelectorViewTests
    {
        public static SalesReturnAccountSelectorViewController Fixture()
        {
            SalesReturnAccountSelectorViewController controller = new SalesReturnAccountSelectorViewController(new SalesReturnAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
