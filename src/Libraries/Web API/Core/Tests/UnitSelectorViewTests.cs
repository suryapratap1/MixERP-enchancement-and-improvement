...
{
    public class UnitSelectorViewTests
    {
        public static UnitSelectorViewController Fixture()
        {
            UnitSelectorViewController controller = new UnitSelectorViewController(new UnitSelectorViewRepository(), "", new LoginView());
            return controller;
        }
