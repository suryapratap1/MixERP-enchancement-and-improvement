...
namespace MixERP.Net.Api.Core.Tests
{
    ...
    {
        public static RecurrenceTypeController Fixture()
        {
            RecurrenceTypeController controller = new RecurrenceTypeController(new RecurrenceTypeRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.RecurrenceType recurrenceType = Fixture().Get(0);
            Assert.NotNull(recurrenceType);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.RecurrenceType recurrenceType = Fixture().GetFirst();
            Assert.NotNull(recurrenceType);
        }
        ...
        {
            MixERP.Net.Entities.Core.RecurrenceType recurrenceType = Fixture().GetPrevious(0);
            Assert.NotNull(recurrenceType);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.RecurrenceType recurrenceType = Fixture().GetNext(0);
            Assert.NotNull(recurrenceType);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.RecurrenceType recurrenceType = Fixture().GetLast();
            Assert.NotNull(recurrenceType);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.RecurrenceType> recurrenceTypes = Fixture().Get(new int[] { });
            Assert.NotNull(recurrenceTypes);
        }
