...
{
    public class MerchantAccountSelectorViewTests
    {
        public static MerchantAccountSelectorViewController Fixture()
        {
            MerchantAccountSelectorViewController controller = new MerchantAccountSelectorViewController(new MerchantAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
