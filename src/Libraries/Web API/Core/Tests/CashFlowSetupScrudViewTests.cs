...
{
    public class CashFlowSetupScrudViewTests
    {
        public static CashFlowSetupScrudViewController Fixture()
        {
            CashFlowSetupScrudViewController controller = new CashFlowSetupScrudViewController(new CashFlowSetupScrudViewRepository(), "", new LoginView());
            return controller;
        }
