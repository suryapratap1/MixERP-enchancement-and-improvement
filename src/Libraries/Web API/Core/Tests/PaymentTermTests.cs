...
namespace MixERP.Net.Api.Core.Tests
{
    ...
    {
        public static PaymentTermController Fixture()
        {
            PaymentTermController controller = new PaymentTermController(new PaymentTermRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.PaymentTerm paymentTerm = Fixture().Get(0);
