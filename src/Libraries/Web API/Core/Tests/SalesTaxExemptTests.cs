...
{
    public class SalesTaxExemptTests
    {
        public static SalesTaxExemptController Fixture()
        {
            SalesTaxExemptController controller = new SalesTaxExemptController(new SalesTaxExemptRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.SalesTaxExempt salesTaxExempt = Fixture().Get(0);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(salesTaxExempts);
        }
