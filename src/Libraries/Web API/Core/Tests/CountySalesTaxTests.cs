...
{
    public class CountySalesTaxTests
    {
        public static CountySalesTaxController Fixture()
        {
            CountySalesTaxController controller = new CountySalesTaxController(new CountySalesTaxRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.CountySalesTax countySalesTax = Fixture().Get(0);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(countySalesTaxes);
        }
