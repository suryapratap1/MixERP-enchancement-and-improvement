...
{
    public class FiscalYearSelectorViewTests
    {
        public static FiscalYearSelectorViewController Fixture()
        {
            FiscalYearSelectorViewController controller = new FiscalYearSelectorViewController(new FiscalYearSelectorViewRepository(), "", new LoginView());
            return controller;
        }
