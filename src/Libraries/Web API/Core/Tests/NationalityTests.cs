...
namespace MixERP.Net.Api.Core.Tests
{
    ...
    {
        public static NationalityController Fixture()
        {
            NationalityController controller = new NationalityController(new NationalityRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.Nationality nationality = Fixture().Get(string.Empty);
