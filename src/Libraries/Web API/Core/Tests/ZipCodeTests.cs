...
namespace MixERP.Net.Api.Core.Tests
{
    ...
    {
        public static ZipCodeController Fixture()
        {
            ZipCodeController controller = new ZipCodeController(new ZipCodeRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.ZipCode zipCode = Fixture().Get(0);
