...
{
    public class AgeingSlabScrudViewTests
    {
        public static AgeingSlabScrudViewController Fixture()
        {
            AgeingSlabScrudViewController controller = new AgeingSlabScrudViewController(new AgeingSlabScrudViewRepository(), "", new LoginView());
            return controller;
        }
