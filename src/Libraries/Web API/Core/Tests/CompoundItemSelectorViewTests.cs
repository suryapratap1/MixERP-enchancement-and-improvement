...
{
    public class CompoundItemSelectorViewTests
    {
        public static CompoundItemSelectorViewController Fixture()
        {
            CompoundItemSelectorViewController controller = new CompoundItemSelectorViewController(new CompoundItemSelectorViewRepository(), "", new LoginView());
            return controller;
        }
