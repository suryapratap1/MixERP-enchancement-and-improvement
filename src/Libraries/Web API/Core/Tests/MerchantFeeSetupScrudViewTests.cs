...
{
    public class MerchantFeeSetupScrudViewTests
    {
        public static MerchantFeeSetupScrudViewController Fixture()
        {
            MerchantFeeSetupScrudViewController controller = new MerchantFeeSetupScrudViewController(new MerchantFeeSetupScrudViewRepository(), "", new LoginView());
            return controller;
        }
