...
{
    public class BrandSelectorViewTests
    {
        public static BrandSelectorViewController Fixture()
        {
            BrandSelectorViewController controller = new BrandSelectorViewController(new BrandSelectorViewRepository(), "", new LoginView());
            return controller;
        }
