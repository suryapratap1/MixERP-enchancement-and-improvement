...
{
    public class AccountSelectorViewTests
    {
        public static AccountSelectorViewController Fixture()
        {
            AccountSelectorViewController controller = new AccountSelectorViewController(new AccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
