...
namespace MixERP.Net.Api.Core.Tests
{
    ...
    {
        public static RecurringInvoiceController Fixture()
        {
            RecurringInvoiceController controller = new RecurringInvoiceController(new RecurringInvoiceRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.RecurringInvoice recurringInvoice = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.RecurringInvoice recurringInvoice = Fixture().GetFirst();
            Assert.NotNull(recurringInvoice);
        }
        ...
        {
            MixERP.Net.Entities.Core.RecurringInvoice recurringInvoice = Fixture().GetPrevious(0);
            Assert.NotNull(recurringInvoice);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.RecurringInvoice recurringInvoice = Fixture().GetNext(0);
            Assert.NotNull(recurringInvoice);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.RecurringInvoice recurringInvoice = Fixture().GetLast();
            Assert.NotNull(recurringInvoice);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.RecurringInvoice> recurringInvoices = Fixture().Get(new int[] { });
            Assert.NotNull(recurringInvoices);
        }
