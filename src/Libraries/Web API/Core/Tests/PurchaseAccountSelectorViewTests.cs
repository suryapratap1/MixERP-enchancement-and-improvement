...
{
    public class PurchaseAccountSelectorViewTests
    {
        public static PurchaseAccountSelectorViewController Fixture()
        {
            PurchaseAccountSelectorViewController controller = new PurchaseAccountSelectorViewController(new PurchaseAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
