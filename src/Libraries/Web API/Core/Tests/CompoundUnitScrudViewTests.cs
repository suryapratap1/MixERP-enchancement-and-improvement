...
{
    public class CompoundUnitScrudViewTests
    {
        public static CompoundUnitScrudViewController Fixture()
        {
            CompoundUnitScrudViewController controller = new CompoundUnitScrudViewController(new CompoundUnitScrudViewRepository(), "", new LoginView());
            return controller;
        }
