...
{
    public class PriceTypeSelectorViewTests
    {
        public static PriceTypeSelectorViewController Fixture()
        {
            PriceTypeSelectorViewController controller = new PriceTypeSelectorViewController(new PriceTypeSelectorViewRepository(), "", new LoginView());
            return controller;
        }
