...
{
    public class StateScrudViewTests
    {
        public static StateScrudViewController Fixture()
        {
            StateScrudViewController controller = new StateScrudViewController(new StateScrudViewRepository(), "", new LoginView());
            return controller;
        }
