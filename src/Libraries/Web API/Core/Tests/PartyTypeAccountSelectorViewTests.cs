...
{
    public class PartyTypeAccountSelectorViewTests
    {
        public static PartyTypeAccountSelectorViewController Fixture()
        {
            PartyTypeAccountSelectorViewController controller = new PartyTypeAccountSelectorViewController(new PartyTypeAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
