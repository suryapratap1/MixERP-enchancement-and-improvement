...
{
    public class SalesTaxDetailScrudViewTests
    {
        public static SalesTaxDetailScrudViewController Fixture()
        {
            SalesTaxDetailScrudViewController controller = new SalesTaxDetailScrudViewController(new SalesTaxDetailScrudViewRepository(), "", new LoginView());
            return controller;
        }
