...
{
    public class SalesTeamSelectorViewTests
    {
        public static SalesTeamSelectorViewController Fixture()
        {
            SalesTeamSelectorViewController controller = new SalesTeamSelectorViewController(new SalesTeamSelectorViewRepository(), "", new LoginView());
            return controller;
        }
