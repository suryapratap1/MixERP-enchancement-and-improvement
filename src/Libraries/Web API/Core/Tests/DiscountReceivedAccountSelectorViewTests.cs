...
{
    public class DiscountReceivedAccountSelectorViewTests
    {
        public static DiscountReceivedAccountSelectorViewController Fixture()
        {
            DiscountReceivedAccountSelectorViewController controller = new DiscountReceivedAccountSelectorViewController(new DiscountReceivedAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
