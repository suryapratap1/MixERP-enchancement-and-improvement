...
{
    public class CostOfSalesAccountSelectorViewTests
    {
        public static CostOfSalesAccountSelectorViewController Fixture()
        {
            CostOfSalesAccountSelectorViewController controller = new CostOfSalesAccountSelectorViewController(new CostOfSalesAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
