...
{
    public class BonusSlabScrudViewTests
    {
        public static BonusSlabScrudViewController Fixture()
        {
            BonusSlabScrudViewController controller = new BonusSlabScrudViewController(new BonusSlabScrudViewRepository(), "", new LoginView());
            return controller;
        }
