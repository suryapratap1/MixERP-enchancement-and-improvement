...
{
    public class ExpensesAccountSelectorViewTests
    {
        public static ExpensesAccountSelectorViewController Fixture()
        {
            ExpensesAccountSelectorViewController controller = new ExpensesAccountSelectorViewController(new ExpensesAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
