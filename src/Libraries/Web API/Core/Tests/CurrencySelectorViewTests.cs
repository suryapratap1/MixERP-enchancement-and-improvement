...
{
    public class CurrencySelectorViewTests
    {
        public static CurrencySelectorViewController Fixture()
        {
            CurrencySelectorViewController controller = new CurrencySelectorViewController(new CurrencySelectorViewRepository(), "", new LoginView());
            return controller;
        }
