...
{
    public class RoundingMethodSelectorViewTests
    {
        public static RoundingMethodSelectorViewController Fixture()
        {
            RoundingMethodSelectorViewController controller = new RoundingMethodSelectorViewController(new RoundingMethodSelectorViewRepository(), "", new LoginView());
            return controller;
        }
