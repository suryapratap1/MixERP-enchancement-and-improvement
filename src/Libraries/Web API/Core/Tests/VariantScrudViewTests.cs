...
{
    public class VariantScrudViewTests
    {
        public static VariantScrudViewController Fixture()
        {
            VariantScrudViewController controller = new VariantScrudViewController(new VariantScrudViewRepository(), "", new LoginView());
            return controller;
        }
