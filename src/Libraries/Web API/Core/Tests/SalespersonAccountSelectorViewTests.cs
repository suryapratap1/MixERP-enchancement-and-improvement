...
{
    public class SalespersonAccountSelectorViewTests
    {
        public static SalespersonAccountSelectorViewController Fixture()
        {
            SalespersonAccountSelectorViewController controller = new SalespersonAccountSelectorViewController(new SalespersonAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
