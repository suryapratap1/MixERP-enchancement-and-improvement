...
namespace MixERP.Net.Api.Core.Tests
{
    public class TransactionTypeTests
    {
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.TransactionType transactionType = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.TransactionType transactionType = Fixture().GetFirst();
            Assert.NotNull(transactionType);
        }
        ...
        {
            MixERP.Net.Entities.Core.TransactionType transactionType = Fixture().GetPrevious(0);
            Assert.NotNull(transactionType);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.TransactionType transactionType = Fixture().GetNext(0);
            Assert.NotNull(transactionType);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.TransactionType transactionType = Fixture().GetLast();
            Assert.NotNull(transactionType);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.TransactionType> transactionTypes = Fixture().Get(new short[] { });
