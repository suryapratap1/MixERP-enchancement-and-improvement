...
{
    public class AttachmentViewTests
    {
        public static AttachmentViewController Fixture()
        {
            AttachmentViewController controller = new AttachmentViewController(new AttachmentViewRepository(), "", new LoginView());
            return controller;
        }
