...
{
    public class MenuLocaleTests
    {
        public static MenuLocaleController Fixture()
        {
            MenuLocaleController controller = new MenuLocaleController(new MenuLocaleRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.MenuLocale menuLocale = Fixture().Get(0);
