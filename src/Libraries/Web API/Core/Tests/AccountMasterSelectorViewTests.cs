...
{
    public class AccountMasterSelectorViewTests
    {
        public static AccountMasterSelectorViewController Fixture()
        {
            AccountMasterSelectorViewController controller = new AccountMasterSelectorViewController(new AccountMasterSelectorViewRepository(), "", new LoginView());
            return controller;
        }
