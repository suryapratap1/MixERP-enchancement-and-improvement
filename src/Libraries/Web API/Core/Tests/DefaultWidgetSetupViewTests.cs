...
{
    public class DefaultWidgetSetupViewTests
    {
        public static DefaultWidgetSetupViewController Fixture()
        {
            DefaultWidgetSetupViewController controller = new DefaultWidgetSetupViewController(new DefaultWidgetSetupViewRepository(), "", new LoginView());
            return controller;
        }
