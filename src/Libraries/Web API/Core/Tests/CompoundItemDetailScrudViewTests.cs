...
{
    public class CompoundItemDetailScrudViewTests
    {
        public static CompoundItemDetailScrudViewController Fixture()
        {
            CompoundItemDetailScrudViewController controller = new CompoundItemDetailScrudViewController(new CompoundItemDetailScrudViewRepository(), "", new LoginView());
            return controller;
        }
