...
namespace MixERP.Net.Api.Core.Tests
{
    public class FlagTests
    {
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.Flag flag = Fixture().Get(0);
            Assert.NotNull(flag);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.Flag flag = Fixture().GetFirst();
            Assert.NotNull(flag);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.Flag flag = Fixture().GetLast();
            Assert.NotNull(flag);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.Flag> flags = Fixture().Get(new long[] { });
