...
{
    public class ItemGroupSelectorViewTests
    {
        public static ItemGroupSelectorViewController Fixture()
        {
            ItemGroupSelectorViewController controller = new ItemGroupSelectorViewController(new ItemGroupSelectorViewRepository(), "", new LoginView());
            return controller;
        }
