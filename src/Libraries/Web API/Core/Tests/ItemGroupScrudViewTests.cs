...
{
    public class ItemGroupScrudViewTests
    {
        public static ItemGroupScrudViewController Fixture()
        {
            ItemGroupScrudViewController controller = new ItemGroupScrudViewController(new ItemGroupScrudViewRepository(), "", new LoginView());
            return controller;
        }
