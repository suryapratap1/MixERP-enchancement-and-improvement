...
{
    public class SalesTaxExemptDetailTests
    {
        public static SalesTaxExemptDetailController Fixture()
        {
            SalesTaxExemptDetailController controller = new SalesTaxExemptDetailController(new SalesTaxExemptDetailRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.SalesTaxExemptDetail salesTaxExemptDetail = Fixture().Get(0);
            Assert.NotNull(salesTaxExemptDetail);
        }
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.SalesTaxExemptDetail salesTaxExemptDetail = Fixture().GetFirst();
            Assert.NotNull(salesTaxExemptDetail);
        }
        ...
        {
            MixERP.Net.Entities.Core.SalesTaxExemptDetail salesTaxExemptDetail = Fixture().GetPrevious(0);
            Assert.NotNull(salesTaxExemptDetail);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.SalesTaxExemptDetail salesTaxExemptDetail = Fixture().GetNext(0);
            Assert.NotNull(salesTaxExemptDetail);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.SalesTaxExemptDetail salesTaxExemptDetail = Fixture().GetLast();
            Assert.NotNull(salesTaxExemptDetail);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.SalesTaxExemptDetail> salesTaxExemptDetails = Fixture().Get(new int[] { });
            Assert.NotNull(salesTaxExemptDetails);
        }
