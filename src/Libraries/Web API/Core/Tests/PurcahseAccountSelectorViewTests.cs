...
{
    public class PurcahseAccountSelectorViewTests
    {
        public static PurcahseAccountSelectorViewController Fixture()
        {
            PurcahseAccountSelectorViewController controller = new PurcahseAccountSelectorViewController(new PurcahseAccountSelectorViewRepository(), "", new LoginView());
            return controller;
        }
