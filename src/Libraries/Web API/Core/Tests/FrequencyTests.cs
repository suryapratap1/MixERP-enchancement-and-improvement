...
namespace MixERP.Net.Api.Core.Tests
{
    ...
    {
        public static FrequencyController Fixture()
        {
            FrequencyController controller = new FrequencyController(new FrequencyRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.Frequency frequency = Fixture().Get(0);
