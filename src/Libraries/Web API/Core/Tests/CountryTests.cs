...
namespace MixERP.Net.Api.Core.Tests
{
    public class CountryTests
    {
        ...
        public void Get()
        {
            MixERP.Net.Entities.Core.Country country = Fixture().Get(0);
        ...
        public void First()
        {
            MixERP.Net.Entities.Core.Country country = Fixture().GetFirst();
            Assert.NotNull(country);
        }
        ...
        {
            MixERP.Net.Entities.Core.Country country = Fixture().GetPrevious(0);
            Assert.NotNull(country);
        }
        ...
        public void Next()
        {
            MixERP.Net.Entities.Core.Country country = Fixture().GetNext(0);
            Assert.NotNull(country);
        }
        ...
        public void Last()
        {
            MixERP.Net.Entities.Core.Country country = Fixture().GetLast();
            Assert.NotNull(country);
        }
        ...
        {
            IEnumerable<MixERP.Net.Entities.Core.Country> countries = Fixture().Get(new int[] { });
