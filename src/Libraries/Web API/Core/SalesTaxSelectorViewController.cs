...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The SalesTaxSelectorView repository.
        /// </summary>
        private readonly ISalesTaxSelectorViewRepository SalesTaxSelectorViewRepository;
        ...
        public SalesTaxSelectorViewController()
        {
            ...
            this.SalesTaxSelectorViewRepository = new MixERP.Net.Schemas.Core.Data.SalesTaxSelectorView
            {
        ...
        public SalesTaxSelectorViewController(ISalesTaxSelectorViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.SalesTaxSelectorViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.SalesTaxSelectorViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of sales tax selector view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/core/sales-tax-selector-view/export")]
        [Route("~/api/core/sales-tax-selector-view/all")]
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxSelectorView> Get()
        {
            try
            {
                return this.SalesTaxSelectorViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 sales tax selector views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxSelectorView> GetPaginatedResult()
        {
            try
            {
                return this.SalesTaxSelectorViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxSelectorView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.SalesTaxSelectorViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.SalesTaxSelectorViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.SalesTaxSelectorViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 sales tax selector views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxSelectorView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.SalesTaxSelectorViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.SalesTaxSelectorViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxSelectorView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.SalesTaxSelectorViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
