...
namespace MixERP.Net.Api.Audit.Tests
{
    ...
    {
        public static FailedLoginController Fixture()
        {
            FailedLoginController controller = new FailedLoginController(new FailedLoginRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Audit.FailedLogin failedLogin = Fixture().Get(0);
