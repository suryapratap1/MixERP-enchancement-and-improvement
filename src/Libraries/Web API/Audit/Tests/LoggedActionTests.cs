...
{
    public class LoggedActionTests
    {
        public static LoggedActionController Fixture()
        {
            LoggedActionController controller = new LoggedActionController(new LoggedActionRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Audit.LoggedAction loggedAction = Fixture().Get(0);
