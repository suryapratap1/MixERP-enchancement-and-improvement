...
namespace MixERP.Net.Api.Audit
{
    ...
    /// </summary>
    [RoutePrefix("api/v1.5/audit/procedures/get-user-id-by-login-id")]
    public class GetUserIdByLoginIdController : ApiController
    {
        /// <summary>
        ...
        [Route("annotation")]
        [Route("~/api/audit/procedures/get-user-id-by-login-id/annotation")]
        ...
        [AcceptVerbs("POST")]
        [Route("execute")]
        [Route("~/api/audit/procedures/get-user-id-by-login-id/execute")]
