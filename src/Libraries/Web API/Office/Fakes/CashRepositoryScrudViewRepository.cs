...
{
    public class CashRepositoryScrudViewRepository : ICashRepositoryScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.Office.CashRepositoryScrudView(), 1);
        }
