...
namespace MixERP.Net.Api.Office
{
    ...
    /// </summary>
    [RoutePrefix("api/v1.5/office/sign-in-view")]
    public class SignInViewController : ApiController
    {
        ...
        public SignInViewController()
        {
            ...
            this.SignInViewRepository = new MixERP.Net.Schemas.Office.Data.SignInView
            {
        ...
        [Route("count")]
        [Route("~/api/office/sign-in-view/count")]
        public long Count()
        {
            try
            {
        ...
        [Route("export")]
        [Route("all")]
        [Route("~/api/office/sign-in-view/export")]
        [Route("~/api/office/sign-in-view/all")]
        ...
        [Route("~/api/office/sign-in-view/page/{pageNumber}")]
        ...
        [Route("~/api/office/sign-in-view/display-fields")]
        ...
        [AcceptVerbs("POST")]
        [Route("count-where")]
        [Route("~/api/office/sign-in-view/count-where")]
        ...
        [Route("~/api/office/sign-in-view/get-where/{pageNumber}")]
        public IEnumerable<MixERP.Net.Entities.Office.SignInView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
        ...
        [Route("~/api/office/sign-in-view/count-filtered/{filterName}")]
        ...
        [Route("~/api/office/sign-in-view/get-filtered/{pageNumber}/{filterName}")]
