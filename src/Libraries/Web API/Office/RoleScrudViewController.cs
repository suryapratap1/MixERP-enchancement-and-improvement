...
namespace MixERP.Net.Api.Office
{
    ...
    {
        /// <summary>
        ///     The RoleScrudView repository.
        /// </summary>
        private readonly IRoleScrudViewRepository RoleScrudViewRepository;
        ...
        public RoleScrudViewController()
        {
            ...
            this.RoleScrudViewRepository = new MixERP.Net.Schemas.Office.Data.RoleScrudView
            {
        ...
        public RoleScrudViewController(IRoleScrudViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.RoleScrudViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.RoleScrudViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of role scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/office/role-scrud-view/export")]
        [Route("~/api/office/role-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.Office.RoleScrudView> Get()
        {
            try
            {
                return this.RoleScrudViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.RoleScrudView> GetPaginatedResult()
        {
            try
            {
                return this.RoleScrudViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.RoleScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.RoleScrudViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.RoleScrudViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.RoleScrudViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.RoleScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            ...
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.RoleScrudViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.RoleScrudViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.RoleScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.RoleScrudViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
