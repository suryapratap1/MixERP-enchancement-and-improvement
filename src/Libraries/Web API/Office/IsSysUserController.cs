...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function IsSysUser.
    /// </summary>
    [RoutePrefix("api/v1.5/office/procedures/is-sys-user")]
    public class IsSysUserController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "is sys user" annotation meta information to perform CRUD operation.</returns>
