...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetSysUserId.
    /// </summary>
    [RoutePrefix("api/v1.5/office/procedures/get-sys-user-id")]
    public class GetSysUserIdController : ApiController
    {
        /// <summary>
        ...
        [AcceptVerbs("POST")]
        [Route("execute")]
        [Route("~/api/office/procedures/get-sys-user-id/execute")]
