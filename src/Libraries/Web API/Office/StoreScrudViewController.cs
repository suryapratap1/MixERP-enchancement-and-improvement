...
namespace MixERP.Net.Api.Office
{
    ...
    {
        /// <summary>
        ///     The StoreScrudView repository.
        /// </summary>
        private readonly IStoreScrudViewRepository StoreScrudViewRepository;
        ...
        public StoreScrudViewController()
        {
            ...
            this.StoreScrudViewRepository = new MixERP.Net.Schemas.Office.Data.StoreScrudView
            {
        ...
        public StoreScrudViewController(IStoreScrudViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.StoreScrudViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.StoreScrudViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of store scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/office/store-scrud-view/export")]
        [Route("~/api/office/store-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.Office.StoreScrudView> Get()
        {
            try
            {
                return this.StoreScrudViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 store scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.StoreScrudView> GetPaginatedResult()
        {
            try
            {
                return this.StoreScrudViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.StoreScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.StoreScrudViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.StoreScrudViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.StoreScrudViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 store scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.StoreScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.StoreScrudViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.StoreScrudViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.StoreScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.StoreScrudViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
