...
namespace MixERP.Net.Api.Office
{
    ...
    public class HasChildOfficesController : ApiController
    {
        ...
        /// <summary>
        ///     The HasChildOffices repository.
        /// </summary>
        private readonly IHasChildOfficesRepository repository;
        ...
        public HasChildOfficesController()
        {
            ...
            this.repository = new HasChildOfficesProcedure
            {
        ...
        public HasChildOfficesController(IHasChildOfficesRepository repository, string catalog, LoginView view)
        {
