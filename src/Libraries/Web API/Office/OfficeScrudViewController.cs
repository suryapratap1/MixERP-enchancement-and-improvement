...
namespace MixERP.Net.Api.Office
{
    ...
    public class OfficeScrudViewController : ApiController
    {
        ...
        /// <summary>
        ///     Returns collection of office scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/office/office-scrud-view/export")]
        [Route("~/api/office/office-scrud-view/all")]
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 office scrud views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 office scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.OfficeScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
