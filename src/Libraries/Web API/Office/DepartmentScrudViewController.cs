...
namespace MixERP.Net.Api.Office
{
    ...
    {
        /// <summary>
        ///     The DepartmentScrudView repository.
        /// </summary>
        private readonly IDepartmentScrudViewRepository DepartmentScrudViewRepository;
        ...
        public DepartmentScrudViewController()
        {
            ...
            this.DepartmentScrudViewRepository = new MixERP.Net.Schemas.Office.Data.DepartmentScrudView
            {
        ...
        public DepartmentScrudViewController(IDepartmentScrudViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.DepartmentScrudViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.DepartmentScrudViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of department scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/office/department-scrud-view/export")]
        [Route("~/api/office/department-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.Office.DepartmentScrudView> Get()
        {
            try
            {
                return this.DepartmentScrudViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 department scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.DepartmentScrudView> GetPaginatedResult()
        {
            try
            {
                return this.DepartmentScrudViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.DepartmentScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.DepartmentScrudViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.DepartmentScrudViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.DepartmentScrudViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 department scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.DepartmentScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.DepartmentScrudViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.DepartmentScrudViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.DepartmentScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.DepartmentScrudViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
