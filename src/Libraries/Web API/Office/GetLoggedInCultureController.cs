...
{
    /// <summary>
    /// Provides a direct HTTP access to execute the function GetLoggedInCulture.
    /// </summary>
    [RoutePrefix("api/v1.5/office/procedures/get-logged-in-culture")]
    public class GetLoggedInCultureController : ApiController
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>Returns the "get logged in culture" annotation meta information to perform CRUD operation.</returns>
