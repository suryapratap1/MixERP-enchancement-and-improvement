...
{
    public class StoreSelectorViewTests
    {
        public static StoreSelectorViewController Fixture()
        {
            StoreSelectorViewController controller = new StoreSelectorViewController(new StoreSelectorViewRepository(), "", new LoginView());
            return controller;
        }
