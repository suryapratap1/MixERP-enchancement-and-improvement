...
{
    public class OfficeScrudViewTests
    {
        public static OfficeScrudViewController Fixture()
        {
            OfficeScrudViewController controller = new OfficeScrudViewController(new OfficeScrudViewRepository(), "", new LoginView());
            return controller;
        }
