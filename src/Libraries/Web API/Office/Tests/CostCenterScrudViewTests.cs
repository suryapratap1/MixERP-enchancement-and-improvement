...
{
    public class CostCenterScrudViewTests
    {
        public static CostCenterScrudViewController Fixture()
        {
            CostCenterScrudViewController controller = new CostCenterScrudViewController(new CostCenterScrudViewRepository(), "", new LoginView());
            return controller;
        }
