...
{
    public class StoreTypeScrudViewTests
    {
        public static StoreTypeScrudViewController Fixture()
        {
            StoreTypeScrudViewController controller = new StoreTypeScrudViewController(new StoreTypeScrudViewRepository(), "", new LoginView());
            return controller;
        }
