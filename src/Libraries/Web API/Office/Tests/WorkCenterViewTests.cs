...
{
    public class WorkCenterViewTests
    {
        public static WorkCenterViewController Fixture()
        {
            WorkCenterViewController controller = new WorkCenterViewController(new WorkCenterViewRepository(), "", new LoginView());
            return controller;
        }
