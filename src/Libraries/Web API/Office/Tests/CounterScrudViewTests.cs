...
{
    public class CounterScrudViewTests
    {
        public static CounterScrudViewController Fixture()
        {
            CounterScrudViewController controller = new CounterScrudViewController(new CounterScrudViewRepository(), "", new LoginView());
            return controller;
        }
