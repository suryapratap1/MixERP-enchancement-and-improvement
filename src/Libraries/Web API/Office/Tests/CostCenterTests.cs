...
namespace MixERP.Net.Api.Office.Tests
{
    ...
    {
        public static CostCenterController Fixture()
        {
            CostCenterController controller = new CostCenterController(new CostCenterRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Office.CostCenter costCenter = Fixture().Get(0);
