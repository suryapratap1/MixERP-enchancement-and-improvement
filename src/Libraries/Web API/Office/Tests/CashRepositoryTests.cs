...
namespace MixERP.Net.Api.Office.Tests
{
    ...
    {
        public static CashRepositoryController Fixture()
        {
            CashRepositoryController controller = new CashRepositoryController(new CashRepositoryRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.Office.CashRepository cashRepository = Fixture().Get(0);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(cashRepositories);
        }
