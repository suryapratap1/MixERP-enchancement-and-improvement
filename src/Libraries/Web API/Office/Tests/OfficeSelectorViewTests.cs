...
{
    public class OfficeSelectorViewTests
    {
        public static OfficeSelectorViewController Fixture()
        {
            OfficeSelectorViewController controller = new OfficeSelectorViewController(new OfficeSelectorViewRepository(), "", new LoginView());
            return controller;
        }
