...
{
    public class CashRepositoryScrudViewTests
    {
        public static CashRepositoryScrudViewController Fixture()
        {
            CashRepositoryScrudViewController controller = new CashRepositoryScrudViewController(new CashRepositoryScrudViewRepository(), "", new LoginView());
            return controller;
        }
