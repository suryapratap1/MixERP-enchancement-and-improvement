...
{
    public class OfficeViewTests
    {
        public static OfficeViewController Fixture()
        {
            OfficeViewController controller = new OfficeViewController(new OfficeViewRepository(), "", new LoginView());
            return controller;
        }
