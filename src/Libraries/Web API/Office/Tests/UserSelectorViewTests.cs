...
{
    public class UserSelectorViewTests
    {
        public static UserSelectorViewController Fixture()
        {
            UserSelectorViewController controller = new UserSelectorViewController(new UserSelectorViewRepository(), "", new LoginView());
            return controller;
        }
