...
{
    public class CashRepositorySelectorViewTests
    {
        public static CashRepositorySelectorViewController Fixture()
        {
            CashRepositorySelectorViewController controller = new CashRepositorySelectorViewController(new CashRepositorySelectorViewRepository(), "", new LoginView());
            return controller;
        }
