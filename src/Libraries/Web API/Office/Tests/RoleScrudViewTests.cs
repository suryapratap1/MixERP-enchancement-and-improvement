...
{
    public class RoleScrudViewTests
    {
        public static RoleScrudViewController Fixture()
        {
            RoleScrudViewController controller = new RoleScrudViewController(new RoleScrudViewRepository(), "", new LoginView());
            return controller;
        }
