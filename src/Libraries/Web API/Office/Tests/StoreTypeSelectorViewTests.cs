...
{
    public class StoreTypeSelectorViewTests
    {
        public static StoreTypeSelectorViewController Fixture()
        {
            StoreTypeSelectorViewController controller = new StoreTypeSelectorViewController(new StoreTypeSelectorViewRepository(), "", new LoginView());
            return controller;
        }
