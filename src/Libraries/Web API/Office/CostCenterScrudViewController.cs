...
namespace MixERP.Net.Api.Office
{
    ...
    {
        /// <summary>
        ///     The CostCenterScrudView repository.
        /// </summary>
        private readonly ICostCenterScrudViewRepository CostCenterScrudViewRepository;
        ...
        public CostCenterScrudViewController()
        {
            ...
            this.CostCenterScrudViewRepository = new MixERP.Net.Schemas.Office.Data.CostCenterScrudView
            {
        ...
        public CostCenterScrudViewController(ICostCenterScrudViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.CostCenterScrudViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.CostCenterScrudViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of cost center scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/office/cost-center-scrud-view/export")]
        [Route("~/api/office/cost-center-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.Office.CostCenterScrudView> Get()
        {
            try
            {
                return this.CostCenterScrudViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 cost center scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.CostCenterScrudView> GetPaginatedResult()
        {
            try
            {
                return this.CostCenterScrudViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.CostCenterScrudView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.CostCenterScrudViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.CostCenterScrudViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.CostCenterScrudViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 cost center scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.CostCenterScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.CostCenterScrudViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.CostCenterScrudViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.CostCenterScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.CostCenterScrudViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
