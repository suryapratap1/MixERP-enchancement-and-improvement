...
namespace MixERP.Net.Api.Office
{
    ...
    {
        /// <summary>
        ///     The WorkCenterView repository.
        /// </summary>
        private readonly IWorkCenterViewRepository WorkCenterViewRepository;
        ...
        public WorkCenterViewController()
        {
            ...
            this.WorkCenterViewRepository = new MixERP.Net.Schemas.Office.Data.WorkCenterView
            {
        ...
        public WorkCenterViewController(IWorkCenterViewRepository repository, string catalog, LoginView view)
        {
            ...
            this.WorkCenterViewRepository = repository;
        }
        ...
        public long Count()
        {
            try
            {
                return this.WorkCenterViewRepository.Count();
            }
        ...
        /// <summary>
        ///     Returns collection of work center view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/office/work-center-view/export")]
        [Route("~/api/office/work-center-view/all")]
        public IEnumerable<MixERP.Net.Entities.Office.WorkCenterView> Get()
        {
            try
            {
                return this.WorkCenterViewRepository.Get();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 work center views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.WorkCenterView> GetPaginatedResult()
        {
            try
            {
                return this.WorkCenterViewRepository.GetPaginatedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.WorkCenterView> GetPaginatedResult(long pageNumber)
        {
            try
            {
                return this.WorkCenterViewRepository.GetPaginatedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.WorkCenterViewRepository.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]JArray filters)
        {
            try
            {
                ...
                return this.WorkCenterViewRepository.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 work center views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.WorkCenterView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
                return this.WorkCenterViewRepository.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.WorkCenterViewRepository.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Office.WorkCenterView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.WorkCenterViewRepository.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
