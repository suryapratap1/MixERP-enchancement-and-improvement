...
SELECT localization.add_localized_resource('Labels', '', 'CreateItemOrServiceDescription', 'Inventory items may refer to the stockable products or nonstockable services that you buy and/or sell.');
...
SELECT localization.add_localized_resource('Labels', '', 'HoursAbbreviated', 'hrs');
...
SELECT localization.add_localized_resource('Labels', '', 'ItemDuplicated', 'Item was duplicated.');
...
SELECT localization.add_localized_resource('Labels', '', 'MinutesAbbreviate', 'mins');
...
SELECT localization.add_localized_resource('Labels', '', 'NCountySalesTaxesDefined', '{0} county sales taxes defined.');
SELECT localization.add_localized_resource('Labels', '', 'NHours', '{0} hours');
SELECT localization.add_localized_resource('Labels', '', 'NItemGroupsFound', '{0} item group(s) found.');
SELECT localization.add_localized_resource('Labels', '', 'NItemsFound', '{0} item(s) found.');
SELECT localization.add_localized_resource('Labels', '', 'NOutOfNFrequenciesDefined', '{0} out of 12 frequencies defined.');
...
SELECT localization.add_localized_resource('Labels', '', 'NSalespersonsFound', '{0} salespersons found.');
...
SELECT localization.add_localized_resource('Labels', '', 'NoWidgetFound', 'No widget found.');
...
SELECT localization.add_localized_resource('Labels', '', 'SalesQuotationEmailSubject', 'Quotation #{0} from {1}');
...
SELECT localization.add_localized_resource('Labels', '', 'TransactionStartDateDescription', 'Enter the exact date from when you want to record transactions in MixERP.');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'applied_on', 'Applied On');
SELECT localization.add_localized_resource('ScrudResource', '', 'applied_on_shipping_charge', 'Applied on Shipping Charge');
SELECT localization.add_localized_resource('ScrudResource', '', 'as_of', 'As Of');
SELECT localization.add_localized_resource('ScrudResource', '', 'attribute_code', 'Attribute Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'attribute_id', 'Attribute Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'attribute_name', 'Attribute Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'auto_deduction_based_on_attendance', 'Auto Deduction Based On Attendance');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'bank_branch_name', 'Bank Branch Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'bank_reference_number', 'Bank Reference Number');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'began_on', 'Began On');
SELECT localization.add_localized_resource('ScrudResource', '', 'begins_from', 'Begins From');
SELECT localization.add_localized_resource('ScrudResource', '', 'blog', 'Blog');
SELECT localization.add_localized_resource('ScrudResource', '', 'bom_code', 'BOM Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'bom_id	', 'BOM Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'bom_name', 'BOM Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'bom_type', 'BOM Type');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'can_expire', 'Can Expire');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'capacity_per_cycle', 'Capacity Per Cycle');
SELECT localization.add_localized_resource('ScrudResource', '', 'capacity_unit_id', 'Capacity Unit Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'change_status_code_to', 'Change Status Code To');
SELECT localization.add_localized_resource('ScrudResource', '', 'change_status_to', 'Change Status To');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'column_name', 'Column Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'comment', 'Comment');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'completed_on', 'Completed On');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'contract_id', 'Contract Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'cool_down_time_in_minutes', 'Cool Down Time In Minutes');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'current_department', 'Current Department');
SELECT localization.add_localized_resource('ScrudResource', '', 'current_department_id', 'Current Department Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'current_employment_status_code_id', 'Current Employment Status Code Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'current_employment_status_id', 'Current Employment Status Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'current_job_title_id', 'Current Job Title Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'current_pay_grade_id', 'Current Pay Grade Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'deduction_setup_id', 'Deduction Setup Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'deduction_setup_name', 'Deduction Setup Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'default_employment_status_code_id', 'Default Employment Status Code Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'default_entity_access_id', 'Default Entity Access Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'department', 'Department');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'employee', 'Employee');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_code', 'Employee Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_contribution_rate', 'Employee Contribution Rate');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_experience_id', 'Employee Experience Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_id', 'Employee Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_identification_detail_id', 'Employee Identification Detail Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_name', 'Employee Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_qualification_id', 'Employee Qualification Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_social_network_detail_id', 'Employee Social Network Detail Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_tax_rate', 'Employee Tax Rate');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_type', 'Employee Type');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_type_code', 'Employee Type Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_type_id', 'Employee Type Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_type_name', 'Employee Type Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'employee_wage_id', 'Employee Wage Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'employer_contribution_rate', 'Employer Contribution Rate');
SELECT localization.add_localized_resource('ScrudResource', '', 'employer_tax_rate', 'Employer Tax Rate');
SELECT localization.add_localized_resource('ScrudResource', '', 'employment_status', 'Employment Status');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'employment_tax', 'Employment Tax');
SELECT localization.add_localized_resource('ScrudResource', '', 'employment_tax_code', 'Employment Tax Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'employment_tax_detail_code', 'Employment Tax Detail Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'employment_tax_detail_id', 'Employment Tax Detail Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'employment_tax_detail_name', 'Employment Tax Detail Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'employment_tax_id', 'Employment Tax Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'employment_tax_name', 'Employment Tax Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'ended_on', 'Ended On');
SELECT localization.add_localized_resource('ScrudResource', '', 'ends_on', 'Ends On');
SELECT localization.add_localized_resource('ScrudResource', '', 'entered_by', 'Entered By');
SELECT localization.add_localized_resource('ScrudResource', '', 'entity_access_id', 'Entity Access Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'exit_id', 'Exit Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'exit_interview_details', 'Exit Interview Details');
SELECT localization.add_localized_resource('ScrudResource', '', 'exit_type', 'Exit Type');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'expense_account', 'Expense Account');
SELECT localization.add_localized_resource('ScrudResource', '', 'expense_account_id', 'Expense Account Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'filter_and_value', 'Filter And Value');
SELECT localization.add_localized_resource('ScrudResource', '', 'filter_condition', 'Filter Condition');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'fund_holding_account_id', 'Fund Holding Account Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'gender_code', 'Gender Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'gender_name', 'Gender Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'hard_of_hearing', 'Hard Of Hearing');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'holiday_id', 'Holiday Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'holiday_name', 'Holiday Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'holiding_account', 'Holiding Account');
SELECT localization.add_localized_resource('ScrudResource', '', 'hot_item', 'Hot item');
SELECT localization.add_localized_resource('ScrudResource', '', 'hourly_cost', 'Hourly Cost');
SELECT localization.add_localized_resource('ScrudResource', '', 'hourly_rate', 'Hourly Rate');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'installation_date', 'Installation Date');
SELECT localization.add_localized_resource('ScrudResource', '', 'institution', 'Institution');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'is_alcoholic', 'Is Alcoholic');
SELECT localization.add_localized_resource('ScrudResource', '', 'is_aphonic', 'Is Aphonic');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'is_machine', 'Is Machine');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'is_smoker', 'Is Smoker');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'item_variant_code', 'Item Variant Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'item_variant_detail_id', 'Item Variant Detail Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'item_variant_id', 'Item Variant Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'item_variant_name', 'Item Variant Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'job_title', 'Job Title');
SELECT localization.add_localized_resource('ScrudResource', '', 'job_title_code', 'Job Title Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'job_title_id', 'Job Title Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'job_title_name', 'Job Title Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'joined_on', 'Joined On');
SELECT localization.add_localized_resource('ScrudResource', '', 'kanban_code', 'Kanban Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'kanban_id', 'Kanban Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'kanban_name', 'Kanban Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'leave_application_id', 'Leave Application Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'leave_benefit', 'Leave Benefit');
SELECT localization.add_localized_resource('ScrudResource', '', 'leave_benefit_code', 'Leave Benefit Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'leave_benefit_id', 'Leave Benefit Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'leave_benefit_name', 'Leave Benefit Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'leave_type', 'Leave Type');
SELECT localization.add_localized_resource('ScrudResource', '', 'leave_type_code', 'Leave Type Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'leave_type_id', 'Leave Type Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'leave_type_name', 'Leave Type Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'length_in_centimeters', 'Length In Centimeters');
SELECT localization.add_localized_resource('ScrudResource', '', 'lifetime_capacity', 'Lifetime Capacity');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'low_vision', 'Low Vision');
SELECT localization.add_localized_resource('ScrudResource', '', 'machinable', 'Machinable');
SELECT localization.add_localized_resource('ScrudResource', '', 'machine_cost', 'Machine Cost');
SELECT localization.add_localized_resource('ScrudResource', '', 'machine_name', 'Machine Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'maximum_daily_work_hours', 'Maximum Daily Work Hours');
SELECT localization.add_localized_resource('ScrudResource', '', 'maximum_salary', 'Maximum Salary');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'minimum_salary', 'Minimum Salary');
SELECT localization.add_localized_resource('ScrudResource', '', 'model_number', 'Model Number');
SELECT localization.add_localized_resource('ScrudResource', '', 'nationality', 'Nationality');
SELECT localization.add_localized_resource('ScrudResource', '', 'nationality_code', 'Nationality Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'nationality_name', 'Nationality Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'notice_date', 'Notice Date');
SELECT localization.add_localized_resource('ScrudResource', '', 'object_name', 'Object Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'occurs_on', 'Occurs On');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'office_hour_id', 'Office Hour Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'overtime_hourly_rate', 'Overtime Hourly Rate');
SELECT localization.add_localized_resource('ScrudResource', '', 'overtime_hours', 'Overtime Hours');
SELECT localization.add_localized_resource('ScrudResource', '', 'overtime_pay_rate', 'Overtime Pay Rate');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'parent_department', 'Parent Department');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'parent_plant', 'Parent Plant');
SELECT localization.add_localized_resource('ScrudResource', '', 'parent_plant_id', 'Parent Plant Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'parent_work_center', 'Parent Work Center');
SELECT localization.add_localized_resource('ScrudResource', '', 'parent_work_center_department_id', 'Parent Work Center Department Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'parent_work_center_id', 'Parent Work Center Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'pay_grade', 'Pay Grade');
SELECT localization.add_localized_resource('ScrudResource', '', 'pay_grade_code', 'Pay Grade Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'pay_grade_id', 'Pay Grade Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'pay_grade_name', 'Pay Grade Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'payroll_account_id', 'Payroll Account Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'phone_emergency', 'Phone Emergency');
SELECT localization.add_localized_resource('ScrudResource', '', 'phone_emergency2', 'Phone Emergency2');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'plant_name', 'Plant Name');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'reason', 'Reason');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'regular_hours', 'Regular Hours');
SELECT localization.add_localized_resource('ScrudResource', '', 'regular_pay_rate', 'Regular Pay Rate');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'resignation_id', 'Resignation Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'salary_tax_income_bracket_id', 'Salary Tax Income Bracket Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'salary_tax_name', 'Salary Tax Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'salary_to', 'Salary To');
SELECT localization.add_localized_resource('ScrudResource', '', 'salary_type', 'Salary Type');
SELECT localization.add_localized_resource('ScrudResource', '', 'salary_type_code', 'Salary Type Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'salary_type_id', 'Salary Type Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'started_on', 'Started On');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'termination_id', 'Termination Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'wage_processing_id', 'Wage Processing Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'wage_setup', 'Wage Setup');
SELECT localization.add_localized_resource('ScrudResource', '', 'wage_setup_code', 'Wage Setup Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'wage_setup_id', 'Wage Setup Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'wage_setup_name', 'Wage Setup Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'warm_up_time_in_minutes', 'Warm Up Time In Minutes');
SELECT localization.add_localized_resource('ScrudResource', '', 'website', 'Website');
SELECT localization.add_localized_resource('ScrudResource', '', 'week_day', 'Week Day');
SELECT localization.add_localized_resource('ScrudResource', '', 'week_day_id', 'Week Day Id');
...
SELECT localization.add_localized_resource('ScrudResource', '', 'with_disabilities', 'With Disabilities');
SELECT localization.add_localized_resource('ScrudResource', '', 'work_center', 'Work Center');
SELECT localization.add_localized_resource('ScrudResource', '', 'work_center_capacity_id', 'Work Center Capacity Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'work_center_code', 'Work Center Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'work_center_cost_code', 'Work Center Cost Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'work_center_cost_id', 'Work Center Cost Id');
SELECT localization.add_localized_resource('ScrudResource', '', 'work_center_cost_name', 'Work Center Cost Name');
SELECT localization.add_localized_resource('ScrudResource', '', 'work_center_department_code', 'Work Center Department Code');
SELECT localization.add_localized_resource('ScrudResource', '', 'work_center_department_id', 'Work Center Department Id');
...
SELECT localization.add_localized_resource('Titles', '', 'AddressAndContactInformation', 'Address & Contact Information');
SELECT localization.add_localized_resource('Titles', '', 'AddressInformation', 'Address Information');
SELECT localization.add_localized_resource('Titles', '', 'Adjustment', 'Adjustment');
...
SELECT localization.add_localized_resource('Titles', '', 'AllTasks', 'All Tasks');
...
SELECT localization.add_localized_resource('Titles', '', 'Attendance', 'Attendance');
SELECT localization.add_localized_resource('Titles', '', 'Attendances', 'Attendances');
SELECT localization.add_localized_resource('Titles', '', 'Attribute', 'Attribute');
SELECT localization.add_localized_resource('Titles', '', 'Attributes', 'Attributes');
...
SELECT localization.add_localized_resource('Titles', '', 'BOM', 'Bill of Materials');
SELECT localization.add_localized_resource('Titles', '', 'BOMCode', 'BOMCode');
SELECT localization.add_localized_resource('Titles', '', 'BOMId', 'BOM Id');
SELECT localization.add_localized_resource('Titles', '', 'BOMName', 'BOM Name');
SELECT localization.add_localized_resource('Titles', '', 'BOMType', 'BOM Type');
SELECT localization.add_localized_resource('Titles', '', 'BOMVerification', 'Bill of Materials Verification');
...
SELECT localization.add_localized_resource('Titles', '', 'BankDetails', 'Bank Details');
...
SELECT localization.add_localized_resource('Titles', '', 'BillOfMaterials', 'Bill of Materials');
...
SELECT localization.add_localized_resource('Titles', '', 'CheckInTime', 'CheckIn Time');
SELECT localization.add_localized_resource('Titles', '', 'CheckOutTime', 'CheckOut Time');
...
SELECT localization.add_localized_resource('Titles', '', 'CollectRawMaterialsFrom', 'Collect Raw Materials From');
...
SELECT localization.add_localized_resource('Titles', '', 'ComponentObliqueBOM', 'Component/BOM');
...
SELECT localization.add_localized_resource('Titles', '', 'ContactInformation', 'Contact Information');
...
SELECT localization.add_localized_resource('Titles', '', 'CreateDuplicate', 'Create a Duplicate');
...
SELECT localization.add_localized_resource('Titles', '', 'CreatePayslip', 'Create Payslip');
SELECT localization.add_localized_resource('Titles', '', 'CreatePayslips', 'Create Payslips');
...
SELECT localization.add_localized_resource('Titles', '', 'Deduction', 'Deduction');
SELECT localization.add_localized_resource('Titles', '', 'DeductionSetup', 'Deduction Setup');
SELECT localization.add_localized_resource('Titles', '', 'DeductionSetups', 'Deduction Setups');
...
SELECT localization.add_localized_resource('Titles', '', 'Disassemble', 'Disassemble');
SELECT localization.add_localized_resource('Titles', '', 'Disassembly', 'Disassembly');
SELECT localization.add_localized_resource('Titles', '', 'DisassemblyVerification', 'Disassembly Verification');
...
SELECT localization.add_localized_resource('Titles', '', 'EducationLevel', 'Education Level');
...
SELECT localization.add_localized_resource('Titles', '', 'Employee', 'Employee');
SELECT localization.add_localized_resource('Titles', '', 'EmployeeExits', 'Employee Exits');
...
SELECT localization.add_localized_resource('Titles', '', 'EmployeeSalaries', 'Employee Salaries');
SELECT localization.add_localized_resource('Titles', '', 'EmployeeSalary', 'Employee Salary');
...
SELECT localization.add_localized_resource('Titles', '', 'EmployeeWage', 'Employee Wage');
SELECT localization.add_localized_resource('Titles', '', 'EmployeeWages', 'Employee Wages');
SELECT localization.add_localized_resource('Titles', '', 'Employees', 'Employees');
SELECT localization.add_localized_resource('Titles', '', 'EmploymentInformation', 'Employment Information');
...
SELECT localization.add_localized_resource('Titles', '', 'EmploymentTax', 'Employment Tax');
SELECT localization.add_localized_resource('Titles', '', 'EmploymentTaxDetails', 'Employment Tax Details');
SELECT localization.add_localized_resource('Titles', '', 'EmploymentTaxes', 'Employment Taxes');
...
SELECT localization.add_localized_resource('Titles', '', 'Exit', 'Exit');
SELECT localization.add_localized_resource('Titles', '', 'ExitType', 'Exit Type');
...
SELECT localization.add_localized_resource('Titles', '', 'FIFO', 'First In, First Out (FIFO)');
...
SELECT localization.add_localized_resource('Titles', '', 'FinishedGoodsStore', 'Finished Goods Store');
...
SELECT localization.add_localized_resource('Titles', '', 'ForDate', 'For Date');
...
SELECT localization.add_localized_resource('Titles', '', 'Genders', 'Genders');
SELECT localization.add_localized_resource('Titles', '', 'GeneralInformation', 'General Information');
SELECT localization.add_localized_resource('Titles', '', 'GlobalParameters', 'Global Parameters');
SELECT localization.add_localized_resource('Titles', '', 'Go', 'Go');
SELECT localization.add_localized_resource('Titles', '', 'GoToBottom', 'Go to Bottom');
...
SELECT localization.add_localized_resource('Titles', '', 'IdentificationTypes', 'Identification Types');
...
SELECT localization.add_localized_resource('Titles', '', 'InventoryAccountingSystem', 'Inventory Accounting System');
SELECT localization.add_localized_resource('Titles', '', 'InventoryAdvice', 'Inventory Advice');
SELECT localization.add_localized_resource('Titles', '', 'InventoryValuationMethod', 'Inventory Valuation Method');
...
SELECT localization.add_localized_resource('Titles', '', 'IsPresent', 'Is Present');
SELECT localization.add_localized_resource('Titles', '', 'IsSystemAccount', 'Is System Account');
SELECT localization.add_localized_resource('Titles', '', 'IssueMethod', 'Issue Method');
...
SELECT localization.add_localized_resource('Titles', '', 'ItemInformation', 'Item Information');
...
SELECT localization.add_localized_resource('Titles', '', 'ItemVariant', 'Item Variant');
SELECT localization.add_localized_resource('Titles', '', 'ItemVariantDetails', 'Item Variant Details');
SELECT localization.add_localized_resource('Titles', '', 'ItemVariants', 'Item Variants');
...
SELECT localization.add_localized_resource('Titles', '', 'Kanbans', 'Kanbans');
...
SELECT localization.add_localized_resource('Titles', '', 'LIFO', 'Last In, First Out (LIFO)');
...
SELECT localization.add_localized_resource('Titles', '', 'LeaveApplications', 'Leave Applications');
SELECT localization.add_localized_resource('Titles', '', 'LeaveBenefit', 'Leave Benefit');
SELECT localization.add_localized_resource('Titles', '', 'LeaveBenefits', 'Leave Benefits');
SELECT localization.add_localized_resource('Titles', '', 'LeaveType', 'Leave Type');
...
SELECT localization.add_localized_resource('Titles', '', 'LunchDeduction', 'Lunch Deduction');
SELECT localization.add_localized_resource('Titles', '', 'MAVCO', 'Moving Average Cost (MAVCO)');
SELECT localization.add_localized_resource('Titles', '', 'MachineInformation', 'Machine Information');
...
SELECT localization.add_localized_resource('Titles', '', 'Manufacture', 'Manufacture');
SELECT localization.add_localized_resource('Titles', '', 'Manufacturing', 'Manufacturing');
SELECT localization.add_localized_resource('Titles', '', 'ManufacturingVerification', 'Manufacturing Verification');
SELECT localization.add_localized_resource('Titles', '', 'MaritalStatus', 'Marital Status');
SELECT localization.add_localized_resource('Titles', '', 'MaritalStatuses', 'Marital Statuses');
...
SELECT localization.add_localized_resource('Titles', '', 'MyLeaveApplications', 'My Leave Applications');
SELECT localization.add_localized_resource('Titles', '', 'MyResignation', 'My Resignation');
SELECT localization.add_localized_resource('Titles', '', 'Name', 'Name');
SELECT localization.add_localized_resource('Titles', '', 'Nationalities', 'Nationalities');
...
SELECT localization.add_localized_resource('Titles', '', 'OfficeHour', 'Office Hour');
...
SELECT localization.add_localized_resource('Titles', '', 'OvertimeHours', 'Overtime Hours');
SELECT localization.add_localized_resource('Titles', '', 'OvertimeWage', 'Overtime Wage');
...
SELECT localization.add_localized_resource('Titles', '', 'PartyInformation', 'Party Information');
...
SELECT localization.add_localized_resource('Titles', '', 'PayHours', 'Pay Hours');
SELECT localization.add_localized_resource('Titles', '', 'PayRate', 'Pay Rate');
...
SELECT localization.add_localized_resource('Titles', '', 'PriceDetails', 'Price Details');
SELECT localization.add_localized_resource('Titles', '', 'PriceType', 'Price Type');
SELECT localization.add_localized_resource('Titles', '', 'PrimarySalesTaxType', 'Primary Sales Tax Type');
...
SELECT localization.add_localized_resource('Titles', '', 'ProducedUnit', 'Produced Unit');
SELECT localization.add_localized_resource('Titles', '', 'ProductionOrder', 'Production Order');
SELECT localization.add_localized_resource('Titles', '', 'ProductionOrderProgress', 'Production Order Progress');
SELECT localization.add_localized_resource('Titles', '', 'ProductionOrderVerification', 'Production Order Verification');
SELECT localization.add_localized_resource('Titles', '', 'ProductionOrders', 'Production Orders');
...
SELECT localization.add_localized_resource('Titles', '', 'RegionalDataIncludingCOA', 'Regional Data (Including Chart of Accounts)');
SELECT localization.add_localized_resource('Titles', '', 'RegistrationDate', 'Registration Date');
SELECT localization.add_localized_resource('Titles', '', 'RegularHours', 'Regular Hours');
SELECT localization.add_localized_resource('Titles', '', 'RegularWage', 'Regular Wage');
...
SELECT localization.add_localized_resource('Titles', '', 'Resignation', 'Resignation');
...
SELECT localization.add_localized_resource('Titles', '', 'Revision', 'Revision');
...
SELECT localization.add_localized_resource('Titles', '', 'SalaryTaxes', 'Salary Taxes');
SELECT localization.add_localized_resource('Titles', '', 'SalaryType', 'Salary Type');
...
SELECT localization.add_localized_resource('Titles', '', 'SelectBOM', 'Select BOM');
...
SELECT localization.add_localized_resource('Titles', '', 'SelectGroup', 'Select a Group');
...
SELECT localization.add_localized_resource('Titles', '', 'ShippingInformation', 'Shipping Information');
...
SELECT localization.add_localized_resource('Titles', '', 'StockDetails', 'Stock Details');
...
SELECT localization.add_localized_resource('Titles', '', 'Sunday', 'Sunday');
...
SELECT localization.add_localized_resource('Titles', '', 'TransactionStartDate', 'Transaction Start Date');
...
SELECT localization.add_localized_resource('Titles', '', 'Tuesday', 'Tuesday');
...
SELECT localization.add_localized_resource('Titles', '', 'UpdateAll', 'Update All');
...
SELECT localization.add_localized_resource('Titles', '', 'VAT', 'VAT');
...
SELECT localization.add_localized_resource('Titles', '', 'Variant', 'Variant');
SELECT localization.add_localized_resource('Titles', '', 'Variants', 'Variants');
...
SELECT localization.add_localized_resource('Titles', '', 'WeekStartsOn', 'Week Starts On');
SELECT localization.add_localized_resource('Titles', '', 'WhichBank', 'Which Bank?');
SELECT localization.add_localized_resource('Titles', '', 'Widget', 'Widget');
SELECT localization.add_localized_resource('Titles', '', 'WidgetManager', 'Widget Manager');
SELECT localization.add_localized_resource('Titles', '', 'Widgets', 'Widgets');
...
SELECT localization.add_localized_resource('Titles', '', 'WorkCenter', 'Work Center');
SELECT localization.add_localized_resource('Titles', '', 'WorkCenterCapacity', 'Work Center Capacity');
SELECT localization.add_localized_resource('Titles', '', 'WorkCenterCost', 'Work Center Cost');
SELECT localization.add_localized_resource('Titles', '', 'WorkCenterCosting', 'Work Center Costing');
SELECT localization.add_localized_resource('Titles', '', 'WorkCenterCosts', 'Work Center Costs');
SELECT localization.add_localized_resource('Titles', '', 'WorkCenterDepartment', 'Work Center Department');
SELECT localization.add_localized_resource('Titles', '', 'WorkCenterDepartments', 'Work Center Departments');
SELECT localization.add_localized_resource('Titles', '', 'WorkCenters', 'Work Centers');
