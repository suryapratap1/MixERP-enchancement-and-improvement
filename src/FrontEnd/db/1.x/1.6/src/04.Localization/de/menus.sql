...
SELECT core.create_menu_locale('BONUS', 'de', 'Bonus');
SELECT core.create_menu_locale('COMMSN', 'de', 'Kommissionen');
SELECT core.create_menu_locale('CTRCT', 'de', 'Verträge');
SELECT core.create_menu_locale('OVERTM', 'de', 'Abzug');
SELECT core.create_menu_locale('DEFEAPOL', 'de', 'Standard Einträge Zugriffsrichtlinie ');
SELECT core.create_menu_locale('EDULVL', 'de', 'Ausbildungslevel');
SELECT core.create_menu_locale('EMPTYP', 'de', 'Mitarbeiter Typen');
SELECT core.create_menu_locale('EMPL', 'de', 'Mitarbeiter ');
SELECT core.create_menu_locale('EMPSTA', 'de', 'Beschäftigungsstatus');
SELECT core.create_menu_locale('EAPOL', 'de', 'Eintrags Zugriffsrichtlinie');
SELECT core.create_menu_locale('Exit Types', 'de', 'Austrittsarten');
SELECT core.create_menu_locale('EXIT', 'de', 'Austritte');
SELECT core.create_menu_locale('GENDR', 'de', 'Geschlechter');
SELECT core.create_menu_locale('HRM', 'de', 'HRM');
SELECT core.create_menu_locale('HRMRPT', 'de', 'HRM Reports');
SELECT core.create_menu_locale('HOLDAY', 'de', 'Feiertags Setup');
SELECT core.create_menu_locale('HOLIDAY', 'de', 'Feiertags Setup');
SELECT core.create_menu_locale('IDNTYP', 'de', 'Identifications Typen');
SELECT core.create_menu_locale('JOBTA', 'de', 'Arbeitstitel');
SELECT core.create_menu_locale('LEVAPP', 'de', 'Ürlaubsansuchen');
SELECT core.create_menu_locale('LEVBEN', 'de', 'Remunerationen');
SELECT core.create_menu_locale('LEVTYP', 'de', 'Urlaubs Typen');
SELECT core.create_menu_locale('MATSTS', 'de', 'Familienstand');
SELECT core.create_menu_locale('NTNALY', 'de', 'Nationalitäten');
SELECT core.create_menu_locale('OFFHRS', 'de', 'Öffnungszeiten');
SELECT core.create_menu_locale('OTHR', 'de', 'Anderes Setup');
SELECT core.create_menu_locale('PATGR', 'de', 'Gehaltsstufen');
SELECT core.create_menu_locale('PAYRL', 'de', 'Gehaltsliste');
SELECT core.create_menu_locale('RESIGN', 'de', 'Kündigungen');
SELECT core.create_menu_locale('SETSAL', 'de', 'Gehälter');
SELECT core.create_menu_locale('SALRY', 'de', 'Gehalt');
SELECT core.create_menu_locale('SALTYP', 'de', 'Gehalts Typen');
SELECT core.create_menu_locale('HRMSSM', 'de', 'Setup und Wartung');
SELECT core.create_menu_locale('SHIFT', 'de', 'Schichten');
SELECT core.create_menu_locale('HRMTA', 'de', 'Aufträge');
SELECT core.create_menu_locale('TERMIN', 'de', 'Beendigungen');
SELECT core.create_menu_locale('TOPSUP', 'de', 'Spitzenlieferanten');
SELECT core.create_menu_locale('HRMVER', 'de', 'Verifizierung');
SELECT core.create_menu_locale('VERCTRCT', 'de', 'Verifiziere Verträge');
SELECT core.create_menu_locale('VEREXIT', 'de', 'Verifiziere Austritte');
SELECT core.create_menu_locale('VERLEVAPP', 'de', 'Verifiziere Urlaubsansuchen');
SELECT core.create_menu_locale('VERRESIGN', 'de', 'Verifiziere Kündigungen');
SELECT core.create_menu_locale('VERTERMIN', 'de', 'Verifiziere Beendigungen');
SELECT core.create_menu_locale('SETWAGES', 'de', 'Lohn');
SELECT core.create_menu_locale('WAGES', 'de', 'Löhne');
