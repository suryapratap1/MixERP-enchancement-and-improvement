...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    ...
    /// </summary>
    public class OfficeHourScrudView : DbAccess, IOfficeHourScrudViewRepository
    {
        /// <summary>
        ...
        /// <summary>
        /// Executes a select query on the view "hrm.office_hour_scrud_view" to return all instances of the "OfficeHourScrudView" class. 
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.OfficeHourScrudView> Get()
        {
            ...
            if (!this.SkipValidation)
            {
                ...
                if (!this.HasAccess)
                {
                    Log.Information("Access to the export entity \"OfficeHourScrudView\" was denied to the user with Login ID {LoginId}", this._LoginId);
                    throw new UnauthorizedException("Access is denied.");
                }
            }

            const string sql = "SELECT * FROM hrm.office_hour_scrud_view ORDER BY 1;";
