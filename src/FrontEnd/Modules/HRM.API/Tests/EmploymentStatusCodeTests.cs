...
{
    public class EmploymentStatusCodeTests
    {
        ...
        public void Get()
        {
            MixERP.Net.Entities.HRM.EmploymentStatusCode employmentStatusCode = Fixture().Get(0);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(employmentStatusCodes);
        }
