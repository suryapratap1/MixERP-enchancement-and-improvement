...
{
    public class EmployeeIdentificationDetailTests
    {
        public static EmployeeIdentificationDetailController Fixture()
        {
            EmployeeIdentificationDetailController controller = new EmployeeIdentificationDetailController(new EmployeeIdentificationDetailRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.HRM.EmployeeIdentificationDetail employeeIdentificationDetail = Fixture().Get(0);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(employeeIdentificationDetails);
        }
