...
{
    public class LeaveApplicationScrudViewTests
    {
        public static LeaveApplicationScrudViewController Fixture()
        {
            LeaveApplicationScrudViewController controller = new LeaveApplicationScrudViewController(new LeaveApplicationScrudViewRepository(), "", new LoginView());
            return controller;
        }
