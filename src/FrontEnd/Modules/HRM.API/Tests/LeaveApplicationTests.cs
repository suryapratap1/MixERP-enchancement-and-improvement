...
namespace MixERP.Net.Api.HRM.Tests
{
    ...
    {
        public static LeaveApplicationController Fixture()
        {
            LeaveApplicationController controller = new LeaveApplicationController(new LeaveApplicationRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.HRM.LeaveApplication leaveApplication = Fixture().Get(0);
        ...
        public void GetMultiple()
        {
            ...
            Assert.NotNull(leaveApplications);
        }
