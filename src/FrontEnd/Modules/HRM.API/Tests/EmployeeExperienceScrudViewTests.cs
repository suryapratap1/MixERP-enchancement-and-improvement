...
{
    public class EmployeeExperienceScrudViewTests
    {
        public static EmployeeExperienceScrudViewController Fixture()
        {
            EmployeeExperienceScrudViewController controller = new EmployeeExperienceScrudViewController(new EmployeeExperienceScrudViewRepository(), "", new LoginView());
            return controller;
        }
