...
{
    public class OfficeHourScrudViewTests
    {
        public static OfficeHourScrudViewController Fixture()
        {
            OfficeHourScrudViewController controller = new OfficeHourScrudViewController(new OfficeHourScrudViewRepository(), "", new LoginView());
            return controller;
        }
