...
{
    public class AttendanceViewTests
    {
        public static AttendanceViewController Fixture()
        {
            AttendanceViewController controller = new AttendanceViewController(new AttendanceViewRepository(), "", new LoginView());
            return controller;
        }
