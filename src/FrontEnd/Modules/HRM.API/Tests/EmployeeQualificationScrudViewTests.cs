...
{
    public class EmployeeQualificationScrudViewTests
    {
        public static EmployeeQualificationScrudViewController Fixture()
        {
            EmployeeQualificationScrudViewController controller = new EmployeeQualificationScrudViewController(new EmployeeQualificationScrudViewRepository(), "", new LoginView());
            return controller;
        }
