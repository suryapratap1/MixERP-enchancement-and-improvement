...
{
    public class ContractVerificationScrudViewTests
    {
        public static ContractVerificationScrudViewController Fixture()
        {
            ContractVerificationScrudViewController controller = new ContractVerificationScrudViewController(new ContractVerificationScrudViewRepository(), "", new LoginView());
            return controller;
        }
