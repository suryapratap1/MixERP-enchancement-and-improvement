...
{
    public class PayGradeTests
    {
        public static PayGradeController Fixture()
        {
            PayGradeController controller = new PayGradeController(new PayGradeRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.HRM.PayGrade payGrade = Fixture().Get(0);
