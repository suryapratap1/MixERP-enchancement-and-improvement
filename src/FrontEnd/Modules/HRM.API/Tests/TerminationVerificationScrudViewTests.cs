...
{
    public class TerminationVerificationScrudViewTests
    {
        public static TerminationVerificationScrudViewController Fixture()
        {
            TerminationVerificationScrudViewController controller = new TerminationVerificationScrudViewController(new TerminationVerificationScrudViewRepository(), "", new LoginView());
            return controller;
        }
