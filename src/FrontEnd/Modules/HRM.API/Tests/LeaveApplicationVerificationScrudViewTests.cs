...
{
    public class LeaveApplicationVerificationScrudViewTests
    {
        public static LeaveApplicationVerificationScrudViewController Fixture()
        {
            LeaveApplicationVerificationScrudViewController controller = new LeaveApplicationVerificationScrudViewController(new LeaveApplicationVerificationScrudViewRepository(), "", new LoginView());
            return controller;
        }
