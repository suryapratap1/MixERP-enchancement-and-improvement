...
{
    public class EmployeeTypeScrudViewTests
    {
        public static EmployeeTypeScrudViewController Fixture()
        {
            EmployeeTypeScrudViewController controller = new EmployeeTypeScrudViewController(new EmployeeTypeScrudViewRepository(), "", new LoginView());
            return controller;
        }
