...
{
    public class EmployeeSocialNetworkDetailScrudViewTests
    {
        public static EmployeeSocialNetworkDetailScrudViewController Fixture()
        {
            EmployeeSocialNetworkDetailScrudViewController controller = new EmployeeSocialNetworkDetailScrudViewController(new EmployeeSocialNetworkDetailScrudViewRepository(), "", new LoginView());
            return controller;
        }
