...
{
    public class EmployeeIdentificationDetailScrudViewTests
    {
        public static EmployeeIdentificationDetailScrudViewController Fixture()
        {
            EmployeeIdentificationDetailScrudViewController controller = new EmployeeIdentificationDetailScrudViewController(new EmployeeIdentificationDetailScrudViewRepository(), "", new LoginView());
            return controller;
        }
