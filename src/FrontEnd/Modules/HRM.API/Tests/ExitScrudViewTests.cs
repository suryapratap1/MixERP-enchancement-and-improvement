...
{
    public class ExitScrudViewTests
    {
        public static ExitScrudViewController Fixture()
        {
            ExitScrudViewController controller = new ExitScrudViewController(new ExitScrudViewRepository(), "", new LoginView());
            return controller;
        }
