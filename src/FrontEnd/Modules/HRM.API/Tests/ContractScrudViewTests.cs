...
{
    public class ContractScrudViewTests
    {
        public static ContractScrudViewController Fixture()
        {
            ContractScrudViewController controller = new ContractScrudViewController(new ContractScrudViewRepository(), "", new LoginView());
            return controller;
        }
