...
{
    public class ResignationVerificationScrudViewTests
    {
        public static ResignationVerificationScrudViewController Fixture()
        {
            ResignationVerificationScrudViewController controller = new ResignationVerificationScrudViewController(new ResignationVerificationScrudViewRepository(), "", new LoginView());
            return controller;
        }
