...
namespace MixERP.Net.Api.HRM.Tests
{
    ...
    {
        public static TerminationController Fixture()
        {
            TerminationController controller = new TerminationController(new TerminationRepository(), "", new LoginView());
            return controller;
        }
        ...
        public void Get()
        {
            MixERP.Net.Entities.HRM.Termination termination = Fixture().Get(0);
