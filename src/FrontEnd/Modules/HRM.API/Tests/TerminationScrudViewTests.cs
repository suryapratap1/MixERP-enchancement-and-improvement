...
{
    public class TerminationScrudViewTests
    {
        public static TerminationScrudViewController Fixture()
        {
            TerminationScrudViewController controller = new TerminationScrudViewController(new TerminationScrudViewRepository(), "", new LoginView());
            return controller;
        }
