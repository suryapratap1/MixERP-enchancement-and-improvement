...
{
    public class ResignationScrudViewTests
    {
        public static ResignationScrudViewController Fixture()
        {
            ResignationScrudViewController controller = new ResignationScrudViewController(new ResignationScrudViewRepository(), "", new LoginView());
            return controller;
        }
