...
namespace MixERP.Net.Api.HRM
{
    ...
    public class OfficeHourScrudViewController : ApiController
    {
        ...
        /// <summary>
        ///     Returns collection of office hour scrud view for export.
        /// </summary>
        /// <returns></returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("export")]
        [Route("all")]
        [Route("~/api/hrm/office-hour-scrud-view/export")]
        [Route("~/api/hrm/office-hour-scrud-view/all")]
        public IEnumerable<MixERP.Net.Entities.HRM.OfficeHourScrudView> Get()
        {
            try
            {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 office hour scrud views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Counts the number of office hour scrud views using the supplied filter(s).
        /// </summary>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns the count of filtered office hour scrud views.</returns>
        [AcceptVerbs("POST")]
        [Route("count-where")]
        [Route("~/api/hrm/office-hour-scrud-view/count-where")]
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 office hour scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.OfficeHourScrudView> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
        ...
        /// <summary>
        ///     Counts the number of office hour scrud views using the supplied filter name.
        /// </summary>
        /// <param name="filterName">The named filter.</param>
        /// <returns>Returns the count of filtered office hour scrud views.</returns>
        [AcceptVerbs("GET", "HEAD")]
        [Route("count-filtered/{filterName}")]
        [Route("~/api/hrm/office-hour-scrud-view/count-filtered/{filterName}")]
        ...
        [Route("~/api/hrm/office-hour-scrud-view/get-filtered/{pageNumber}/{filterName}")]
