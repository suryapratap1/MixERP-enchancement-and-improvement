...
{
    public class EmployeeSocialNetworkDetailScrudViewRepository : IEmployeeSocialNetworkDetailScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.HRM.EmployeeSocialNetworkDetailScrudView(), 1);
        }
