...
namespace MixERP.Net.Api.HRM.Fakes
{
    public class EmployeeExperienceRepository : IEmployeeExperienceRepository
    {
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.HRM.EmployeeExperience(), 1);
        }
        ...
        {
            return new MixERP.Net.Entities.HRM.EmployeeExperience();
        }
        ...
        public void Update(dynamic employeeExperience, long employeeExperienceId)
        {
            ...
            throw new ArgumentException("employeeExperienceId is null.");
        }
