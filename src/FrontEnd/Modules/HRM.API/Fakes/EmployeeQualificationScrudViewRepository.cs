...
{
    public class EmployeeQualificationScrudViewRepository : IEmployeeQualificationScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.HRM.EmployeeQualificationScrudView(), 1);
        }
