...
{
    public class ContractVerificationScrudViewRepository : IContractVerificationScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.HRM.ContractVerificationScrudView(), 1);
        }
