...
{
    public class TerminationVerificationScrudViewRepository : ITerminationVerificationScrudViewRepository
    {
        public long Count()
        {
            return 1;
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.HRM.TerminationVerificationScrudView(), 1);
        }
