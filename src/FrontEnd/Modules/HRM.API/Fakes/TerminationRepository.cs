...
namespace MixERP.Net.Api.HRM.Fakes
{
    public class TerminationRepository : ITerminationRepository
    {
        ...
        {
            return Enumerable.Repeat(new MixERP.Net.Entities.HRM.Termination(), 1);
        }
        ...
        {
            return new MixERP.Net.Entities.HRM.Termination();
        }
        ...
        public void Update(dynamic termination, int terminationId)
        {
            ...
            throw new ArgumentException("terminationId is null.");
        }
